...
export default function AIChatPage() {
  ...
  const theme = chatTheme === 'cream' ? {
    ...
    bg: '#f5f0eb',
    headerBg: '#f5f0eb',
    headerBorder: 'rgba(180,160,140,0.15)',
    backBg: 'rgba(180,160,140,0.12)',
    backColor: '#8a7060',
    titleColor: '#3a2e28',
    subColor: '#a09080',
    endBtnBg: 'transparent',
    endBtnBorder: 'rgba(180,160,140,0.3)',
    endBtnColor: '#a09080',
    progressBg: 'rgba(180,160,140,0.15)',
    progressFill: 'linear-gradient(90deg, #f2c4ce, #e8a0b0)',
    messagesBg: '#f5f0eb',
    aiBubbleBg: '#ffffff',
    ...
    trTextColor: '#a09080',
    userBubbleBg: '#f2c4ce',
    userBubbleShadow: '0 2px 10px rgba(200,140,160,0.15)',
    userNotchColor: '#f2c4ce',
    userText: '#3a2e28',
    typingBg: '#ffffff',
    typingBorder: 'none',
    typingLabel: '#b0a090',
    dotColor: '#e8a0b0',
    inputAreaBg: '#f5f0eb',
    inputAreaBorder: 'rgba(180,160,140,0.12)',
    inputBg: '#ffffff',
    inputBorder: 'rgba(180,160,140,0.2)',
    inputColor: '#3a2e28',
    inputPlaceholder: '#c0b0a0',
    themeBtnBg: 'rgba(180,160,140,0.12)',
    themeBtnColor: '#8a7060',
    avatarBg: 'linear-gradient(135deg, #f2c4ce, #deb8c8)',
    listenColor: '#b0a090',
    listenHover: '#c48090',
    feedbackErrorBg: 'color-mix(in srgb, #ff5a5a 6%, #f5f0eb)',
    feedbackNormalBg: '#ffffff',
    feedbackNormalBorder: '1px solid rgba(180,160,140,0.15)',
    hintsBg: '#ffffff',
    hintsBorder: 'rgba(180,160,140,0.15)',
    hintsItemBg: '#f5f0eb',
    hintsItemBorder: 'rgba(180,160,140,0.2)',
    feedbackMutedColor: '#a09080',
    feedbackSecondaryColor: '#7a6a60',
  } : {
    // Deep space (style 3)
  ...
  return (
    <div
      className={isDesktop ? 'flex flex-col -mx-4 lg:-mx-8' : 'flex flex-col'}
      style={isDesktop ? {
