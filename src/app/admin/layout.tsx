...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#FFFDF9' }}>
      {/* Sidebar */}
      <aside className="w-56 bg-white border-r border-[#F5E6E0] flex flex-col shrink-0 min-h-screen sticky top-0 left-0" style={{ boxShadow: '2px 0 12px rgba(0,0,0,0.04)' }}>
        {/* Tori header */}
