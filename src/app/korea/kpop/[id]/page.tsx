                  ...
                  <div style={{
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: savedWords.has(displayKorean) ? 'var(--color-mint-soft)' : C.white,
                        color: savedWords.has(displayKorean) ? '#4e746d' : C.btnDarkText,
                        border: `1px solid ${savedWords.has(displayKorean) ? 'var(--color-mint-soft)' : C.line}`,
