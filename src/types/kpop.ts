// KPOP module types
// Preserved: KpopHotPost, KpopHotSentence, KpopImportJob, KpopSongProgress, KpopLineRecording (used by other modules)
// Removed: KpopTrack, KpopLine, KpopLyricLineData (old static library, replaced by P1 local karaoke)
// Added: LocalLyricLine, LocalCachedSong (P1 local karaoke)
...
// ── Progress & Recording (used by /api/kpop/progress, /api/kpop/recording) ──
...
// ── Import jobs (used by /api/kpop/import) ──
...
// ── Hot posts (used by /api/hot-posts, /korea/kpop/news) ──
...
// ── Legacy stubs (kept for TS compatibility, will be removed after full migration) ──
