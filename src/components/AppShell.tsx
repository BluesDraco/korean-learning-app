...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (isStandalone) {
    return (
      <>
        {/* Beta banner */}
        <div className="fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r from-[#FFF5EE] via-[#FFF0F5] to-[#FFF5EE] border-b-2 border-dashed border-pink-200 py-1.5 text-center">
        ...
        <main className="pb-16 md:pb-6 px-3 md:px-5 lg:px-8 page-container pt-3">
          {children}
        </main>
      </>
    );
