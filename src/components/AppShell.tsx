...
export function AppShell({ children }: { children: React.ReactNode }) {
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-[60] md:left-14 lg:left-52 bg-gradient-to-r from-[#FFF5EE] via-[#FFF0F5] to-[#FFF5EE] border-b-2 border-dashed border-pink-200 py-1.5 text-center">
      ...
      <Navbar />
      <main className="pb-16 md:pb-6 pl-0 md:pl-14 lg:pl-52 px-3 md:px-4 lg:px-8 page-container pt-3 transition-[padding] duration-200">
        {children}
      </main>
