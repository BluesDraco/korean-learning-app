...
走到街上，我发现手在抖——不是害怕，是愤怒。`,
  ...
  words: [
    {
      ...
      zh: '歧视',
      pos: '名词',
      example: { ko: '체형 차별이에요.', zh: '是体型歧视。' },
      tip: '差(차) + 别(별). 인종/성/체형 차별',
    },
    {
      id: 'd66-w2',
      korean: '체형',
      ...
      zh: '体型',
      pos: '名词',
      example: { ko: '체형이 작아서 못 뽑는대요.', zh: '说因为体型小所以不能招。' },
      tip: '体(체) + 型(형). 체력(体力)과 다름',
    },
    {
      id: 'd66-w3',
      korean: '체력',
      ...
      zh: '体力',
      pos: '名词',
      example: { ko: '체력이 필요한 일이에요.', zh: '需要体力的工作。' },
      tip: '体(체) + 力(력). 面试被拒时常用',
    },
    {
      id: 'd66-w4',
      ...
      zh: '生气',
      pos: '表达',
      example: { ko: '진짜 화가 났어요.', zh: '真的生气了。' },
      tip: '화(火) + 가 + 나다(出). "怒气冒出"的比喻',
    },
    {
      id: 'd66-w5',
      korean: '무시하다',
      ...
      zh: '无视',
      pos: '动词',
      example: { ko: '이력서도 안 보고 무시했어요.', zh: '简历都不看就无视了。' },
      tip: '无(무) + 视(시) + 하다。轻视对方、把人看轻',
    },
    {
      id: 'd66-w6',
      korean: '실력이 부족하다',
      ...
      zh: '实力不足',
      pos: '表达',
      example: { ko: '실력이 부족한 것도 아닌데요.', zh: '也不是实力不足。' },
      tip: '실력(实力) + 이 + 부족하다(不足). Day 63 复习',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '狮子没回应，转头看下一个人。Tori想守住尊严再说一句"这是歧视"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '이건 명백한 체형 차별이에요.', zh: '这明显是体型歧视。', correct: true },
          { ko: '아, 죄송해요. 그럼 그냥 갈게요.', zh: '啊，抱歉。那我就走了。', correct: false },
          { ko: '체력 좀 키우고 다시 올게요.', zh: '锻炼下体力再来。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '委婉拒绝：~(으)ㄹ 것 같아요',
    pattern: 'V/A + **(으)ㄹ 것 같아요**',
    whenToUse: 'Day 39 学过 ~는 것 같아요 (现在推测). Day 66 = **~(으)ㄹ 것 같아요** = 「(未来/可能性) 大概不行」的委婉表达。狮子说 「안 **될 것 같아요**」= 大概不行。韩国人拒绝人时最常用的柔和句——但柔和不代表不歧视。',
    rules: [
    ...
    examples: [
      { ko: '너무 작아서 안 될 것 같아요.', zh: '太小了，可能不行。', highlight: '안 될 것 같아요', note: '되다 → 될 것 같아요. 사자 원문. 부드러운 거절.' },
      { ko: '내일 비가 올 것 같아요.', zh: '明天可能下雨。', highlight: '올 것 같아요', note: '오다 → 올 것 같아요. 날씨 추측' },
      { ko: '다음 주에 시간이 없을 것 같아요.', zh: '下周可能没时间。', highlight: '없을 것 같아요', note: '없다 → 없을 것 같아요. 약속 완곡 거절' },
      { ko: '그 사람 벌써 갔을 것 같아요.', zh: '那人可能已经走了。', highlight: '갔을 것 같아요', note: '가다 → 갔을 것 같아요 (과거 추측)' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      successMsg: '✓ 狮子 사장의 거절. 부드러움 뒤의 편견.',
      choices: [
        { zh: '太小了，可能不行。', correct: true },
        { zh: '太小所以不能来。', correct: false },
        { zh: '你不够高，别来。', correct: false },
        { zh: '太小了很好。', correct: false },
      ],
    },
    {
      id: 'd66-o3',
    ...
    },
    {
      id: 'd66-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 66 全对. 손 떨렸지만 목소리는 안 떨렸어요.',
      pairs: [
        { ko: '차별', zh: '歧视' },
        { ko: '체형', zh: '体型' },
        { ko: '체력', zh: '体力' },
  ...
  recap: {
    ...
    preview: '明天 Tori 迷路了猎食者街区，天黑，路灯暗——第一次真的害怕。',
    stickerId: 'sticker-d66',
    sceneImageUrl: '/images/diary/day-66-scene.jpg',
  },

  carrotHint: '今天的胡萝卜: 「~(으)ㄹ 것 같아요 和 ~는 것 같아요 有什么区别？」「面对歧视怎么用韩语说不？」',
};
