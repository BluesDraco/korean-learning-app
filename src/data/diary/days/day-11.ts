...
脸上写着"又一个被胡萝卜俘获的留学生"。`,
  ...
  grammar: {
    ...
    examples: [
      { ko: '이거 얼마예요?', zh: '这个多少钱？', highlight: '이거', note: '**이거** = 手边的东西。무받침 → 얼마예요? 直接问价' },
      { ko: '그거 주세요.', zh: '请给我那个（你那）。', highlight: '그거', note: '**그거** = 对方那边的。店员手上的东西用그거，不是이거' },
      { ko: '저거 좋아해요.', zh: '我喜欢那个（远处）。', highlight: '저거', note: '**저거** = 远处的东西。좋아해요 = 喜欢（Day 6 学过）' },
      { ko: '이거도 주세요.', zh: '这个也请给我。', highlight: '이거도', note: '**도** = 也。이거 + 도 = 这个也。省略주세요是口语常见' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      id: 'd11-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 11 核心词全部对上。다이소 的胡萝卜钥匙扣在书包上晃了一路。',
      pairs: [
        { ko: '샴푸', zh: '洗发水' },
        { ko: '수건', zh: '毛巾' },
        { ko: '슬리퍼', zh: '拖鞋' },
