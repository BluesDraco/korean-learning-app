...
学习就是——把昨天和今天的差距，每天一点点往前推。`,
  ...
  words: [
    {
      ...
      zh: '订单/点单',
      pos: '名词',
      example: { ko: '주문 받았어요.', zh: '收到订单了。' },
      tip: '注(주) + 文(문). 주문하다 = 点单 / 주문 넣다 = 下单',
    },
    {
      id: 'd64-w2',
      korean: '영수증',
      ...
      zh: '收据',
      pos: '名词',
      example: { ko: '영수증 드릴까요?', zh: '要收据吗？' },
      tip: '领(영) + 收(수) + 证(증). 결제 후 자주 묻는 말',
    },
    {
      id: 'd64-w3',
      korean: '사투리',
      ...
      zh: '方言',
      pos: '名词',
      example: { ko: '사투리 쓰시는 분은 아직 어려워요.', zh: '用方言的人还是难。' },
    ...
    },
    {
      ...
      zh: '自然',
      pos: '形容词',
      example: { ko: '이 문장 자연스러워요.', zh: '这句话很自然。' },
    ...
    },
    {
      ...
      zh: '努力',
      pos: '动词',
      example: { ko: '계속 노력하고 있어요.', zh: '一直在努力。' },
      tip: '努(노) + 力(력) + 하다. Day 55 열심히 는 副词, 노력하다 는 动词',
    },
    {
      id: 'd64-w6',
      korean: '흐름',
      ...
      zh: '流程/流向',
      pos: '名词',
      example: { ko: '결제 흐름이 자연스러워요.', zh: '结账流程很自然。' },
      tip: '흐르다(流) → 흐름(名词化). 업무 흐름 = 工作流程',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '사장 说"이 자세가 실력을 만들어". Tori 想认真答"我会一直这样"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '네, 계속 이렇게 배워 나갈게요.', zh: '好的，会一直这样学下去。', correct: true },
          { ko: '아니에요, 저 이미 다 잘해요.', zh: '不，我已经全会了。', correct: false },
          { ko: '그럼 이제 안 배워도 되나요?', zh: '那现在可以不学了吧？', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '变得会___：~게 되다',
    pattern: 'V + **게 되다**',
    whenToUse: '「变得能___」的**状态变化**句尾。Tori 说 「주문을 다 알아듣게 됐어요」= 变得能全听懂订单了。~게 되다 强调**从"不能→能"的自然变化**（非主动努力），Day 64 成长主题的核心句。',
    rules: [
    ...
    examples: [
      { ko: '주문을 다 알아듣게 됐어요.', zh: '变得能全听懂订单了。', highlight: '알아듣게 됐어요', note: '알아듣다 → 알아듣게 됐어요. 상태 변화' },
      { ko: '이 문장이 자연스럽게 나오게 됐어요.', zh: '这句话变得自然说出来。', highlight: '나오게 됐어요', note: '나오다 → 나오게 됐어요. 시간 지남에 따른 변화' },
      { ko: '한국 음식을 좋아하게 됐어요.', zh: '变得喜欢韩国料理了。', highlight: '좋아하게 됐어요', note: '좋아하다 → 좋아하게 됐어요. 취향 변화' },
      { ko: '이제 혼자 할 수 있게 됐어요.', zh: '现在变得能独立做了。', highlight: '할 수 있게 됐어요', note: 'Day 38·51 ~(으)ㄹ 수 있어요 + ~게 되다 = 능력 획득' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      choices: [
        { zh: '这种态度就是造就实力的。', correct: true },
        { zh: '姿势不对没有实力。', correct: false },
        { zh: '实力没有姿势重要。', correct: false },
        { zh: '这种姿势没用。', correct: false },
      ],
    },
    {
      id: 'd64-o3',
      kind: 'zh-to-ko',
      zhPrompt: '现在变得能独立做了。',
      successMsg: '"이제 혼자 할 수 있게 됐어요." — ~(으)ㄹ 수 있게 되다 = 能力 획득.',
      choices: [
    ...
    },
    {
      id: 'd64-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 64 全对. 2주 만에 성장했어요.',
      pairs: [
        { ko: '주문', zh: '订单' },
        { ko: '영수증', zh: '收据' },
        { ko: '사투리', zh: '方言' },
  ...
  recap: {
    ...
    preview: '明天听说北区有"猎食者街区" — 什么样的地方？',
    stickerId: 'sticker-d64',
    sceneImageUrl: '/images/diary/day-64-scene.jpg',
  },

  carrotHint: '今天的胡萝卜: 「~게 되다 和 ~아/어지다 有什么区别？」「打工怎么才能进步快？」',
};
