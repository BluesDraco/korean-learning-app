...
我不再只是那只需要帮助的外国兔子了。`,
  ...
  words: [
    {
      ...
      zh: '出口',
      pos: '名词',
      example: { ko: '2번 출구로 나가세요.', zh: '请从2号出口出去。' },
      tip: '출(出) + 구(口)。地铁站导航必备。입구 = 入口',
    },
    {
      id: 'd35-w2',
      korean: '왼쪽',
      ...
      zh: '左边',
      pos: '名词',
      example: { ko: '왼쪽으로 가세요.', zh: '请往左走。' },
      tip: '왼(左) + 쪽(边)。反义: 오른쪽(右)。介词用 ~으로',
    },
    {
      id: 'd35-w3',
      korean: '오른쪽',
      ...
      zh: '右边',
      pos: '名词',
      example: { ko: '오른쪽 편의점 옆이에요.', zh: '在右边便利店旁边。' },
      tip: '오른 + 쪽。왼쪽/오른쪽 是问路四件套之二',
    },
    {
      id: 'd35-w4',
      korean: '쭉',
      ...
      zh: '一直/笔直',
      pos: '副词',
      example: { ko: '쭉 가세요.', zh: '请一直走。' },
      tip: '拟态词。쭉 가다 = 直走。问路核心副词',
    },
    {
      id: 'd35-w5',
      korean: '걸어요',
      ...
      zh: '走（走路）',
      pos: '动词',
      example: { ko: '5분쯤 걸어요.', zh: '走大概5分钟。' },
      tip: '걷다(走) → 걸어요。ㄷ 不规则：ㄷ → ㄹ 前 아/어',
    },
    {
      id: 'd35-w6',
      korean: '어학당',
      ...
      zh: '语学堂',
      pos: '名词',
      example: { ko: '한빛 어학당은 여기서 5분이에요.', zh: '韩光语学堂离这里5分钟。' },
      tip: '어(语) + 학(学) + 당(堂)。语言学校的正式称呼',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '海狸大叔鞠躬说"고마워요, 학생"。Tori最自然的回应是？',
        practice: 'pick',
        choices: [
          { ko: '아니에요. 조심히 가세요.', zh: '不客气。请慢走。', correct: true },
          { ko: '고마워요.', zh: '谢谢。', correct: false },
          { ko: '괜찮으세요?', zh: '您还好吗？', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '往___走 / 从___到___：~(으)로 / ~에서 ~까지',
    pattern: 'N + **(으)로 가세요** · **N에서 N까지**',
    whenToUse: '指路两个核心助词。**(으)로** 表方向（"往哪"）：왼쪽으로 = 往左；2번 출구로 = 往2号出口。**에서~까지** 表起终点：집에서 학교까지 = 从家到学校。海狸大叔一句"어디예요"，Tori 用这两个句型答完整。',
    rules: [
    ...
    examples: [
      { ko: '왼쪽으로 가세요.', zh: '请往左走。', highlight: '왼쪽으로', note: '왼쪽 有收音 ㄱ → **으로**。指路最核心的一句' },
      { ko: '2번 출구로 나가세요.', zh: '请从2号出口出去。', highlight: '출구로', note: '출구 无收音 → **로**。나가다 + 로 是地铁站导航固定搭配' },
      { ko: '집에서 학교까지 5분이에요.', zh: '从家到学校5分钟。', highlight: '에서 ... 까지', note: '起点助词 에서 + 终点助词 까지 = 距离/时间表达' },
      { ko: '쭉 가서 오른쪽으로 도세요.', zh: '一直走然后往右转。', highlight: '쭉 ... 으로', note: '쭉 + 가서(走) + 방향 + 으로 + 돌다(转)。指路进阶句' },
    ],
    pitfall:
  ...
  output: [
    {
      id: 'd35-o1',
      kind: 'compose',
      zhHint: '请从2号出口出去，往左一直走。',
      tokens: ['2번', '출구로', '나가서', '왼쪽으로', '쭉 가세요', '가세요', '갑니다'],
      composeAnswer: ['2번', '출구로', '나가서', '왼쪽으로', '쭉 가세요'],
      successMsg: '第一次给别人指路。完整的一句。',
    },
    {
      id: 'd35-o2',
      kind: 'listen-choice',
      audioKo: '집에서 학교까지 5분이에요.',
      successMsg: '✓ 从___到___的距离/时间标准表达。',
      choices: [
        { zh: '从家到学校5分钟。', correct: true },
        { zh: '学校在家里5分钟处。', correct: false },
        { zh: '在家学习5分钟。', correct: false },
        { zh: '5分钟能到家。', correct: false },
      ],
    },
    {
      id: 'd35-o3',
    ...
    },
    {
      ...
      kind: 'particle-error',
      zhHint: '请往地铁站方向走。',
      successMsg: '지하철역 有收音 → **으로**。收音判断决定 으로 / 로。',
      choices: [
    ...
    },
    {
      id: 'd35-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 35 全对。这条路，Tori 走成了本地人。',
      pairs: [
        { ko: '출구', zh: '出口' },
        { ko: '왼쪽', zh: '左边' },
        { ko: '오른쪽', zh: '右边' },
  ...
  recap: {
    ...
    preview: '明天，Tori收到一个包裹——妈妈从中国寄来的火锅底料。',
