...
하지만 兽尔의 이야기는 이제 시작이야.`,
  ...
  words: [
    {
      ...
      zh: '毕业',
      pos: '名词',
      example: { ko: '언어 학교를 졸업했어요.', zh: '语言学校毕业了。' },
      tip: '毕(졸) + 业(업). 졸업식 = 毕业典礼',
    },
    {
      id: 'd60-w2',
      korean: '침묵',
      ...
      zh: '沉默',
      pos: '名词',
      example: { ko: '3초 침묵 후에 박수.', zh: '3秒沉默后掌声。' },
      tip: '沈(침) + 默(묵). 침묵이 흐르다 = 沉默流淌',
    },
    {
      id: 'd60-w3',
      korean: '헷갈리다',
      ...
      zh: '搞混/混淆',
      pos: '动词',
      example: { ko: '집이랑 짐을 헷갈렸어요.', zh: '把집和짐搞混了。' },
      tip: 'Day 3 Tori 犯的错. Day 56 新生也犯. 学习者共同的坑',
    },
    {
      id: 'd60-w4',
      korean: '입학',
      ...
      zh: '入学',
      pos: '名词',
      example: { ko: '대학 입학 준비반으로 올라갔어요.', zh: '升到大学入学准备班。' },
      tip: '入(입) + 学(학). 反义: 졸업(毕业)',
    },
    {
      id: 'd60-w5',
      korean: '가족',
      ...
      zh: '家人',
      pos: '名词',
      example: { ko: '제 가족은 여기에 있어요.', zh: '我的家人在这里。' },
    ...
    },
    {
      ...
      zh: '故事',
      pos: '名词',
      example: { ko: '兽尔의 이야기는 이제 시작이야.', zh: '兽尔的故事现在才开始。' },
      tip: '이야기하다 = 讲故事/说话. 얘기(축약형)',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '典礼结束朋友们围过来。Tori想说"这60天，你们是我的家人"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '이 60일, 너희가 내 가족이었어. 진심으로 고마워.', zh: '这60天，你们就是我的家人。真心谢谢。', correct: true },
          { ko: '이제 다 끝났어. 잘 가.', zh: '现在都结束了。再见。', correct: false },
          { ko: '나 대학 안 갈래.', zh: '我不想上大学了。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '虽然___但___：~았/었지만（Day 48 深化 + 결말 회고）',
    pattern: 'V/A + **았/었지만** + Result',
    whenToUse: 'Day 48 学过 ~지만。Day 60 深化——**~았/었지만** 表**过去事实**的转折，是回顾/毕业演讲的核心句型。Tori 说 「짐을 가져왔**지만** 지금은 집이 있어요」= 虽然带来了行李，但现在有了家。~았/었지만 = "曾经/过去___，但现在___"，成长表达的黄金结构。',
    rules: [
    ...
    examples: [
      { ko: '짐을 가져왔지만 지금은 집이 있어요.', zh: '虽然带来了行李，但现在有了家。', highlight: '가져왔지만 ... 있어요', note: '가져오다 → 가져왔지만. Day 60 主题句. Day 3의 회수' },
      { ko: '처음엔 어려웠지만 지금은 재밌어요.', zh: '一开始难，但现在有意思。', highlight: '어려웠지만 ... 재밌어요', note: '어렵다 → 어려웠지만. 학습 회고의 정석' },
      { ko: '떨렸지만 다 말했어요.', zh: '虽然紧张但都说了。', highlight: '떨렸지만', note: '떨리다 → 떨렸지만. Day 55 배운 표현 활용' },
      { ko: '한국말이 서툴렀지만 마음은 통했어요.', zh: '虽然韩语生疏但心意相通。', highlight: '서툴렀지만 ... 통했어요', note: '서투르다 → 서툴렀지만 (르 불규칙). 감동적 회고' },
    ],
    pitfall:
  ...
  output: [
    {
      id: 'd60-o1',
      kind: 'compose',
      zhHint: '虽然带来了行李，但现在有了家。',
      tokens: ['짐을', '가져왔지만', '지금은', '집이 있어요', '가져와서', '집이에요'],
      composeAnswer: ['짐을', '가져왔지만', '지금은', '집이 있어요'],
      successMsg: 'Day 60 最重要的一句。짐 → 집. 60天成长收束.',
    },
    {
      id: 'd60-o2',
      kind: 'listen-choice',
      audioKo: '토리 학생, 중급반 졸업. 대학 입학 준비반으로 올라가세요.',
      successMsg: '✓ 火鹤老师宣布. 中级毕业, 但下一站是大学准备班.',
      choices: [
        { zh: '兔莉，中级班毕业。请升到大学入学准备班。', correct: true },
        { zh: '兔莉，中级班没通过。', correct: false },
        { zh: '兔莉，请离开学校。', correct: false },
        { zh: '兔莉，明年再来。', correct: false },
      ],
    },
    {
      id: 'd60-o3',
      kind: 'zh-to-ko',
      zhPrompt: '一开始难，但现在有意思。',
    ...
    },
    {
      id: 'd60-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 60 全对. 중급반 졸업. 대학 이야기는 곧 시작.',
      pairs: [
        { ko: '졸업', zh: '毕业' },
        { ko: '침묵', zh: '沉默' },
        { ko: '헷갈리다', zh: '搞混' },
  ...
  recap: {
    ...
    preview: '언어 학교 졸업 — 하지만 다음 학기, 대학 입학 준비반으로. 兽尔의 이야기는 이제 시작.',
