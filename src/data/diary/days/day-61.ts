...
export const day61: ToriDay = {
  ...
  day: 1,
  phase: 'mastery',
  title: '高级班第一天 · Danielle完美得不真实',
  subtitle: '同样是外国人，为什么她像母语者？',
...
（兔莉，你怎么还只能做到这么一点点？）`,
  ...
  words: [
    {
      ...
      zh: '高级班',
      pos: '名词',
      example: { ko: '오늘부터 고급반이에요.', zh: '从今天起是高级班。' },
      tip: '고(高) + 급(级) + 반(班). 중급반의 다음 단계',
    },
    {
      id: 'd61-w2',
      korean: '원어민',
      ...
      zh: '母语者',
      pos: '名词',
      example: { ko: '원어민처럼 말해요.', zh: '像母语者一样说话。' },
      tip: '원(原) + 어(语) + 민(民). 韩语原语言使用者',
    },
    {
      id: 'd61-w3',
      korean: '자신감',
      ...
      zh: '自信',
      pos: '名词',
      example: { ko: '자신감이 없어요.', zh: '没自信。' },
      tip: 'Day 45 学过. 이 날은 반대: 자신감이 떨어지다',
    },
    {
      id: 'd61-w4',
      korean: '차이',
      ...
      zh: '差别/差距',
      pos: '名词',
      example: { ko: '차이가 너무 커요.', zh: '差距太大了。' },
      tip: 'Day 56 学过. 이 날은 실력 차이',
    },
    {
      id: 'd61-w5',
      korean: '틀리다',
      ...
      zh: '错/答错',
      pos: '动词',
      example: { ko: '문법 하나도 안 틀렸어요.', zh: '语法一处都没错。' },
      tip: '반의: 맞다(对). 시험/답변 상황 자주 씀',
    },
    {
      id: 'd61-w6',
      korean: '실력',
      ...
      zh: '实力',
      pos: '名词',
      example: { ko: '실력 차이가 커요.', zh: '实力差距很大。' },
      tip: 'Day 31·43 学过. 이 날은 자신을 낮게 봄',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '火鹤老师安慰完，Tori想说"我会更努力"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '네, 저도 계속 노력할게요.', zh: '好的，我会继续努力。', correct: true },
          { ko: '저는 이제 안 할래요.', zh: '我不想学了。', correct: false },
          { ko: '다니엘 씨가 최고예요.', zh: 'Danielle最厉害。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '像___一样：~처럼',
    pattern: 'N + **처럼** + V/A',
    whenToUse: '「像___一样」的比喻/比较句尾。Tori 说 「원어민**처럼** 발음해요」= 像母语者一样发音。~처럼 直接接名词，是韩语最刚需的比喻——夸人像明星、抱怨像小孩、羡慕像本地人都用它。',
    rules: [
    ...
    examples: [
      { ko: '다니엘 씨는 원어민처럼 발음해요.', zh: 'Danielle发音像母语者。', highlight: '원어민처럼', note: 'N + 처럼 = 像N一样. Day 61 主题句' },
      { ko: '눈이 별처럼 빛나요.', zh: '眼睛像星星一样闪。', highlight: '별처럼', note: '별(星) + 처럼 + 빛나다(闪光). 감성 표현' },
      { ko: '아이처럼 웃었어요.', zh: '像小孩一样笑了。', highlight: '아이처럼', note: '아이(小孩) + 처럼 + 웃다. 관용 비유' },
      { ko: '한국 사람같이 자연스러워요.', zh: '像韩国人一样自然。', highlight: '한국 사람같이', note: '같이(N 뒤) = 처럼과 같은 뜻. 실사용에서 흔함' },
    ],
    pitfall:
  ...
  output: [
    {
      id: 'd61-o1',
      kind: 'compose',
      zhHint: 'Danielle 像母语者一样发音。',
      tokens: ['다니엘 씨는', '원어민처럼', '발음해요', '원어민이', '발음이에요', '원어민을'],
      composeAnswer: ['다니엘 씨는', '원어민처럼', '발음해요'],
      successMsg: '~처럼 = 像...一样. 비교/비유의 정석.',
    },
    {
      id: 'd61-o2',
      kind: 'listen-choice',
      audioKo: '각자 속도가 있어요.',
      successMsg: '✓ 火鹤老师的一句. 각자 = 各自.',
      choices: [
        { zh: '各自有自己的节奏。', correct: true },
        { zh: '所有人都一样。', correct: false },
        { zh: '速度都一样。', correct: false },
        { zh: '没有速度。', correct: false },
      ],
    },
    {
      id: 'd61-o3',
    ...
    },
    {
      ...
      kind: 'particle-error',
      zhHint: '像韩国人一样自然。',
      successMsg: '한국 사람 + **같이** = 像韩国人一样 (같이 = 처럼 같은 뜻).',
      choices: [
    ...
    },
    {
      id: 'd61-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 61 全对. 각자 속도가 있어요.',
      pairs: [
        { ko: '고급반', zh: '高级班' },
        { ko: '원어민', zh: '母语者' },
        { ko: '차이', zh: '差距' },
  ...
  recap: {
    ...
    preview: '明天 Tori 去咖啡馆面试打工——熊店长会怎么问？',
    stickerId: 'sticker-d61',
    sceneImageUrl: '/images/diary/day-61-scene.jpg',
  },

  carrotHint: '今天的胡萝卜：「~처럼 和 ~같이 有什么区别？」「원어민처럼 怎么练？」',
};
