...
胡萝卜在口袋里好像也笑了一下。`,
  ...
  words: [
    ...
    },
    {
      ...
      zh: '可乐',
      pos: '名词',
      example: { ko: '콜라 한 잔 주세요.', zh: '请给我一杯可乐。' },
  ...
  grammar: {
    title: '请给我 ___ : ~ 주세요',
    pattern: 'N + 을/를 (可省略) + 주세요',
    whenToUse: '点单、问别人要东西、请求帮忙。韩国生活第一个万能句型：只要在名词后加「주세요」就变成礼貌请求。',
    rules: [
    ...
    examples: [
      { ko: '콜라 주세요.', zh: '请给我可乐。', highlight: '주세요', note: '콜라 无받침，直接加 주세요。口语省略 을/를' },
      { ko: '물 한 잔 주세요.', zh: '请给我一杯水。', highlight: '주세요', note: '물(水) + 한 잔(一杯，量词) + 주세요。한 잔 夹在中间' },
      { ko: '메뉴 주세요.', zh: '请给我菜单。', highlight: '주세요', note: '메뉴 无받침 → 直接加 주세요。餐厅第一步' },
      { ko: '도와주세요!', zh: '请帮帮我！', highlight: '도와주세요', note: '돕다(帮) → 도와(词干变形) + 주세요 = 请帮我。固定组合' },
      { ko: '메뉴 부탁드립니다.', zh: '麻烦给我菜单。（最礼貌）', highlight: '부탁드립니다', note: '比 주세요 更正式，对长辈或高级餐厅用' },
      { ko: '콜라를 주세요.', zh: '请给我可乐。（加宾格助词）', highlight: '를', note: '콜라 无받침 → 宾格 조사 를。加了更语法正确，但口语常省略' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      kind: 'zh-to-ko',
      zhPrompt: '好的，请给我一杯可乐。',
      successMsg: '"네, 콜라 한 잔 주세요." — 兔莉的人生第一次韩语点单。',
      choices: [
