...
胡萝卜在口袋里好像也笑了一下。`,
  ...
  grammar: {
    ...
    examples: [
      { ko: '콜라 주세요.', zh: '请给我可乐。', highlight: '주세요' },
      { ko: '물 한 잔 주세요.', zh: '请给我一杯水。', highlight: '주세요' },
      { ko: '메뉴 주세요.', zh: '请给我菜单。', highlight: '주세요' },
      { ko: '도와주세요.', zh: '请帮帮我。', highlight: '주세요' },
    ],
    pitfall:
  ...
  carrotHint:
    '今天的胡萝卜：可以问它「飞机上韩语怎么说水/咖啡/茶」「主세요前面要加什么助词吗」',
};
