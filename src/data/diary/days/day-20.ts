...
export const day20: ToriDay = {
  ...
  day: 20,
  phase: 'expansion',
  title: '签约前夜 · 海豹房东走进了房间',
  subtitle: '500/50/5 따로 — Tori的笔记本写满了',
...
大概没想到留学生会问这个。`,
  ...
  words: [
    {
      ...
      zh: '房东',
      pos: '名词',
      example: { ko: '집주인이 친절해요.', zh: '房东很亲切。' },
      tip: '집(房) + 주인(主人) = 房东。韩国租房时房东权力很大',
    },
    {
      id: 'd20-w2',
      korean: '계약',
      ...
      zh: '合同',
      pos: '名词',
      example: { ko: '계약서를 잘 읽어 보세요.', zh: '请仔细看合同。' },
      tip: '계(契) + 약(约)。계약하다 = 签合同',
    },
    {
      id: 'd20-w3',
      korean: '관리비',
    ...
    },
    {
      ...
      zh: '单独；另外',
      pos: '副词',
      example: { ko: '관리비는 따로예요.', zh: '管理费另算。' },
      tip: '따로 = 分开/另外。房东说"따로"意思是"不包含在月租里"',
    },
    {
      id: 'd20-w5',
      korean: '들어 있어요',
      ...
      zh: '包含；装着',
      pos: '表达',
      example: { ko: '관리비에 수도세가 들어 있어요.', zh: '管理费里包含水费。' },
      tip: '들다(进入) + 어 있다(持续状态) = 被包含在里面',
    },
    {
      id: 'd20-w6',
      korean: '질문',
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: 'Tori想确认水电费是否都包含在管理费里，她应该怎么问？',
        practice: 'pick',
        choices: [
  ...
  grammar: {
    title: '里面包含什么：N에 뭐가 들어 있어요?',
    pattern: 'N + **에** + 뭐가 + **들어 있어요**? = ___里包含什么？',
    whenToUse: '询问某个东西里面包含/装着什么。Day 20 兔莉问"관리비에 뭐가 들어 있어요?"——管理费里包含什么。这是租房签约时必须问的句子。',
    rules: [
    ...
    examples: [
      { ko: '관리비에 뭐가 들어 있어요?', zh: '管理费包含什么？', highlight: '에 ... 들어 있어요', note: '관리비 + 에(在……里) + 뭐가(什么) + 들어 있어요(包含)。租房必问句' },
      { ko: '가방에 뭐가 들어 있어요?', zh: '包里装着什么？', highlight: '에 ... 들어 있어요', note: '가방(包) + 에。同样结构，不同场景——过海关时也可能被问' },
      { ko: '수도세가 들어 있어요.', zh: '包含水费。', highlight: '들어 있어요', note: '수도세(水费) + 가(主格)。回答"包含什么"时，用 이/가 + 들어 있어요' },
      { ko: '전기세는 따로예요.', zh: '电费另算。', highlight: '따로', note: '전기세(电费) + 는(主题) + 따로(另外)。따로 是"不包含在内"的关键词' },
      { ko: '이 세트에 음료도 들어 있어요?', zh: '这个套餐也包含饮料吗？', highlight: '에 ... 들어 있어요', note: '세트(套餐) + 에 + 음료(饮料) + 도(也) + 들어 있어요?。点餐时也能用' },
    ],
    pitfall:
  ...
  output: [
    {
      ...
      successMsg: '관리비에 뭐가 들어 있어요? — 海豹房东愣了一下，然后认真回答了。',
    },
    {
      id: 'd20-o2',
      kind: 'listen-choice',
      audioKo: '보증금 500만, 월세 50만, 관리비 5만 따로예요.',
      successMsg: '✓ 500/50/5 따로——记住这组数字，签约前确认清楚。',
      choices: [
        { zh: '押金500万，月租50万，管理费5万另算。', correct: true },
        { zh: '一共555万韩元。', correct: false },
        { zh: '押金50万，月租500万。', correct: false },
        { zh: '管理费包含在月租里。', correct: false },
      ],
    },
    {
      id: 'd20-o3',
      kind: 'zh-to-ko',
      zhPrompt: '包里装着什么？',
      successMsg: '"가방에 뭐가 들어 있어요?" — 同样句式，换个名词就行。',
      choices: [
    ...
    },
    {
      ...
      kind: 'particle-error',
      zhHint: '管理费包含什么？',
      successMsg: '관리비 + 에（在里面）；뭐 + 가（什么·主格）。에 不能省。',
      choices: [
    ...
    },
    {
      id: 'd20-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 20 全对。明天签合同，Tori准备好了。',
      pairs: [
        { ko: '집주인', zh: '房东' },
        { ko: '계약', zh: '合同' },
        { ko: '관리비', zh: '管理费' },
