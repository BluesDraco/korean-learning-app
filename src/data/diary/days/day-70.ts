...
export const day70: ToriDay = {
  ...
  phase: 'mastery',
  title: '辩论赛 · "작지만 강하다"',
  subtitle: 'Tori vs Danielle — 讲台上的和解',
...
70 天了——这是她第一次和我正面相视地笑。`,
  ...
  words: [
    {
      ...
      zh: '辩论/讨论',
      pos: '名词',
      example: { ko: '토론대회에서 이겼어요.', zh: '辩论赛赢了。' },
      tip: '討(토) + 论(론). 토론하다 = 辩论',
    },
    {
      id: 'd70-w2',
      ...
      zh: '决定',
      pos: '动词',
      example: { ko: '체형이 능력을 결정하지 않아요.', zh: '体型不决定能力。' },
      tip: '决(결) + 定(정) + 하다',
    },
    {
      id: 'd70-w3',
      ...
      zh: '多样性',
      pos: '名词',
      example: { ko: '진짜 다양성이에요.', zh: '是真正的多样性。' },
      tip: '多(다) + 样(양) + 性(성). 반차별 담론 핵심어',
    },
    {
      id: 'd70-w4',
      korean: '강하다',
    ...
    },
    {
      ...
      zh: '承认',
      pos: '动词',
      example: { ko: '잘했어. 인정할게.', zh: '干得好，我承认。' },
      tip: '认(인) + 定(정) + 하다. 논쟁의 마무리',
    },
    {
      id: 'd70-w6',
      korean: '눈높이',
      ...
      zh: '视角/视线高度',
      pos: '名词',
      example: { ko: '사자의 눈높이에서 안 보이는 길이 있어요.', zh: '狮子视角看不到的路。' },
      tip: '눈(眼) + 높이(高度). 관점의 은유',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: 'Danielle 认输并走过来握手。Tori想友好回应表达"以后一起加油"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '고마워. 다니엘도 진짜 잘했어. 같이 배워가자.', zh: '谢谢。Danielle也很棒。以后一起学。', correct: true },
          { ko: '내가 이겼으니까 이제 됐어.', zh: '我赢了就够了。', correct: false },
          { ko: '너 항상 완벽하잖아. 부러워.', zh: '你总是那么完美，好羡慕。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '虽然___但是___：~지만 (Day 48·60 심화 · 논쟁 문형)',
    pattern: 'V/A + **지만** + Result',
    whenToUse: 'Day 48 学过 ~지만 (转折)，Day 60 学过 ~았/었지만 (过去转折). Day 70 = **논쟁/자기 정의** 상황의 ~지만. Tori 说 「**작지만** 강하다」= 虽小但强。~지만 = 韩语最刚需의 논쟁 문형—承认 A 但主张 B.',
    rules: [
    ...
    examples: [
      { ko: '작지만 강하다.', zh: '虽小但强。', highlight: '작지만 강하다', note: '작다 → 작지만. Day 70 Tori 명제' },
      { ko: '체형은 작지만 능력은 큽니다.', zh: '体型虽小能力大。', highlight: '작지만 ... 큽니다', note: '주어 대비 + ~지만 = 격식체 논쟁' },
      { ko: '어제는 졌지만 오늘은 이겼어요.', zh: '昨天输了但今天赢了。', highlight: '졌지만 ... 이겼어요', note: '과거 ~았/었지만 대비. Day 60 복습' },
      { ko: '실수했지만 배웠어요.', zh: '虽然失误但学到了。', highlight: '실수했지만 ... 배웠어요', note: '실수하다 → 실수했지만. 성장 관점' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      choices: [
        { zh: '干得好。我承认。', correct: true },
        { zh: '不错。我不服。', correct: false },
        { zh: '还行。差不多。', correct: false },
        { zh: '你输了。承认吧。', correct: false },
      ],
    },
    {
      id: 'd70-o3',
    ...
    },
    {
      id: 'd70-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 70 全对. Danielle 과의 첫 웃음.',
      pairs: [
        { ko: '토론', zh: '辩论' },
        { ko: '결정하다', zh: '决定' },
        { ko: '다양성', zh: '多样性' },
  ...
  recap: {
    ...
    preview: '明天 4명이 고속열차로 부산 여행. 첫 국내 여행!',
    stickerId: 'sticker-d70',
    sceneImageUrl: '/images/diary/day-70-scene.jpg',
  },

  carrotHint: '今天的胡萝卜: 「~지만 논쟁에서 어떻게 강력?」「Danielle이 왜 인정했을까?」',
};
