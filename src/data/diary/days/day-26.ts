  ...
  output: [
    {
      ...
      kind: 'compose',
      zhHint: '能推荐一杯吗？',
      tokens: ['메뉴', '하나', '추천해', '주실 수 있어요', '?', '없어요', '주세요'],
      composeAnswer: ['메뉴', '하나', '추천해', '주실 수 있어요', '?'],
    ...
    },
    {
      ...
      kind: 'compose',
      zhHint: '请给我一杯热的粉色拿铁。',
      tokens: ['따뜻한', '핑크 라떼', '한 잔', '주세요', '얼음', '빼고요', '있어요'],
      composeAnswer: ['따뜻한', '핑크 라떼', '한 잔', '주세요'],
      successMsg: '✓ 第二题：点单完成。',
    },
    {
      id: 'd26-o3',
      kind: 'listen-choice',
      audioKo: '한 잔당 사진 카드 한 장이에요.',
      successMsg: '✓ 「一杯送一张小卡」。「한 잔당」= 每一杯（量词 + 당 = 每个）。',
      choices: [
        { zh: '一杯送一张小卡。', correct: true },
        { zh: '一张小卡 1000 元。', correct: false },
        { zh: '一个人一张卡。', correct: false },
        { zh: '一张卡一杯饮料。', correct: false },
      ],
    },
    {
      id: 'd26-o4',
      kind: 'zh-to-ko',
      zhPrompt: '朋友带我来过。今天一个人来。',
      successMsg: '"데려와 줬어요" 是过去时礼貌；「혼자 왔어요」= 一个人来了。',
      choices: [
        { ko: '친구가 데려와 줬어요. 오늘은 혼자 왔어요.', correct: true },
        { ko: '친구가 데려가 줬어요. 오늘은 혼자 왔어요.', correct: false },
        { ko: '친구가 데려와 줘요. 오늘은 혼자 와요.', correct: false },
        { ko: '친구는 데려와 줬어요. 오늘에 혼자 왔어요.', correct: false },
      ],
    },
    {
      id: 'd26-o5',
