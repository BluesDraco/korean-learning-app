...
镜子里的兔莉，好像可爱了不少。`,
  ...
  words: [
    {
      ...
      zh: '需要',
      pos: '形容词',
      example: { ko: '샴푸 필요해요.', zh: '需要洗发水。' },
      tip: '필요(必要) + 하다。N이/가 필요하다 = 需要___',
    },
    {
      id: 'd26-w2',
      korean: '사다',
      ...
      zh: '买',
      pos: '动词',
      example: { ko: '볼펜을 샀어요.', zh: '买了圆珠笔。' },
      tip: '사다 → 사요(해요体)；샀어요(过去)。사 末元音ㅏ→아요 缩合=사요',
    },
    {
      id: 'd26-w3',
      korean: '귀',
      ...
      zh: '耳朵',
      pos: '名词',
      example: { ko: '펜을 귀에 꽂았어요.', zh: '把笔别在耳朵上了。' },
      tip: '귀 无收音。귀에(在耳朵上)；귀걸이 = 耳环',
    },
    {
      id: 'd26-w4',
      korean: '볼펜',
      ...
      zh: '圆珠笔',
      pos: '名词',
      example: { ko: '이 당근 볼펜 얼마예요?', zh: '这个胡萝卜笔多少钱？' },
      tip: '볼(ball) + 펜(pen)。韩式外来语复合词',
    },
    {
      id: 'd26-w5',
      korean: '키링',
      ...
      zh: '钥匙扣',
      pos: '名词',
      example: { ko: '당근 키링 귀여워요!', zh: '胡萝卜钥匙扣好可爱！' },
      tip: '英语 key ring 的韩式外来语。大创에서 많이 팔아요',
    },
    {
      id: 'd26-w6',
      korean: '귀엽다',
      ...
      zh: '可爱',
      pos: '形容词',
      example: { ko: '이거 진짜 귀여워요!', zh: '这个真的好可爱！' },
      tip: '귀엽다 是 ㅂ불규칙：귀엽+어요 → 귀여워요（ㅂ→우）',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: 'Tori决定买这支胡萝卜笔。她应该怎么跟店员说？',
        practice: 'pick',
        choices: [
          { ko: '이것도 주세요. 귀여워요!', zh: '这个也要。好可爱！', correct: true },
          { ko: '필요 없어요.', zh: '不需要。', correct: false },
          { ko: '비싸요.', zh: '太贵了。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '需要：N이/가 필요해요',
    pattern: 'N(有收音) + **이** 필요해요  /  N(无收音) + **가** 필요해요 = 需要___',
    whenToUse: '表达"需要某东西"。필요하다(需要) 是形容词，前面的名词用主格助词 이/가。Day 26 兔莉说"샴푸 필요해요"——买东西时告诉店员自己需要什么。',
    rules: [
    ...
    examples: [
      { ko: '샴푸 필요해요.', zh: '需要洗发水。', highlight: '필요해요', note: '샴푸 무收音 → 가 可省略。口语自然省略형' },
      { ko: '돈이 필요해요.', zh: '需要钱。', highlight: '이 필요해요', note: '돈 有收音ㄴ → 이 필요해요。이 在口语中也可省但书面保留' },
      { ko: '시간이 더 필요해요.', zh: '需要更多时间。', highlight: '이 필요해요', note: '시간 有收音ㄴ → 이。더(更) 放在 필요해요 前面' },
      { ko: '우산 필요 없어요.', zh: '不需要雨伞。', highlight: '필요 없어요', note: '필요 없다 = 不需要。없다 是独立形容词，和 필요 之间有空格' },
      { ko: '이거 진짜 귀여워요!', zh: '这个真的好可爱！', highlight: '귀여워요', note: '귀엽다 ㅂ불규칙 → 귀엽+어요 = 귀여워요。ㅂ→우+ㅓ=워' },
    ],
    pitfall:
  ...
  output: [
    {
      ...
      successMsg: '샴푸 필요해요. 그리고 수건도요. — 大创에서 완벽한 쇼핑!',
    },
    {
      id: 'd26-o2',
      kind: 'listen-choice',
      audioKo: '천 원이에요. 귀여워요, 안 그래요?',
      successMsg: '✓ 천 원 = 1000元；귀여워요 = 可爱；안 그래요? = 对吧？',
      choices: [
        { zh: '1000元。很可爱吧？', correct: true },
        { zh: '1万元。很贵吧？', correct: false },
        { zh: '免费的。要吗？', correct: false },
        { zh: '1000元。太丑了吧？', correct: false },
      ],
    },
    {
      id: 'd26-o3',
      kind: 'zh-to-ko',
      zhPrompt: '需要钱。',
      successMsg: '"돈이 필요해요." — 돈 有收音ㄴ → 이 필요해요。',
      choices: [
    ...
    },
    {
      ...
      kind: 'particle-error',
      zhHint: '这个真的好可爱！',
      successMsg: '귀엽다 ㅂ불규칙 → 귀여워요（ㅂ脱落→우+ㅓ=워）。',
      choices: [
    ...
    },
    {
      id: 'd26-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 26 全对。胡萝卜笔已别在耳朵上，和Tori一起出发。',
      pairs: [
        { ko: '필요하다', zh: '需要' },
        { ko: '사다', zh: '买' },
        { ko: '귀엽다', zh: '可爱' },
  ...
  recap: {
    ...
    preview: '明天四人聚餐——Tori要第一次请客。韩语怎么说"我来付"？',
