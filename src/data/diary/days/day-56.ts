...
用韩语。`,
  ...
  words: [
    {
      ...
      zh: '新生',
      pos: '名词',
      example: { ko: '새 학기라서 신입생이 왔어요.', zh: '因为开学季来了新生。' },
      tip: '新(신) + 入(입) + 生(생). 신입 짧게도 씀',
    },
    {
      id: 'd56-w2',
      korean: '터지다',
      ...
      zh: '爆开/破',
      pos: '动词',
      example: { ko: '가방이 터졌어요.', zh: '包爆开了。' },
      tip: '자동. 캐리어 터지다 = 行李箱爆开',
    },
    {
      id: 'd56-w3',
      korean: '정리하다',
      ...
      zh: '整理/收拾',
      pos: '动词',
      example: { ko: '같이 정리해요.', zh: '一起收拾。' },
      tip: '整(정) + 理(리) + 하다. 방을 정리하다 / 짐을 정리하다',
    },
    {
      id: 'd56-w4',
      korean: '똑같다',
      ...
      zh: '一模一样',
      pos: '形容词',
      example: { ko: '진짜 똑같았어요.', zh: '真的一模一样。' },
      tip: '똑(完全) + 같다(相同). 强化的"같다"',
    },
    {
      id: 'd56-w5',
      korean: '받침',
      ...
      zh: '收音',
      pos: '名词',
      example: { ko: '받침이 하나 다를 뿐이에요.', zh: '只是收音差一个字母。' },
    ...
    },
    {
      ...
      zh: '差别/差异',
      pos: '名词',
      example: { ko: '작은 차이지만 뜻이 완전히 달라요.', zh: '虽小差别但意思完全不同。' },
      tip: '差(차) + 异(이). 작은 차이 = 微小差别',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '小兔子红着眼道谢。Tori想让她放心"以后有困难可以找自己"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '어려운 일 있으면 언제든 얘기해요.', zh: '有困难随时告诉我。', correct: true },
          { ko: '이제 안 도와줄 거예요.', zh: '以后不帮你了。', correct: false },
          { ko: '학교는 어차피 힘들어요.', zh: '学校反正很累。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '经历过___：~아/어 봤어요（Day 43 深化）',
    pattern: 'V + **아/어 봤어요**',
    whenToUse: 'Day 43 学过 ~아/어 보다 = 尝试。**~아/어 봤어요** = 尝试过 = **有过经验**。Tori 说 「나도 처음에 똑같이 실수해 **봤어요**」= 我一开始也犯过一模一样的错。Day 56 主题是"我有过和你一样的经验"——~아/어 봤어요 是承担别人痛苦的一句话。',
    rules: [
    ...
    examples: [
      { ko: '나도 처음에 똑같이 실수해 봤어요.', zh: '我一开始也犯过一模一样的错。', highlight: '실수해 봤어요', note: '실수하다 → 실수해 봤어요. Tori对新生说的关键句' },
      { ko: '한국 음식을 다 먹어 봤어요.', zh: '韩国料理都尝过。', highlight: '먹어 봤어요', note: '먹다 → 먹어 봤어요. 경험 강조' },
      { ko: '동물문 시장에 가 봤어요?', zh: '你去过동물문市场吗？', highlight: '가 봤어요', note: '가다 → 가 봤어요. 경험 질문' },
      { ko: '한국어로 발표해 봤어요.', zh: '用韩语发表过。', highlight: '발표해 봤어요', note: '발표하다 → 발표해 봤어요. Day 42 회고' },
    ],
    pitfall:
  ...
  output: [
    {
      id: 'd56-o1',
      kind: 'compose',
      zhHint: '我一开始也犯过一模一样的错。',
      tokens: ['나도', '처음에', '똑같이', '실수해', '봤어요', '실수했어요', '실수해요'],
      composeAnswer: ['나도', '처음에', '똑같이', '실수해', '봤어요'],
      successMsg: '~아/어 봤어요 = 有过经验. Tori成为Haru的一刻.',
    },
    {
      id: 'd56-o2',
      kind: 'listen-choice',
      audioKo: '집은 house, 짐은 luggage. 받침 하나 차이예요.',
      successMsg: '✓ Day 3 → Day 56 의 回声. 짐/집 差别就是ㅂ 和ㅁ.',
      choices: [
        { zh: '집 = 家、짐 = 行李。只是收音差一个字母。', correct: true },
        { zh: '집 和 짐 完全一样。', correct: false },
        { zh: '집 是英语。', correct: false },
        { zh: '差异很大。', correct: false },
      ],
    },
    {
      id: 'd56-o3',
    ...
    },
    {
      ...
      kind: 'particle-error',
      zhHint: '没吃过泡菜汤。（부정 경험）',
      successMsg: '否定要用 **~아/어 본 적이 없어요**. 不用 안 + ~아/어 봤어요.',
      choices: [
    ...
    },
    {
      id: 'd56-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 56 全对。이제 내가 그 사람이 됐어요.',
      pairs: [
        { ko: '신입생', zh: '新生' },
        { ko: '터지다', zh: '爆开' },
        { ko: '정리하다', zh: '收拾' },
