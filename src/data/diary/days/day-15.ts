...
我突然觉得自己开始像个首尔人了。`,
  ...
  grammar: {
    ...
    examples: [
      { ko: '원룸 찾고 있어요.', zh: '我在找一居室。', highlight: '찾고 있어요' },
      { ko: '한국어 공부하고 있어요.', zh: '我在学韩语。', highlight: '공부하고 있어요' },
      { ko: '뭐 하고 있어요?', zh: '你在做什么？', highlight: '하고 있어요' },
      { ko: '책 읽고 있어요.', zh: '我在看书。', highlight: '읽고 있어요' },
    ],
    pitfall:
