...
明天，我就要去兽尔了。`,
  ...
  words: [
    ...
    },
    {
      ...
      zh: '谢谢',
      pos: '表达',
      example: { ko: '감사합니다, 엄마.', zh: '谢谢妈妈。' },
      tip: '最高敬语版的"谢谢"。「감사해요」更日常，「고마워」是반말。第一天先学最稳的',
    },
  ],
  ...
  grammar: {
    title: '我是 ___ : 이에요 / 예요',
    pattern: 'N(有收音) + 이에요  /  N(无收音) + 예요',
    whenToUse: '韩语第一课——介绍自己、说"是什么"。이에요/예요 是最常用的句尾之一，相当于中文的"是"。Day 1 兔莉对镜子说"안녕하세요, 저는 토리예요"。',
    rules: [
    ...
    examples: [
      { ko: '저는 토리예요.', zh: '我是兔莉。', highlight: '예요', note: '토리 末字"리"无收音 → 예요。저 无收音 → 는。第一天最重要的一句' },
      { ko: '저는 학생이에요.', zh: '我是学生。', highlight: '이에요', note: '학생 末字"생"有收音 ㅇ → 이에요。학(学) + 생(生) 都是汉字词' },
      { ko: '저는 중국 사람이에요.', zh: '我是中国人。', highlight: '이에요', note: '사람 末字"람"有收音 ㅁ → 이에요。중국(中国) + 사람(人)' },
      { ko: '이름은 토리예요.', zh: '名字是兔莉。', highlight: '예요 + 은', note: '이름 有收音 ㅁ → 主题助词 은。토리 无收音 → 예요。은/는 + 이에요/예요 首次同框' },
      { ko: '제 이름은 토리예요.', zh: '我的名字是兔莉。', highlight: '제 ... 은', note: '제 = 저의(我的)缩写。完整自我介绍: 저는 ___예요 + 제 이름은 ___예요' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      kind: 'listen-choice',
      audioKo: '저는 중국 사람이에요.',
      successMsg: '✓ 是这句。这一句兔莉明天会反复用到。',
      choices: [
        { zh: '我是中国人。', correct: true },
        { zh: '我是韩国人。', correct: false },
        { zh: '我的名字是兔莉。', correct: false },
        { zh: '很高兴认识你。', correct: false },
      ],
    },
    {
      id: 'd01-o3',
      kind: 'zh-to-ko',
      zhPrompt: '我的名字是兔莉。',
      successMsg: '"제 이름은 토리예요." — 标准自我介绍开头。',
      choices: [
    ...
    },
    {
      id: 'd01-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 1 核心词全部对上。明天，机场见。',
      pairs: [
        { ko: '안녕하세요', zh: '你好' },
        { ko: '저', zh: '我（敬语）' },
        { ko: '이름', zh: '名字' },
