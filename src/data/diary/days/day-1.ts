...
明天，我就要去兽尔了。`,
  ...
  grammar: {
    ...
    rules: [
      '名词最后一个字 有收音(받침) → 이에요：학생 → 학생**이에요**',
      '名词最后一个字 没有收音(받침) → 예요：토리 → 토리**예요**',
      '助词「은/는」表示「这个话题」：저**는** = "至于我"',
    ],
    examples: [
      { ko: '저는 토리예요.', zh: '我是兔莉。', highlight: '예요', note: '**토리** 末字「리」받침 없음 → 用 **예요**；주제조사 **는** 因为 저 받침 없음' },
      { ko: '저는 학생이에요.', zh: '我是学生。', highlight: '이에요', note: '**학생** 末字「생」받침 있음 ㅇ → 用 **이에요**' },
      { ko: '저는 중국 사람이에요.', zh: '我是中国人。', highlight: '이에요', note: '**사람** 末字「람」받침 있음 ㅁ → 用 **이에요**' },
      { ko: '이름은 토리예요.', zh: '名字是兔莉。', highlight: '예요', note: '**이름** 받침 있음 ㅁ → 主题助词用 **은**；토리 받침 없음 → **예요**' },
    ],
    pitfall:
      '「토리」最后一字「리」无收音(받침 없음)（리 = 초성 ㄹ + 중성 ㅣ，没有终声）→ 用 예요。「사람」最后一字「람」有收音(받침) ㅁ → 用 이에요。判断只看「最后一个字的终声」，不是整个词。',
  },
