...
30天。我从"안녕하세요"走到了"중급반"。`,
  ...
  words: [
    ...
    },
    {
      ...
      zh: '考试',
      pos: '名词',
      example: { ko: '시험을 잘 봤어요.', zh: '考试考好了。' },
      tip: '시(试) + 험(验)。시험을 보다 = 考试（固定搭配）',
    },
    {
      id: 'd30-w3',
      korean: '합격',
      ...
      zh: '合格',
      pos: '名词',
      example: { ko: '합격했어요!', zh: '合格了！' },
      tip: '합(合) + 격(格)。합격하다 = 合格/通过',
    },
    {
      id: 'd30-w4',
      korean: '행복',
    ...
    },
    {
      ...
      zh: '失误',
      pos: '名词',
      example: { ko: '실수도 많았지만 행복했어요.', zh: '虽然失误很多但很幸福。' },
      tip: '실(失) + 수(手/误)。실수하다 = 犯错',
    },
    {
      id: 'd30-w6',
      korean: '중급',
      ...
      zh: '中级',
      pos: '名词',
      example: { ko: '중급반으로 올라가요.', zh: '升到中级班。' },
      tip: '중(中) + 급(级)。초급(初级)→중급(中级)→고급(高级)',
    },
  ],
  ...
  grammar: {
    title: '毕业自述5段',
    pattern: '인사(问候) → 시작(开始) → 추억(回忆) → 성과(成果) → 끝인사(结束寒暄)',
    whenToUse: '韩国学校/公司正式场合的自述/感言结构。Day 30 Tori在全班面前用这5段说了30天的感受。',
    rules: [
    ...
    examples: [
      { ko: '30일 전에 한국에 왔어요.', zh: '30天前来到韩国。', highlight: '전에 ... 왔어요', note: '시간 + 전에(之前) + 과거시제。叙述起点的标准句' },
      { ko: '실수도 많았지만, 행복했어요.', zh: '虽然失误多，但很幸福。', highlight: '지만', note: '많았다(多·过去) + 지만(但是) + 행복했어요。转折回忆' },
      { ko: '합격했어요!', zh: '合格了！', highlight: '했어요', note: '합격하다 → 했어요。宣布成果的瞬间' },
      { ko: '앞으로도 잘 살게요.', zh: '今后也会好好生活。', highlight: '살게요', note: '살다(活/生活) + ㄹ게요(承诺)。살다 ㄹ词干 + 게요 = 살게요' },
      { ko: '진짜 감사합니다.', zh: '真的感谢。', highlight: '감사합니다', note: '합쇼체最高正式感谢。毕业/升级时的标准结尾' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      successMsg: '✓ 합격 = 合格；중급반 = 中级班；올라가세요 = 请升上去。毕业了！',
      choices: [
        { zh: 'Tori同学，合格。升入中级班。', correct: true },
        { zh: 'Tori同学，不合格。重修。', correct: false },
        { zh: 'Tori同学，考试取消了。', correct: false },
        { zh: 'Tori同学，回家吧。', correct: false },
      ],
    },
    {
      id: 'd30-o4',
      kind: 'zh-to-ko',
      zhPrompt: '30天前来到韩国。',
      successMsg: '"30일 전에 한국에 왔어요." — 전에 + 과거시제，叙述起点。',
      choices: [
  ...
  recap: {
    ...
    preview: '30天的旅程结束了——但Tori的故事才刚刚开始。중급반에서 만나요!',
