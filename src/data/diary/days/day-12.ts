...
我做到了。`,
  ...
  grammar: {
    title: '汉字数词 · 价格/号码/年月日',
    pattern: '일(1) 이(2) 삼(3) 사(4) 오(5) 육(6) 칠(7) 팔(8) 구(9) 십(10) 백(百) 천(千) 만(万)',
    ...
    examples: [
      { ko: '오백원이에요.', zh: '500 韩元。', highlight: '오백', note: '오(5) + 백(100) = 五百。500원 约合人民币 2.5 元' },
      { ko: '삼천원이에요.', zh: '3000 韩元。', highlight: '삼천', note: '삼(3) + 천(1000) = 三千。3000원 约合人民币 15 元' },
      { ko: '만 이천원이에요.', zh: '12000 韩元。', highlight: '만 이천', note: '만(10000) + 이천(2000) = 一万二千。以万为基准拆分' },
      { ko: '오만원이에요.', zh: '50000 韩元。', highlight: '오만', note: '오(5) + 만(10000) = 五万。韩国最大面值纸币就是 오만원' },
      { ko: '이거 얼마예요?', zh: '这个多少钱？', highlight: '얼마예요', note: '얼마(多少) + 예요(是)。购物万能问句，无收音→예요' },
      { ko: '삼백오십 번이에요.', zh: '是 350 号。', highlight: '삼백오십 번', note: '삼백(300) + 오십(50) + 번(号)。报号码用汉字数词' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      kind: 'particle-error',
      zhHint: '5000 元。',
      successMsg: '「오천」(五千)。汉字数 5+1000。원 前不加额外助词。',
      choices: [
  ...
  recap: {
    ...
    preview: '夜里突然感冒了，喉咙火烧一样。明天 Haru 要敲门带我去약국（药店）——第一次用韩语说哪里不舒服。',
