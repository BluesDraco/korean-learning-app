...
然后什么都没问，坐下来跟我一起看那三行信。`,
  ...
  words: [
    {
      ...
      zh: '包裹',
      pos: '名词',
      example: { ko: '엄마가 소포를 보냈어요.', zh: '妈妈寄了包裹。' },
      tip: '小(소) + 包(포)。汉字词。택배 = 快递（国内更常用）',
    },
    {
      id: 'd36-w2',
      korean: '보내다',
      ...
      zh: '寄/送',
      pos: '动词',
      example: { ko: '엄마가 편지를 보내주셨어요.', zh: '妈妈给我寄了信。' },
      tip: '보내다(寄) → 보내요 / 보냈어요 / 보내주다(为我寄)',
    },
    {
      id: 'd36-w3',
      korean: '경비실',
      ...
      zh: '值班室/保安室',
      pos: '名词',
      example: { ko: '경비실에서 소포를 찾았어요.', zh: '在值班室拿到了包裹。' },
      tip: '警备(경비) + 室(실)。宿舍/公寓一楼收快递的地方',
    },
    {
      id: 'd36-w4',
      korean: '고춧가루',
      ...
      zh: '辣椒粉',
      pos: '名词',
      example: { ko: '엄마가 고춧가루도 보냈어요.', zh: '妈妈还寄了辣椒粉。' },
      tip: '고추(辣椒) + 가루(粉)。韩国厨房必备',
    },
    {
      id: 'd36-w5',
      korean: '눈물이 나다',
      ...
      zh: '流眼泪',
      pos: '表达',
      example: { ko: '갑자기 눈물이 났어요.', zh: '突然流眼泪了。' },
      tip: '눈물(眼泪) + 나다(出现) = 流泪。主语用 이/가',
    },
    {
      id: 'd36-w6',
      korean: '그리워하다',
      ...
      zh: '想念/思念',
      pos: '动词',
      example: { ko: '엄마를 그리워하고 있어요.', zh: '想念着妈妈。' },
      tip: '比 보고 싶다 更深沉。多用于长期分离的情感',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: 'Haru看着地板上的火锅底料。Tori想告诉Haru"这是妈妈寄来的"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '엄마가 중국에서 보내주셨어.', zh: '妈妈从中国寄来的。', correct: true },
          { ko: '엄마가 여기 왔어.', zh: '妈妈来这里了。', correct: false },
          { ko: '내가 엄마한테 보냈어.', zh: '我寄给妈妈了。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '为我做了___：~아/어 주셨어요',
    pattern: 'V 어간 + **아/어 주셨어요** (敬语过去时)',
    whenToUse: '「(长辈) 为我做了___」的过去时敬语。妈妈给我寄包裹 = 엄마가 보내**주셨어요**。~아/어 주다(为我做) + ~시(敬语) + ~었(过去) = 아/어 주셨어요。写家书、说长辈善意时用这一个句型就够。',
    rules: [
    ...
    examples: [
      { ko: '엄마가 소포를 보내주셨어요.', zh: '妈妈给我寄了包裹。', highlight: '보내주셨어요', note: '보내다 + 주시다 + 었어요 = 妈妈(敬语)为我做的过去时。核心句型' },
      { ko: '엄마가 편지도 써주셨어요.', zh: '妈妈还给我写了信。', highlight: '써주셨어요', note: '쓰다 → 써 + 주셨어요。ㅡ 脱落变为 어。妈妈手写信' },
      { ko: '아빠가 카드를 보내주셨어요.', zh: '爸爸给我寄了卡片。', highlight: '보내주셨어요', note: '아빠(爸爸) 也用 주셨어요。父母长辈同规格' },
      { ko: '하루가 송편을 나눠줬어.', zh: 'Haru给了我一些松片糕。', highlight: '나눠줬어', note: '同辈朋友用 반말过去时。나누다(分) + 어 주다 → 나눠주다 → 나눠줬어' },
    ],
    pitfall:
  ...
  output: [
    {
      ...
      successMsg: '엄마 + 주셨어요，敬语过去时。今天最重要的一句。',
    },
    {
      id: 'd36-o2',
      kind: 'listen-choice',
      audioKo: '엄마가 고춧가루도 보내주셨어요.',
      successMsg: '✓ 妈妈连辣椒粉都装进包裹了。',
      choices: [
        { zh: '妈妈还给我寄了辣椒粉。', correct: true },
        { zh: '妈妈买了辣椒粉。', correct: false },
        { zh: '妈妈吃了辣椒粉。', correct: false },
        { zh: '妈妈给辣椒粉寄东西。', correct: false },
      ],
    },
    {
      id: 'd36-o3',
    ...
    },
    {
      ...
      kind: 'particle-error',
      zhHint: '在值班室拿到了包裹。',
      successMsg: '경비실 有收音 → **에서**（动作发生地点）；소포 无收音 → **를**。',
      choices: [
    ...
    },
    {
      id: 'd36-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 36 全对。红色的火锅底料，红色的思念。',
      pairs: [
        { ko: '소포', zh: '包裹' },
        { ko: '보내다', zh: '寄' },
        { ko: '경비실', zh: '值班室' },
  ...
  recap: {
    ...
    preview: '明天，Tori用火锅底料请朋友吃火锅——他们受得了辣吗？',
