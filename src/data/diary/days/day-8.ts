...
然后哭了。`,
  ...
  words: [
    ...
    },
    {
      ...
      tip: '괜찮다(没事) + -아지다(变得...) + -ㄹ 거예요(将会) = 会变没事的。对自己说的最温柔一句话',
    },
  ],
  ...
  grammar: {
    ...
    whenToUse: '表达"想做___"的万能句型，TOPIK 初级必考。韩语里说"我想妈妈"其实是"我想见妈妈"——보다(见) + 고 싶어요 = 보고 싶어요（想见=想念）。Day 8 兔莉想家了，对着镜子说想妈妈。',
    rules: [
    ...
    examples: [
      { ko: '엄마가 보고 싶어요.', zh: '我想妈妈。', highlight: '보고 싶어요', note: '보다(见) + 고 싶어요 = 想见。韩语"想念"就是"想见"，直译理解很容易' },
      { ko: '한국에 가고 싶어요.', zh: '我想去韩国。', highlight: '가고 싶어요', note: '가다 词干 가 + 고 싶어요。에 是地点助词' },
      { ko: '불고기 먹고 싶어요.', zh: '我想吃烤肉。', highlight: '먹고 싶어요', note: '먹다 词干 먹 + 고 싶어요。불고기(烤肉) 是韩国代表料理' },
      { ko: '친구 하고 싶어요.', zh: '我想交朋友。', highlight: '하고 싶어요', note: '名词 + 하고 싶어요 = 想要某物/想做某事。친구(朋友) 是名词' },
      { ko: '보고 싶을 거야.', zh: '我会想你的。', highlight: '보고 싶을 거야', note: '보다 + 고 + 싶다 → 싶을 거야（将来时推测）。对朋友说的 반말' },
      { ko: '집에 가고 싶지 않아요.', zh: '不想回家。', highlight: '싶지 않아요', note: '长否定：고 싶지 않아요。口语也可说 안 가고 싶어요' },
    ],
    pitfall:
