...
"오늘, 나 진짜 팬이었어."`,
  ...
  words: [
    {
      ...
      zh: '招牌（饮品）',
      pos: '名词',
      example: { ko: '오늘 시그니처 음료 뭐예요?', zh: '今天招牌饮品是什么？' },
      tip: '英语 signature 的外来语。카페 메뉴 상용어',
    },
    {
      id: 'd51-w2',
      korean: '포토카드',
      ...
      zh: '小卡（明星照片）',
      pos: '名词',
      example: { ko: '포토카드 랜덤 1장이에요.', zh: '随机小卡一张。' },
    ...
    },
    {
      ...
      zh: '随机',
      pos: '名词',
      example: { ko: '랜덤으로 나와요.', zh: '随机开出。' },
      tip: 'random 외래어. 韩国粉圈日常词汇',
    },
    {
      id: 'd51-w4',
      korean: '팬',
      ...
      zh: '粉丝',
      pos: '名词',
      example: { ko: '오늘, 나 진짜 팬이었어.', zh: '今天，我是真正的粉丝。' },
      tip: 'Day 23 学过。这次Tori自己承认了',
    },
    {
      id: 'd51-w5',
      korean: '카드',
    ...
    },
    {
      ...
      zh: '抽/挑',
      pos: '动词',
      example: { ko: '오빠 사진을 뽑았어요!', zh: '抽到了오빠的照片！' },
      tip: '追星圈固定用法。카드 뽑다 = 抽到卡',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '拆卡看到是Mochi正脸卡。Tori发群里第一句话最合适的是？',
        practice: 'pick',
        choices: [
          { ko: '얘들아, 나 모찌 오빠 정면 뽑았어!', zh: '朋友们，我抽到Mochi正面卡！', correct: true },
          { ko: '카드 없어. 미안.', zh: '没抽到卡。抱歉。', correct: false },
          { ko: '이제 팬 안 할래.', zh: '不想当粉丝了。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '独立复习：혼자서 다 할 수 있어요',
    pattern: 'V + **~(으)ㄹ 수 있어요** · **혼자서**',
    whenToUse: 'Day 51 是"自立主题"复习日——不学新语法，而是把 Day 38 学的能力表达 ~(으)ㄹ 수 있어요 + 主体强调副词 혼자서(独自) 整合。从"我会做饭"到"我一个人能追完星"，同样的句型承载不同分量的成长。',
    rules: [
    ...
    examples: [
      { ko: '혼자서 주문할 수 있어요.', zh: '一个人能点单。', highlight: '혼자서 ... 할 수 있어요', note: '주문하다 → 주문할 수 있어요。今天 Tori 的自我承认' },
      { ko: '혼자서 카드도 뽑았어요.', zh: '一个人也抽到卡了。', highlight: '혼자서 ... 뽑았어요', note: '뽑다 有받침 → 뽑았어요。반말/해요体都可' },
      { ko: '나 혼자서 다 할 수 있어.', zh: '我一个人全能搞定。', highlight: '나 혼자서', note: '나 + 혼자서 强调"我独自"。~수 있어 반말' },
      { ko: 'Day 23에는 못 했지만, 오늘은 할 수 있어요.', zh: 'Day 23时做不到，今天可以了。', highlight: '못 했지만 ... 할 수 있어요', note: '过去 vs 现在 대조 = 성장 표현. Day 45学过的 ~보다 + ~지만 组合' },
    ],
    pitfall:
  ...
  output: [
    {
      ...
      successMsg: '혼자서 + ~(으)ㄹ 수 있어요，Day 51 自立主题的一句。',
    },
    {
      id: 'd51-o2',
      kind: 'listen-choice',
      audioKo: '카드로 결제할게요.',
      successMsg: '✓ 咖啡馆结账最刚需句。~로 = 用（工具）.',
      choices: [
        { zh: '我刷卡结账。', correct: true },
        { zh: '给我卡。', correct: false },
        { zh: '不能刷卡。', correct: false },
        { zh: '卡换掉。', correct: false },
      ],
    },
    {
      id: 'd51-o3',
    ...
    },
    {
      id: 'd51-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 51 全对。혼자서 다 했어요.',
      pairs: [
        { ko: '시그니처', zh: '招牌' },
        { ko: '포토카드', zh: '小卡' },
        { ko: '랜덤', zh: '随机' },
