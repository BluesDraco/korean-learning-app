...
课堂里追学分满分的我，课堂外靠"诚实"拿到第一份兼职的我。这两个我，都是我。`,
  ...
  words: [
    {
      ...
      zh: '兼职/打工',
      pos: '名词',
      example: { ko: '카페 아르바이트를 시작해요.', zh: '开始咖啡馆打工。' },
    ...
    },
    {
      ...
      zh: '面试',
      pos: '名词',
      example: { ko: '오늘 면접 봤어요.', zh: '今天面了试。' },
      tip: '面(면) + 接(접). 면접보다 = 面试 (동사搭配)',
    },
    {
      id: 'd62-w3',
      korean: '이력서',
      ...
      zh: '简历',
      pos: '名词',
      example: { ko: '이력서를 냈어요.', zh: '交了简历。' },
      tip: '履(이) + 历(력) + 书(서). 이력서를 내다 = 投简历',
    },
    {
      id: 'd62-w4',
      korean: '솔직하다',
      ...
      zh: '直率/诚实',
      pos: '形容词',
      example: { ko: '솔직해서 좋아요.', zh: '直率所以好。' },
      tip: '外来汉字 率(솔) + 直(직). 韩国面试文化重视这个词',
    },
    {
      id: 'd62-w5',
      korean: '정직하다',
      ...
      zh: '正直/诚实',
      pos: '形容词',
      example: { ko: '정직한 사람이 좋아요.', zh: '喜欢诚实的人。' },
      tip: '正(정) + 直(직). 솔직 은 표현이 직설적, 정직 은 도덕적',
    },
    {
      id: 'd62-w6',
      korean: '뽑다',
      ...
      zh: '选/招（人）',
      pos: '动词',
      example: { ko: '정직한 사람을 뽑아요.', zh: '招诚实的人。' },
      tip: 'Day 51 学过 (抽卡). 이 날은 招人/选拔',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '黑熊问明天3点能来吗。Tori想爽快答应表决心。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '네, 열심히 하겠습니다.', zh: '好的，我会努力工作的。', correct: true },
          { ko: '음… 잘 모르겠어요.', zh: '嗯……不太清楚。', correct: false },
          { ko: '한국말 못 해서 안 될 것 같아요.', zh: '韩语不好，可能不行。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '因为___所以___：~아/어서 (Day 32 深化 · 정중한 이유)',
    pattern: 'V/A + **아/어서** + Positive Result',
    whenToUse: 'Day 32 学过 ~아/어서 基础，Day 52 学过动作先后。Day 62 是**面试正式场合的因果**——熊店长说 「솔직**해서** 좋아」= 因为诚实所以好。~아/어서 + 긍정 결과 = 面试/职场/正式场合表达"因A故B"最刚需的连接。',
    rules: [
    ...
    examples: [
      { ko: '솔직해서 좋아.', zh: '因为诚实所以好。', highlight: '솔직해서', note: '솔직하다 → 솔직해서. 黑熊 사장 원문' },
      { ko: '한국어를 못해서 걱정이에요.', zh: '因为韩语不好所以担心。', highlight: '못해서', note: '못하다 → 못해서. 부정 이유 + 결과' },
      { ko: '정직한 사람이라서 뽑았어요.', zh: '因为是诚实的人所以选了。', highlight: '사람이라서', note: 'N + 이라서 (Day 32) = 이유 명사절' },
      { ko: '계속 배워서 실력이 늘었어요.', zh: '一直学所以实力提升。', highlight: '배워서 ... 늘었어요', note: '배우다 → 배워서 + 결과. 성장 표현' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      successMsg: '✓ 黑熊 사장의 채용 철학. 완벽 vs 정직.',
      choices: [
        { zh: '不招完美的人。招诚实的人。', correct: true },
        { zh: '完美的人才招。', correct: false },
        { zh: '诚实的人不招。', correct: false },
        { zh: '完美和诚实都不招。', correct: false },
      ],
    },
    {
      id: 'd62-o3',
      kind: 'zh-to-ko',
      zhPrompt: '因为是诚实的人所以选了。',
    ...
    },
    {
      id: 'd62-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 62 全对. 첫 알바 잡았어요.',
      pairs: [
        { ko: '아르바이트', zh: '兼职' },
        { ko: '면접', zh: '面试' },
        { ko: '이력서', zh: '简历' },
  ...
  recap: {
    ...
    preview: '明天 첫 알바 시작 — 걱정된다. 손님 말 다 알아들을 수 있을까?',
    stickerId: 'sticker-d62',
    sceneImageUrl: '/images/diary/day-62-scene.jpg',
  },

  carrotHint: '今天的胡萝卜: 「솔직 和 정직 有什么区别？」「面试怎么说自己韩语水平？」',
};
