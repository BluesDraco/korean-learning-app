...
我推门出去。门还是那么高——但今天，我的腿不抖了。`,
  ...
  words: [
    {
      ...
      zh: '有话要说（敬语）',
      pos: '表达',
      example: { ko: '드릴 말씀이 있어요.', zh: '有话跟您说。' },
      tip: '드리다(敬语给) + 말씀(敬语话). 정중 개시',
    },
    {
      id: 'd68-w2',
      korean: '편견',
      ...
      zh: '偏见',
      pos: '名词',
      example: { ko: '편견이었어요.', zh: '是偏见。' },
      tip: '偏(편) + 见(견). 편견을 갖다 = 有偏见',
    },
    {
      id: 'd68-w3',
      korean: '능력',
      ...
      zh: '能力',
      pos: '名词',
      example: { ko: '능력이 중요해요.', zh: '能力重要。' },
      tip: '能(능) + 力(력). 실력(实力) vs 능력(能力) 미묘 차',
    },
    {
      id: 'd68-w4',
      korean: '중요하다',
      ...
      zh: '重要',
      pos: '形容词',
      example: { ko: '체형은 중요하지 않아요.', zh: '体型不重要。' },
      tip: '重(중) + 要(요) + 하다. 반의: 중요하지 않다',
    },
    {
      id: 'd68-w5',
      korean: '진심',
      ...
      zh: '真心',
      pos: '名词',
      example: { ko: '진심이었어요.', zh: '是真心的。' },
      tip: 'Day 49 学过. 이 날은 사자의 사과가 진심',
    },
    {
      id: 'd68-w6',
      korean: '주장하다',
      ...
      zh: '主张',
      pos: '动词',
      example: { ko: '자기 권리를 주장해요.', zh: '主张自己的权利。' },
      tip: '主(주) + 张(장) + 하다. 논쟁 필수',
    },
  ],
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: '狮子承认偏见并要重新看简历。Tori想礼貌回应"当然可以"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '네, 잘 부탁드립니다.', zh: '好的，请多关照。', correct: true },
          { ko: '이제 안 필요해요.', zh: '不需要了。', correct: false },
          { ko: '늦었어요, 저 갈게요.', zh: '晚了，我走了。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '不要___：~지 마세요 (Day 65 심화 · 주장 상황)',
    pattern: 'V + **지 마세요** + N + **~은/는 ... 지 않아요**',
    whenToUse: 'Day 65 学过 ~지 마세요 (禁止). Day 68 = **주장/논박 상황**의 정중한 사용. Tori 说 「저를 무시하**지 마세요**」= 不要无视我。~지 마세요 + 이유 + ~지 않아요 대비 = 韩语 논박의 정통 구조. 讨公道/据理力争 필수.',
    rules: [
    ...
    examples: [
      { ko: '저를 무시하지 마세요.', zh: '不要无视我。', highlight: '무시하지 마세요', note: '무시하다 → 무시하지 마세요. Day 68 주제 문장' },
      { ko: '체형은 중요하지 않아요. 능력이 중요해요.', zh: '体型不重要。能力才重要。', highlight: '중요하지 않아요 ... 중요해요', note: '대립 구조 = 주장 강조' },
      { ko: '기회 한 번만 주세요.', zh: '请给我一次机会。', highlight: '기회 ... 주세요', note: '~아/어 주세요 요청. Day 54 재활용' },
      { ko: '판단하지 말고 이력서를 봐 주세요.', zh: '别下判断，请看简历。', highlight: '판단하지 말고', note: '~지 말고 (Day 65) + ~아/어 주세요. 대안 제시' },
    ],
    pitfall:
  ...
  output: [
    ...
    },
    {
      ...
      choices: [
        { zh: '体型不重要。能力才重要。', correct: true },
        { zh: '体型也重要，能力也重要。', correct: false },
        { zh: '能力不重要，体型才重要。', correct: false },
        { zh: '两个都不重要。', correct: false },
      ],
    },
    {
      id: 'd68-o3',
    ...
    },
    {
      id: 'd68-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 68 全对. 문 나올 때 다리 안 떨렸어요.',
      pairs: [
        { ko: '편견', zh: '偏见' },
        { ko: '능력', zh: '能力' },
        { ko: '중요하다', zh: '重要' },
  ...
  recap: {
    ...
    preview: '明天 학교 반차별 논단에서 이 경험을 나눈다. "토끼도 할 수 있어요."',
    stickerId: 'sticker-d68',
    sceneImageUrl: '/images/diary/day-68-scene.jpg',
  },

  carrotHint: '今天的胡萝卜: 「주장할 때 어떻게 정중하게?」「편견 어떻게 반박?」',
};
