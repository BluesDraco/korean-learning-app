...
Haru의 답은 늘 짧고 깊다.`,
  ...
  words: [
    {
      ...
      zh: '信封',
      pos: '名词',
      example: { ko: '편지를 봉투에 넣었어요.', zh: '把信放进信封。' },
    ...
    },
    {
      ...
      zh: '回信',
      pos: '名词',
      example: { ko: '답장 세 통이 왔어요.', zh: '收到了三封回信。' },
      tip: '答(답) + 状(장)。답장하다 = 回信',
    },
    {
      id: 'd57-w3',
      ...
      zh: '停止',
      pos: '动词',
      example: { ko: '준호는 KPOP 얘기를 시작하면 멈출 줄 몰라요.', zh: 'Junho一开始说KPOP就停不下来。' },
      tip: '멈추다 → 멈춰요. 멈출 줄 모르다 = 停不下来',
    },
    {
      id: 'd57-w4',
      korean: '늘',
      ...
      zh: '总是/一直',
      pos: '副词',
      example: { ko: '늘 그 자리에 있어줬어.', zh: '总是在那儿。' },
    ...
    },
    {
      ...
      zh: '等',
      pos: '动词',
      example: { ko: '언젠간 기다릴게.', zh: '总有一天我会等的。' },
      tip: '기다리다 → 기다려요 / 기다릴게 (承诺)',
    },
    {
      id: 'd57-w6',
      korean: '서두르다',
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        ko: '?',
        hangul: '',
        zh: 'Tori 想给Haru回一句"什么时候都不催你"。合适的一句？',
        practice: 'pick',
        choices: [
          { ko: '서두르지 않을게. 언제든 괜찮아.', zh: '不催你。什么时候都行。', correct: true },
          { ko: '내일까지 다 말해줘.', zh: '明天之前全说清楚。', correct: false },
          { ko: '이제 그만 얘기해.', zh: '不用说了。', correct: false },
        ],
      },
    ],
  },
  ...
  grammar: {
    title: '书面/亲密体：편지 문체와 표현',
    pattern: '~에게 / ~께 (수신인) + 편지 본문(해요体 or 반말) + 서명',
    whenToUse: 'Day 33 学过给妈妈写信。Day 57 深化——**朋友之间的信**。给平辈用 **~에게**（하루에게 / 준호에게），给长辈用 **~께**（선생님께）。信内可以自由切换해요体/반말，看对方是谁。发朋友圈/写卡片/长文告白都用这些格式。',
    rules: [
    ...
    examples: [
      { ko: '민지에게, 진짜 고마워요.', zh: '给Minji，真的谢谢。', highlight: '민지에게', note: '평등 수신인 = ~에게。편지 시작 정석' },
      { ko: '서두르지 않을게. 언제든 괜찮아.', zh: '不催你。什么时候都行。', highlight: '서두르지 않을게', note: '서두르다 → 서둘러 (르 불규칙) → 서두르지 않을게 (承诺/반말)' },
      { ko: '너 없었으면 나 아직 뒤에서 앉아 있었을 거야.', zh: '没有你我还坐在教室后面。', highlight: '없었으면 ... 있었을 거야', note: '~았/었으면 ... ~았/었을 거야 = 반사실적 가정. 편지 감성 표현' },
      { ko: '하루의 답은 늘 짧고 깊어요.', zh: 'Haru的回答总是又短又深。', highlight: '짧고 깊어요', note: '짧다 + 고 + 깊다 (병렬). 감성 서술' },
    ],
    pitfall:
  ...
  output: [
    {
      ...
      successMsg: '~지 않을게 承诺 + 언제든. Tori给Haru的一句。',
    },
    {
      id: 'd57-o2',
      kind: 'listen-choice',
      audioKo: '고마워. 나도.',
      successMsg: '✓ Haru的两个字回信。看似简单实则藏很多。',
      choices: [
        { zh: '谢谢。我也是。', correct: true },
        { zh: '谢谢。不用。', correct: false },
        { zh: '谢什么。别客气。', correct: false },
        { zh: '现在没事。', correct: false },
      ],
    },
    {
      id: 'd57-o3',
      kind: 'zh-to-ko',
      zhPrompt: '没有你我还坐在教室后面。',
    ...
    },
    {
      id: 'd57-o5',
      kind: 'match-pair',
      successMsg: '✓ Day 57 全对。세 통의 편지, 세 개의 답장.',
      pairs: [
        { ko: '봉투', zh: '信封' },
        { ko: '답장', zh: '回信' },
        { ko: '멈추다', zh: '停止' },
  ...
  recap: {
    ...
    preview: '明天，Tori想重走一遍 Day 1-7 的路。',
