  ...
  meaning: [
    {
      ...
      choices: [
        ...
        { text: '泡菜汤没有。', correct: false },
      ],
      explain: '김치찌개(泡菜汤) + 있어요?（有吗·句末升调）。是非疑问句形与陈述句同，只靠语调',
    },
    {
      id: 'd10-l2-m2',
      audioKo: '오늘 없어요.',
      ...
      explain: '없어요 实际发音 [업써요]。「ㅄ」是双收音，只发左边的 ㅂ',
    },
    {
      id: 'd10-l2-m3',
      audioKo: '진짜 맛있어요!',
      choices: [
        { text: '真的好吃！', correct: true },
        { text: '真的没味道！', correct: false },
        { text: '真的辣！', correct: false },
        { text: '真的贵！', correct: false },
      ],
      explain: '진짜(真的) + 맛있어요(好吃)。맛(味) + 있다(有) = 有味道 = 好吃。四音节连读 [진짜 마시써요]',
    },
    {
      id: 'd10-l2-m4',
      audioKo: '오늘 뭐 드릴까요?',
      choices: [
        { text: '今天给您什么？', correct: true },
        { text: '今天几点结束？', correct: false },
        { text: '今天贵吗？', correct: false },
        { text: '今天好吃吗？', correct: false },
      ],
      explain: '뭐(什么) + 드릴까요?（给您·敬语疑问）。「드리다」是「주다」(给) 的敬语。食堂/餐厅招呼语',
    },
    {
      id: 'd10-l2-m5',
      audioKo: '된장찌개도 맛있어요.',
      choices: [
        { text: '大酱汤不好吃。', correct: false },
        { text: '大酱汤也好吃。', correct: true },
        { text: '大酱汤没有。', correct: false },
        { text: '大酱汤太辣。', correct: false },
      ],
      explain: '된장찌개(大酱汤) + 도(也) + 맛있어요(好吃)。도 = 也，粘在名词后',
    },
  ],
  ...
  cloze: [
    {
      ...
      explain: '시간 있어요? = 有时间吗？问别人是否有空的最常用句。是非疑问只靠升调',
    },
    {
      id: 'd10-l2-c2',
      audioKo: '문제없어요!',
      ...
      explain: '문제(问题) + 없어요 = 没问题。回答确认/安慰时的固定搭配',
    },
    {
      id: 'd10-l2-c3',
      audioKo: '그럼 된장찌개 주세요.',
      ...
      explain: '그럼 = 那(顺承·"既然如此")。「그럼 ~ 주세요」= 那就请给我 ~。听到对方拒绝/建议后接受时用',
    },
    {
      id: 'd10-l2-c4',
      audioKo: '어제 집에 있었어요.',
      ...
      explain: '있다 过去式 → 있었어요。있 + 었 + 어요。「어제 집에 있었어요」= 昨天在家',
    },
  ],
  ...
  reply: [
    {
      ...
      explain: '点单公式：菜名 + 주세요。김치찌개(泡菜汤) + 주세요 = 请给我泡菜汤',
    },
    {
      id: 'd10-l2-r2',
      audioKo: '김치찌개 있어요?',
      promptZh: '客人问"有泡菜汤吗？"今天真的卖完了，你（店员）应该？',
      choices: [
      ...
      explain: '「있어요?」的否定答法：아니요, 없어요（不，没有）。「오늘 없어요」= 今天没有，是委婉说"卖完了"',
    },
    {
      id: 'd10-l2-r3',
      audioKo: '된장찌개 있어요. 어떠세요?',
      promptZh: '阿姨说"有大酱汤，您觉得怎么样？"你决定改点这个，应该？',
      choices: [
      ...
      explain: '「그럼 ~ 주세요」= 那就请给我 ~。听到对方建议后转换接受的标准句',
    },
  ],
};
