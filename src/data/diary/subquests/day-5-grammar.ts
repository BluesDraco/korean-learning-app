...
export const day5Grammar: GrammarSubQuestData = {
  ...
  fix: [
    {
      ...
      explain: '저 无收音 → 主题助词用 는。「저은」是最常见的初学者错误——受"有收音用 은"的规则误导',
    },
    {
      id: 'd05-g3-f2',
      promptKo: '이름는 뭐예요?',
      ...
      explain: '이름 末字 름 有收音 ㅁ → 은。问名字用主题助词 은 比主格 이 更自然',
    },
    {
      id: 'd05-g3-f3',
      ...
      explain: '오늘 有收音 ㄹ → 은。同句 은/는（主题）+ 이/가（主语）共存：오늘은(话题) 날씨가(主语) 좋아요',
    },
    {
      id: 'd05-g3-f4',
      promptKo: '누구는 왔어요?',
      ...
      explain: '疑问词作主语时用 이/가（不用 은/는）。누구+가 = 누가（缩写）。作宾语时用 을/를，Day 6 会遇到 뭐를 좋아해요?',
    },
    {
      id: 'd05-g3-f5',
      promptKo: '저는 김치를 좋아요.',
      ...
      explain: '「좋아요」是**形容词**（不是动词），前面用主格 이/가，不用宾格 을/를。中文"喜欢 XX"在韩语里是"XX이/가 좋아요"',
    },
  ],
  ...
  compose: [
    ...
    },
    {
      ...
      explain: '친구 无收音 → 는。사람 有收音 ㅁ → 이에요。两处收音判断都要对',
    },
    {
      id: 'd05-g3-c3',
      zhHint: '今天天气好。（同句 은/는 + 이/가）',
      audioKo: '오늘은 날씨가 좋아요.',
      answer: ['오늘은', '날씨가', '좋아요.'],
      tokens: ['오늘은', '날씨가', '좋아요.', '오늘는', '날씨는', '오늘이'],
      explain: '오늘 有收音 ㄹ → 은（主题）+ 날씨（主语）→ 가。这种"主题+主语"结构 Day 5 后要熟到肌肉记忆',
    },
    {
      id: 'd05-g3-c4',
      zhHint: '一起去吃早饭吗？',
      ...
      explain: '~러 갈래요 = 邀请句式。같이(一起) + 목적어 + 먹으러/보러/사러 + 갈래요',
    },
  ],
  ...
  rule: [
    {
      id: 'd05-g3-r1',
      promptZh: '关于「은/는」（主题）和「이/가」（主格）的区别，哪句是对的？',
      choices: [
        { text: '完全一样，随便用。', correct: false },
        { text: '은/는 = 提话题（说到 X…），이/가 = 谁/什么在做/是（回答"谁"）。', correct: true },
        { text: '은/는 只用于人，이/가 只用于物。', correct: false },
        { text: '은/는 是宾格，이/가 是主格。', correct: false },
      ],
      explain: '은/는 挂"话题"上，이/가 挂"具体主语"上。疑问词 누구/뭐 后**只用** 이/가',
    },
    {
      id: 'd05-g3-r2',
      promptZh: '"오늘"（末字有收音 ㄹ）+ 主题助词，应该？',
      choices: [
      ...
      explain: '有收音 → 은。「오늘은」隐含对比："今天（相比别的天）"',
    },
    {
      id: 'd05-g3-r3',
      promptZh: '"我喜欢泡菜"用什么助词？',
      choices: [
        { text: '저는 김치를 좋아요.', correct: false },
        { text: '저는 김치가 좋아요.', correct: true },
        { text: '저를 김치를 좋아요.', correct: false },
      ...
      explain: '「좋아요」是形容词，前面用主格 이/가。中文思维会想加 을/를，是最常见的错。喜欢/讨厌/需要 都属这一类',
    },
    {
      id: 'd05-g3-r4',
      promptZh: '"谁来了？"哪句正确？',
      ...
      explain: '疑问词作主语时用 이/가，不能用 은/는。누구+가 = 누가（固定缩写）',
    },
  ],
};
