  ...
  meaning: [
    {
      ...
      choices: [
        ...
        { text: '洗发水没有了。', correct: false },
        { text: '不用洗发水。', correct: false },
        { text: '要换洗发水。', correct: false },
      ],
      explain: '「N 필요해요」= 需要 N。省略了主格助词 이/가（口语常见）',
    },
    {
      id: 'd26-l2-m2',
      audioKo: '이 당근 볼펜 얼마예요?',
      choices: [
        { text: '这个胡萝卜笔多少钱？', correct: true },
        { text: '这里有胡萝卜。', correct: false },
        { text: '胡萝卜好吃吗？', correct: false },
        { text: '胡萝卜笔好用吗？', correct: false },
      ],
      explain: '얼마예요? = 多少钱？问价格必用',
    },
    {
      id: 'd26-l2-m3',
      audioKo: '천 원이에요.',
      choices: [
        { text: '1000元。', correct: true },
        { text: '10000元。', correct: false },
        { text: '一件商品。', correct: false },
        { text: '免费。', correct: false },
      ],
      explain: '천(千) + 원(韩元)。다이소 商品多在 1000-5000 원',
    },
    {
      id: 'd26-l2-m4',
      audioKo: '봉투 필요하세요?',
      choices: [
        ...
        { text: '袋子在哪？', correct: false },
      ],
      explain: '收银员必问句。韩国购物袋要另外收费',
    },
    {
      id: 'd26-l2-m5',
      audioKo: '이거 진짜 귀여워요!',
      choices: [
        { text: '这个真的好可爱！', correct: true },
        { text: '这个真的很贵。', correct: false },
        { text: '这个坏了。', correct: false },
        { text: '这个真好吃。', correct: false },
      ],
      explain: '귀엽다 ㅂ 不规则 → 귀여워요',
    },
  ],
  ...
  cloze: [
    {
      ...
      explain: '필요하다 是形容词 → 主语用 이/가。샴푸 无收音 → 가',
    },
    {
      id: 'd26-l2-c2',
      audioKo: '돈이 필요해요.',
  ...
  reply: [
    {
      ...
      promptZh: '店员问需要什么，你想说洗发水和毛巾都要，最完整的一句？',
      choices: [
      ...
      explain: '「N 필요해요」+ 그리고 + 「N 도」列多物 · 다이소购物标准句',
    },
    {
      id: 'd26-l2-r2',
      audioKo: '천 원이에요. 귀여워요, 안 그래요?',
      promptZh: '店员说 1000 元且好可爱，你决定买，最自然的一句？',
      choices: [
      ...
      explain: '「이것도 주세요」= 这个也要。追加商品的标准句',
    },
    {
      id: 'd26-l2-r3',
      audioKo: '봉투 필요하세요?',
      promptZh: '收银员问需要袋子吗，你带了自己的环保袋，最自然的一句？',
      choices: [
      ...
      explain: '不需要 → 「아니요, 괜찮아요」。比 「싫어요」（讨厌） 得体',
    },
  ],
};
