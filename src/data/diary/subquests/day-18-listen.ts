...
export const day18Listen: ListenSubQuestData = {
  ...
  meaning: [
    {
      ...
      choices: [
        ...
        { text: '存折是什么？', correct: false },
      ],
      explain: '통장(存折) + 만들다(做/办) + 고 싶어요(想) = 想开存折。银行开户核心句',
    },
    {
      id: 'd18-l2-m2',
      audioKo: '어떻게 오셨어요?',
      choices: [
        { text: '您要办什么？', correct: true },
        { text: '您怎么来的？', correct: false },
        { text: '您几点到？', correct: false },
        { text: '您从哪来？', correct: false },
      ],
      explain: '「어떻게 오셨어요?」直译"您怎么来的"，实际是"来办什么事？"（银行/公文常用）',
    },
    {
      id: 'd18-l2-m3',
      ...
      choices: [
        ...
        { text: '请给我存折和密码。', correct: false },
        { text: '请输入密码。', correct: false },
    ...
    },
    {
      ...
      choices: [
        { text: '请输入四位密码。', correct: true },
        { text: '请设置密码。', correct: false },
        { text: '请重新输入。', correct: false },
        { text: '密码错误。', correct: false },
      ],
      explain: '비밀번호(密码) + 네 자리(四位) + 입력해 주세요(请输入)。「네」是固有数四搭量词的变形',
    },
    {
      id: 'd18-l2-m5',
      audioKo: '여기에 사인해 주세요.',
      choices: [
        { text: '请在这里签名。', correct: true },
        { text: '请在这里等一下。', correct: false },
        { text: '这是您的签名吗？', correct: false },
        { text: '请重新签名。', correct: false },
      ],
      explain: '여기에(在这里) + 사인하다(签名) → 사인해 주세요。银行/合同签字场景',
    },
  ],
  ...
  cloze: [
    ...
    },
    {
      ...
      explain: '뭐(什么) + 먹다 + 고 싶어요?（想~疑问）。约饭必备句',
    },
    {
      id: 'd18-l2-c3',
      audioKo: '학생증도 필요해요?',
      ...
      explain: '「도」= 也（附加助词）。「학생증도 필요해요?」= 也需要学生证吗？',
    },
    {
      id: 'd18-l2-c4',
  ...
  reply: [
    {
      id: 'd18-l2-r1',
      audioKo: '어떻게 오셨어요?',
      promptZh: '乌龟柜员问"您要办什么？"你想开存折，最自然的一句？',
      choices: [
      ...
      explain: '银行询问 → 客户说明目的：X 만들고 싶어요 = 想办 X',
    },
    {
      id: 'd18-l2-r2',
      audioKo: '외국인등록증이랑 여권 주세요.',
      promptZh: '柜员要证件，你已经带来了，最自然的一句？',
      choices: [
      ...
      explain: '递证件时说 「네, 여기 있어요」= 好的，在这里。母语者递东西的标准句',
    },
    {
      id: 'd18-l2-r3',
      audioKo: '비밀번호 네 자리 입력해 주세요.',
      promptZh: '柜员让你输密码，你想说"我知道了"，最自然的一句？',
      choices: [
      ...
      explain: '收到指令 → 「네, 알겠습니다」（합쇼체·最礼貌）。银行/公务场合用最高敬语',
    },
  ],
};
