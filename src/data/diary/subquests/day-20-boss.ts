...
export const day20Boss: BossSubQuestData = {
  ...
  koTitle: '최후의 관문',
  subtitle: '把海豹房东的每一笔账问清楚',
  intro: '空房间的地板反着阳光。海豹房东摊开文件夹，皮鞋磨得发亮。他抬眼看你，一副"看你能问出什么"的表情。今天学过的每一个词都要用上。',
  outroHook: '通过！租金、管理费都问清楚了。明天，海豹房东会摊开三页合同正式签约——每一个条款、每一句당근俚语，都要听懂再落笔。',
  ...
  tasks: [
    {
      ...
      task: {
        ...
        choices: [
          ...
          { text: '管理费另算吗？', correct: false },
        ],
        explain: 'N에 뭐가 들어 있어요? = N 里包含什么',
      },
    },
    {
      type: 'choice',
      ...
      task: {
        ...
        choices: [
          ...
          { text: '电费免费。', correct: false },
        ],
        explain: '「N은/는 따로예요」= N 另算',
      },
    },
    {
      type: 'choice',
    ...
    },
    {
      ...
      task: {
        ...
        choices: [
          { text: '押金', correct: true },
          { text: '月租', correct: false },
          { text: '管理费', correct: false },
          { text: '中介费', correct: false },
        ],
        explain: '보(保) + 증(证) + 금(金) = 押金。韩国租房制度中的核心词',
      },
    },
    {
      type: 'compose',
    ...
    },
    {
      ...
      task: {
        id: 'd20-b5-t8',
        promptZh: '房东确认身份说「토리 학생이죠?」，第一次见面最合适的一句？',
        choices: [
