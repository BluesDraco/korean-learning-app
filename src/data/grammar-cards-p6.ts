...
<div class="reminder-box">좋나요? ✗ → 좋은가요? ✓ — 形容词现在时用 -은/ㄴ가요?，不用 -나요?。-ㅂ니다만 比 -지만 更正式有礼貌，职场道歉/婉拒时首选。</div>`,
  ...
  <div class="ov-section">
    ...
    <div class="ov-block">
      ...
      questions: [
        ...
        },
        {
          pre: '이 옷이',
          post: '?',
          options: ["예쁘나요", "예뻐요", "예쁜가요"],
          answer: 2,
          explanation: '形容词无收音 + -ㄴ가요?："这件衣服好看吗？"예쁘다 词干 예쁘 无收音 → 예쁘+ㄴ가요 = 예쁜가요。',
        },
        {
          pre: '저 분이',
          post: '?',
          options: ["누군가요", "누구예요", "누구나요"],
          answer: 0,
    ...
    mistakes: [
      { wrong: '작나요? (형용사 过去)', correct: '작았나요?', note: '形容词过去时用 -았/었나요?，现在时直接接词干' },
    ...
    <div class="ov-block">
      ...
      questions: [
        ...
        },
        {
          pre: '아직',
          post: '.',
          options: ["숙제를 할 거예요", "숙제를 다 했어요", "숙제를 못 했어요"],
          answer: 2,
...
<div class="reminder-box">-(으)면 큰일이다 vs -(으)면 안 되다：큰일이다 有"大灾难"的强烈感，안 되다 是单纯禁止。놓쳐 버렸어요（遗憾）vs 다 해 버렸어요（轻松）— 버리다 的情感色彩由上下文决定。</div>`,
  ...
  <div class="ov-section">
    ...
    mistakes: [
      { wrong: '거기 가면 큰일이에요', correct: '거기에 가면 큰일이에요.', note: '动作/方向用 -에，省略助词会让句子断节。' },
...
<div class="reminder-box">형용사에 -는다고 쓰면 틀려요：좋는다고 ✗ → 좋다고 ✓。동사에 -다고 바로 쓰면 틀려요：먹다고 ✗ → 먹는다고 ✓。过去时统一用 -았/었다고：잘했다고 생각해요 ✓。</div>`,
      ...
      questions: [
        {
          pre: '한국어가 재미있',
          post: '.',
          options: ["는 생각해요", "ㄴ다고 생각해요", "다고 생각해요"],
          answer: 2,
  ...
  },
  {
    ...
    rulesNote: '动词现在冠词形：\n直接词干 + -는（不看收音）。\n动词过去冠词形：\n有收音→-은 날，无收音/ㄹ→-ㄴ 날。\n形容词冠词形：\n有收音→-은 날，无收音→-ㄴ 날（形容词现在时也用 -은/ㄴ）。\nㄹ收音动词/形容词：\nㄹ 收音动词→-는 날（살다→사는 날）；形容词→-ㄴ 날（길다→긴 날）。',
      ...
      questions: [
        {
          ...
          options: ["라고", "이라고", "다고"],
          answer: 0,
          explanation: '언제 无收音 → 언제 + 라고 = 언제라고（朋友问"什么时候"）。疑问词+라고 하다。',
        },
        {
          pre: '그 사람 이름이 뭐',
          post: '했어요?',
        ...
        },
        {
          ...
          options: ["라고", "이라고", "다고"],
          answer: 0,
          explanation: '어디 无收音 → 어디 + 라고 = 어디라고 물었어요（朋友问"在哪里"）。',
        },
      ],
    },
...
<div class="reminder-box">먹을 지 얼마 안 됐어요 ✗（未来形）→ 먹은 지 얼마 안 됐어요 ✓（过去冠词形）。걱정이에요 是 -을지 后的固定搭配（比 걱정해요 更自然），-을지 从句后选 걱정이다 而非 걱정하다。</div>`,
        overviewHtml: `<div class="overview">
  <div class="ov-hero">
  ...
  <div class="ov-section">
    ...
    mistakes: [
      { wrong: '갈 수 있는지 걱정이에요.', correct: '갈 수 있을지 걱정이에요.', note: '"걱정이다" 前的固定句型用 -을/ㄹ지；-는지 在其他句型可通用，本固定句首选 -을지。' },
    ...
    <div class="ov-block">
      ...
      questions: [
        ...
        },
        {
          pre: '이렇게 빨리 끝날 줄은',
          post: '.',
          options: ["예상했어요", "알고 있었어요", "상상도 못 했어요"],
          answer: 2,
