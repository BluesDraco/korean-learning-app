        ...
        intro: [
          {
            ...
            zh: '这里全是真的韩语，不是练习题。按难度排好，从最简单的开始就行。',
          ...
          },
          {
            ...
            zh: '馆里分四个区：纪实文章、故事集、韩国小知识、绘本馆。想读什么挑什么。',
    ...
    steps: [
      {
        ...
        intro: [
          {
            ko: '한글, 여기서 처음부터 배워요.',
            zh: '零基础就从这儿开始。40 个字母的发音，听真人怎么念，再学怎么拼成字。',
      ...
      },
      {
        ...
        note: '🥕 소리부터 천천히, 급할 것 없어요 · 先从声音开始，一点都不用急',
  ...
  grammar: {
    ...
    steps: [
      ...
      },
      {
        ...
        note: '🥕 어느새 문장이 길어져 있을 거예요 · 不知不觉，你的句子就变长了',
  ...
  topik: {
    ...
    steps: [
        ...
        intro: [
          {
            ...
            zh: '要考 TOPIK 的话，就在这儿准备。按题型练词汇、阅读、听力，一块块补上。',
          ...
          },
          {
            ...
            zh: '想知道自己到哪了？来火鹤老师这儿，掐着时间考一套模拟卷。',
      ...
      },
      {
        ...
        note: '🥕 한 문제씩 풀다 보면 늘어요 · 一题一题做下去，就上来了',
    ...
    steps: [
      {
        ...
        intro: [
          {
            ko: '배운 걸 여기서 진짜 써 봐요.',
            zh: '光看会忘，动手才记得住。说、写、听、打字，学过的在这儿练成本能。',
          ...
          },
          {
            ...
            zh: '猫头鹰守着的安静自习室。每天挑几样练练，手就越来越顺了。',
      ...
      },
      {
        ...
        note: '🥕 네 가지 다 해 보면 오늘 하루 꽉 찼어요 · 四样都练一遍，今天就很满足',
  ...
  blog: {
    ...
    steps: [
        ...
        intro: [
          {
            ...
            zh: '这是动物城广场。兔莉和朋友们每天发帖，记着在首尔留学的日子。',
          ...
          },
          {
            ...
            zh: '动物城其实就是你在学的首尔——地名、地铁、汉江都和真的一样，读到的全是真实韩语。',
      ...
      },
      {
        ...
        note: '🥕 매일 조금씩, 동물 도시도 같이 자라요 · 每天来一点，动物城也陪你一起长大',
  ...
  vocabulary: {
    ...
    steps: [
      ...
      },
      {
        ...
        note: '🥕 오늘 세 개만 주워 가도 부자예요 · 今天捡三个词回家，就已经很富了',
  ...
  diary: {
    ...
    steps: [
        ...
        intro: [
          {
            ...
            zh: '这是兔莉在首尔（动物城）留学的日记。跟着一天天读，韩语和故事一起往前走。',
      ...
      },
      {
        ...
        note: '🥕 토리랑 하루하루, 서두르지 않아도 돼요 · 有兔莉陪着，一天一天来，不用赶',
  ...
  radio: {
    ...
    steps: [
        ...
        intro: [
          {
            ...
            zh: '动物城的朋友们每天开播——松鼠的早安、动物城新闻、熊的夜晚故事、狐狸的思辨咖啡馆，还有狐狸的深夜访谈。',
      ...
      },
      {
        ...
        note: '🥕 흘려들어도 귀가 트여요 · 就算只是放着听，耳朵也会慢慢打开',
    ...
    steps: [
      {
        ...
        intro: [
          {
            ko: '한 문장을 통째로 풀어 드려요.',
            zh: '贴一句韩语进来，猫头鹰帮你从头拆到尾：词、助词、语法、结构，一样不落。',
      ...
      },
      {
        ...
        note: '🥕 헷갈리는 문장, 여기 넣어 보세요 · 拿不准的句子，丢进来就懂了',
  ...
  picbooks: {
    ...
    steps: [
      ...
      },
      {
        ...
        note: '🥕 그림 보며 읽으면 하나도 안 어려워요 · 看着图读，一点都不难',
