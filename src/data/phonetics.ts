...
export const vowels: PhoneticLetter[] = [
  ...
  { id: 'v-03', letter: 'ㅓ', name: '어', romanization: 'eo', type: 'vowel', subtype: 'basic', sound: '类似英语"but/cup"中的u，嘴型扁平不圆', mnemonic: '嘴型扁平，像发"哦"但嘴不圆', emoji: '😮' },
  ...
  { id: 'v-09', letter: 'ㅡ', name: '으', romanization: 'eu', type: 'vowel', subtype: 'basic', sound: '嘴角向两侧拉平，像微笑时发的"嗯"', mnemonic: '像一条横线，嘴型扁平', emoji: '😐' },
  ...
  { id: 'v-17', letter: 'ㅚ', name: '외', romanization: 'oe', type: 'vowel', subtype: 'compound', sound: '标准音嘴型圆（类似法语eu），口语常读成we', mnemonic: 'ㅗ+ㅣ→oe', emoji: '🔄' },
...
export const consonants: PhoneticLetter[] = [
  ...
  { id: 'c-04', letter: 'ㄹ', name: '리을', romanization: 'r/l', quizRomanization: 'r', type: 'consonant', subtype: 'basic', sound: '元音间弹舌[ɾ]，收音位置为侧音[l]舌尖贴上齿龈不弹开', mnemonic: '像蜿蜒的小路', emoji: '🛤️', strokeOrder: ['从上到下写折线'] },
  ...
  { id: 'c-19', letter: 'ㅉ', name: '쌍지읒', romanization: 'jj', type: 'consonant', subtype: 'double', sound: '类似ㅈ但声带绷紧，短促爆发，无气流送出', mnemonic: '两个ㅈ=加倍用力', emoji: '⚡' },
];
...
export const batchimSounds: PhoneticLetter[] = [
  ...
  { id: 'b-04', letter: 'ㄹ', name: 'ㄹ收音', romanization: '-l', type: 'batchim', subtype: 'liquid', sound: '舌尖轻贴上齿龈，保持侧音[l]，不弹开', mnemonic: '舌尖贴住上颚，气流从两侧流出', emoji: '👅' },
