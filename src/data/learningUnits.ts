...
export const learningUnits: LearningUnit[] = [
...

  {
    ...
    words: [
      { word: '안녕하세요', pronunciation: 'annyeonghaseyo', meaning: '你好', partOfSpeech: '表达', example: '안녕하세요, 처음 뵙겠습니다.', exampleZh: '你好，初次见面。', emoji: '👋', note: '最常用的敬语问候' },
      { word: '감사합니다', pronunciation: 'gamsahamnida', meaning: '谢谢', partOfSpeech: '表达', example: '도와주셔서 감사합니다.', exampleZh: '谢谢您的帮助。', emoji: '🙏', note: '正式敬语"谢谢"' },
  ...
  },
  {
    ...
    words: [
      ...
      { word: '주세요', pronunciation: 'juseyo', meaning: '请给', partOfSpeech: '表达', example: '김밥 하나 주세요.', exampleZh: '请给我一份紫菜包饭。', emoji: '🛎️', note: '点餐万能句式' },
    ],
    grammarId: 'g3',
  ...
  },
  {
    ...
    words: [
      { word: '얼마', pronunciation: 'eolma', meaning: '多少钱', partOfSpeech: '代词', example: '이거 얼마예요?', exampleZh: '这个多少钱？', emoji: '💵' },
      ...
      { word: '깎아 주세요', pronunciation: 'kkakka juseyo', meaning: '请便宜点', partOfSpeech: '表达', example: '좀 깎아 주세요.', exampleZh: '请便宜一点。', emoji: '💸', note: '砍价必备表达' },
    ],
    grammarId: 'g10',
...

  {
    ...
    words: [
      ...
      { word: '화가 나다', pronunciation: 'hwaga nada', meaning: '生气', partOfSpeech: '惯用语', example: '왜 화가 났어요?', exampleZh: '为什么生气了？', emoji: '😤' },
  ...
  },
  {
    ...
    words: [
      ...
      { word: '가는 말이 고와야 오는 말이 곱다', pronunciation: 'ganeun mari gowaya oneun mari gopda', meaning: '你说得好听别人才说得好听', partOfSpeech: '惯用语', example: '친구한테 예쁘게 말해. 가는 말이 고와야 오는 말이 곱잖아.', exampleZh: '对朋友说话好听点，你怎么说别人，别人就怎么说你。', emoji: '🗣️' },
    ],
    grammarId: 'g45',
