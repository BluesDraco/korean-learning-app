...
export const thirtyDayCourse: DailyCourse[] = [
  // ── WEEK 1: 日常问候与自我介绍 (Days 1-7) ──
  {
    ...
    words: [
      { korean: '안녕하세요', pronunciation: 'an-nyeong-ha-se-yo', chinese: '您好', partOfSpeech: '表达', emoji: '👋' },
      { korean: '감사합니다', pronunciation: 'gam-sa-ham-ni-da', chinese: '谢谢', partOfSpeech: '表达', emoji: '🙏' },
      ...
      { korean: '안녕히 가세요', pronunciation: 'an-nyeong-hi ga-se-yo', chinese: '再见（对走的人）', partOfSpeech: '表达', emoji: '👋' },
      { korean: '안녕히 계세요', pronunciation: 'an-nyeong-hi gye-se-yo', chinese: '再见（对留的人）', partOfSpeech: '表达', emoji: '👋' },
      { korean: '반갑습니다', pronunciation: 'ban-gap-seum-ni-da', chinese: '很高兴见到你', partOfSpeech: '表达', emoji: '😊' },
      { korean: '죄송합니다', pronunciation: 'joe-song-ham-ni-da', chinese: '对不起', partOfSpeech: '表达', emoji: '🙇' },
    ],
    grammar: {
  ...
  // ── WEEK 3: 社交与表达 (Days 15-21) ──
  {
    ...
    words: [
      ...
      { korean: '여보세요', pronunciation: 'yeo-bo-se-yo', chinese: '喂（接电话）', partOfSpeech: '表达', emoji: '📱' },
...

  {
    ...
    words: [
      ...
      { korean: '좋을 것 같다', pronunciation: 'jo-eul geot gat-tta', chinese: '应该不错', partOfSpeech: '表达', emoji: '🤔' },
...

  {
    ...
    words: [
      ...
      { korean: '화이팅', pronunciation: 'hwa-i-ting', chinese: '加油', partOfSpeech: '表达', emoji: '💪' },
