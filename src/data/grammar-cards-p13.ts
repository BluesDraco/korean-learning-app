...
<div class="reminder-box">세 표현은 교체 가능한 경우가 많지만，듯하다 는 비유，모양이다 는 외부 관찰에 더 특화。</div>`,
    ...
    mistakes: [
      ...
      { wrong: '비가 올 모양이다', correct: '비가 올 모양이에요', note: '모양이다 단독 종결은 구어에서 어색하다。구어에서는 모양이에요，격식에서는 모양입니다 가 자연스럽다。' },
  ...
  // ── 第9课：-을/ㄹ 텐데，-는/은/ㄴ/을 더러，보고 ───────────────────
  {
    ...
    mistakes: [
      ...
      { wrong: '갈 텐데요', correct: '갈 텐데 조심하세요', note: '-을/ㄹ 텐데 는 보통 단독 종결이 어색하다。뒤에 부탁/우려/제안 절이 이어져야 자연스럽다。' },
