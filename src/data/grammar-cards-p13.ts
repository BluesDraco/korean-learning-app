...
<div class="reminder-box">-는 길에 不表示原因，只表示"途中顺便"，和前两个用法完全不同。</div>`,
    ...
    mistakes: [
      { wrong: '비가 오로 해서 못 나가요', correct: '비로 해서 못 나가요 또는 비가 오기 때문에 못 나가요', note: '(으)로 해서 앞에는 명사만 올 수 있다。동사를 원인으로 쓰려면 -기 때문에 사용。' },
      { wrong: '집에 간 길에 편의점에 들렀어요', correct: '집에 가는 길에 편의점에 들렀어요', note: '-는 길에 는 현재 관형사형（가는/오는）만 가능，과거형 간/온 은 쓸 수 없다。' },
      { wrong: '학교로 해서 친구를 사귀었어요', correct: '학교에서 친구를 사귀었어요 또는 학교를 통해서 친구를 사귀었어요', note: '(으)로 해서 는 원인이나 수단을 나타내는 명사 뒤에 써야 자연스럽다。단순 장소에는 어색。' },
      { wrong: '오는 길에 비가 왔어요', correct: '오는 길에 비를 맞았어요', note: '-는 길에 뒤에는 이동 주체가 직접 한 행동이 와야 자연스럽다。자연 현상 서술에는 부적절。' },
    ],
    quickTable: {
      title: '(으)로 해서 接续形式',
...
<div class="reminder-box">-처럼 侧重外表相似，-만큼/-정도로 侧重程度量级，注意区分。</div>`,
    ...
    mistakes: [
      { wrong: '죽을 만큼 힘드는 하루예요', correct: '죽을 만큼 힘든 하루예요', note: '관형사형 + 만큼 에서 형용사 관형사형은 힘드는이 아니라 힘든이다。형용사는 현재 관형사형이 -은/ㄴ 형태。' },
      { wrong: '그만큼을 노력했어요', correct: '그만큼 노력했어요', note: '-만큼 자체가 조사이므로 뒤에 을/를을 다시 붙이지 않는다。' },
      { wrong: '정도로 힘들어요', correct: '쓰러질 정도로 힘들어요', note: '-정도로 앞에는 구체적 정도 기준이 되는 관형사형이나 명사가 와야 한다。단독으로 쓰면 비문。' },
      { wrong: '눈물이 날 정도가 감동적이에요', correct: '눈물이 날 정도로 감동적이에요', note: '여기서는 정도의 부사어 역할을 위해 정도로（로 조사）가 필요하다。정도가는 주어 역할이 되어 문장이 맞지 않는다。' },
    ],
    quickTable: {
      title: '-만큼 / -정도로 接续形式',
...
<div class="reminder-box">前后主语相同用 -기 위해서，创造条件用 -을 수 있게，程度/口语目的用 -도록。</div>`,
    ...
    mistakes: [
      { wrong: '늦으도록 서둘러요', correct: '늦도록 서둘러요 또는 늦지 않도록 서둘러요', note: '-도록 은 동사 어간에 직접 붙으며 으를 삽입하지 않는다。늦다 어간 늦 + 도록 = 늦도록。' },
      { wrong: '볼 수 있게로 설명했어요', correct: '볼 수 있게 설명했어요', note: '-을 수 있게 자체가 부사절이므로 뒤에 조사를 다시 붙이지 않는다。' },
      { wrong: '공부하기 위하여도록 노력했어요', correct: '공부하기 위하여 노력했어요 또는 공부하도록 노력했어요', note: '-기 위하여 와 -도록 은 같은 자리에서 쓰이는 목적 표현이므로 동시에 쓰지 않는다。' },
      { wrong: '이해할 수 있게 하기 위하여을 설명했어요', correct: '이해할 수 있게 하기 위하여 설명했어요', note: '-게 하기 위하여 는 부사절로 기능하므로 뒤에 목적격 조사 을/를을 붙이지 않는다。' },
    ],
    quickTable: {
...
<div class="reminder-box">-지경이다 是状态到达极点，-(으)ㄹ수록 是条件与结果同步递进。</div>`,
    ...
    mistakes: [
      { wrong: '쓰러지을 지경이에요', correct: '쓰러질 지경이에요', note: '쓰러지다 어간 쓰러지는 받침이 없으므로 ㄹ수록/ㄹ 관형사형：쓰러질 지경이에요。쓰러지을은 없는 형태。' },
      { wrong: '알수록 알수록 재미있어요', correct: '알면 알수록 재미있어요', note: '-(으)ㄹ수록 앞에 -(으)면 을 한 번만 붙여 쓴다。같은 동사를 두 번 반복할 때는 알면 알수록 형태가 표준。' },
      { wrong: '시간이 지날수록에 더 그리워요', correct: '시간이 지날수록 더 그리워요', note: '-(으)ㄹ수록 자체가 부사절 역할을 하므로 뒤에 조사를 붙이지 않는다。' },
      { wrong: '행복할 지경이에요', correct: '너무 행복해요 또는 행복해서 눈물이 날 지경이에요', note: '-을 지경이다 는 부정적이거나 극단적인 상황에 쓰는 것이 자연스럽다。행복하다처럼 긍정적 상태에는 어색하다。' },
    ],
    quickTable: {
...
<div class="reminder-box">-던데요 는 청자 배려，-더라 는 독백/친한 사이 감탄，-테요 는 현재·미래 추측/의지。</div>`,
    ...
    mistakes: [
      { wrong: '피곤할 테요니까 쉬세요', correct: '피곤할 테니까 쉬세요', note: '-테니까 는 테 + 니까가 결합한 형태로 하나의 어미처럼 쓰인다。테요 뒤에 니까를 붙이지 않는다。' },
      { wrong: '어제 거기 맛있었던데요', correct: '어제 거기 맛있던데요', note: '-던데요 자체가 과거 회상 의미를 포함하므로 었/았 과거 시제를 중복하지 않는다。맛있었던데요는 어색하다。' },
      { wrong: '그 영화 재미있더라요', correct: '그 영화 재미있더라 또는 재미있더라고요', note: '-더라 는 구어체 종결어미로 뒤에 요를 바로 붙이지 않는다。격식체로는 -더라고요 형태를 쓴다。' },
      { wrong: '내가 할 테요을 준비했어요', correct: '내가 할 테요（단독 종결）또는 내가 준비할 테요', note: '-테요 는 종결어미이므로 뒤에 조사를 붙이지 않는다。' },
    ],
    quickTable: {
...
<div class="reminder-box">-았더니 와 -더니 는 주어 인칭이 핵심 구분 기준。</div>`,
    ...
    mistakes: [
      { wrong: '친구가 먹었더니 배불렀어요', correct: '친구가 먹더니 배부른 것 같았어요 또는 내가 먹었더니 배불렀어요', note: '-았더니 앞 주어는 1인칭이어야 한다。3인칭 주어에는 -더니 를 쓴다。' },
      { wrong: '비가 왔더니 길이 미끄러워요', correct: '비가 오더니 길이 미끄러워졌어요', note: '자연현상을 주어로 쓸 때는 -더니 가 자연스럽다。-았더니 는 1인칭 직접 경험에만 쓴다。' },
      { wrong: '잠을 자더니 피로가 풀렸어요', correct: '잠을 잤더니 피로가 풀렸어요', note: '나/저의 직접 경험 후 결과를 말할 때는 -았더니 를 쓴다。1인칭 주어에 -더니 만 쓰면 어색하다。' },
      { wrong: '운동했더니에 살이 빠졌어요', correct: '운동했더니 살이 빠졌어요', note: '-았더니 는 접속어미이므로 뒤에 조사를 붙이지 않는다。' },
    ],
    quickTable: {
...
<div class="reminder-box">-길래 는 1인칭의 반응 행동이 뒤 절에 온다는 점이 특징。</div>`,
    ...
    mistakes: [
      { wrong: '태풍이로 인하여 결항됐습니다', correct: '태풍으로 인하여 결항됐습니다', note: '태풍의 末字 풍은 받침 ㅇ → 으로 인하여。이로는 없는 형태，(으)로 인하여 앞에 이를 삽입하지 않는다。' },
      { wrong: '배고프길래 먹어라', correct: '배고프길래 뭔가 먹었어요', note: '-길래 뒤에는 명령문이나 청유문이 올 수 없다。뒤 절은 화자의 반응 행동（과거형/현재형）이어야 한다。' },
      { wrong: '사고로 인한 때문에 도로가 막혔어요', correct: '사고로 인하여 도로가 막혔어요 또는 사고 때문에 도로가 막혔어요', note: '(으)로 인하여 와 때문에 는 같은 원인 기능이므로 동시에 쓰지 않는다。' },
      { wrong: '맛있어 보이길래서 시켰어요', correct: '맛있어 보이길래 시켰어요', note: '-길래 는 접속어미로 뒤에 서를 붙이지 않는다。길래서는 없는 형태。' },
    ],
    quickTable: {
      title: '(으)로 인하여 接续形式',
...
<div class="reminder-box">세 표현은 교체 가능한 경우가 많지만，듯하다 는 비유，모양이다 는 외부 관찰에 더 특화。</div>`,
    ...
    mistakes: [
      { wrong: '피곤하는 듯해요', correct: '피곤한 듯해요', note: '형용사 관형사형은 -는 이 아니라 -은/ㄴ 이다。피곤하다 → 피곤한 듯해요。동사에만 현재형 -는 을 쓴다。' },
      { wrong: '비가 올 모양이다', correct: '비가 올 모양이에요（구어 자연스러운 형태）', note: '모양이다 단독 종결은 구어에서 어색하다。구어에서는 모양이에요，격식에서는 모양입니다 가 자연스럽다。' },
      { wrong: '모르은 모양이에요', correct: '모르는 모양이에요', note: '모르다는 동사이며 현재 관형사형은 -는 이다。받침 유무와 관계없이 동사 현재형에는 -는 을 쓴다。받침 있는 형태인 -은 은 형용사나 동사 과거형에 사용한다。' },
      { wrong: '비가 오는 듯한 것 같아요', correct: '비가 오는 듯해요 또는 비가 올 것 같아요', note: '-듯하다 와 -것 같다 는 동일 기능의 추측 표현이므로 동시에 쓰지 않는다。' },
    ],
    quickTable: {
  ...
  // ── 第9课：-을/ㄹ 텐데，-는/은/ㄴ/을 더러，보고 ───────────────────
  {
    ...
    mistakes: [
      { wrong: '피곤을 텐데', correct: '피곤할 텐데', note: '피곤하다는 형용사이므로 어간 피곤하- 에 ㄹ 텐데를 붙인다：피곤할 텐데。명사에는 직접 을 텐데를 붙이지 않는다。' },
      { wrong: '갈 텐데요', correct: '갈 텐데 조심하세요 등 후속절 필요', note: '-을/ㄹ 텐데 는 보통 단독 종결이 어색하다。뒤에 부탁/우려/제안 절이 이어져야 자연스럽다。' },
      { wrong: '책보고 읽으라고 했어요', correct: '동생보고 읽으라고 했어요', note: '더러/보고 는 사람 명사 뒤에만 쓸 수 있다。책、가방 등 사물에는 쓸 수 없다。' },
      { wrong: '친구더러게 말했어요', correct: '친구더러 말했어요 또는 친구에게 말했어요', note: '더러 와 에게 는 동일 기능의 조사이므로 중복 사용하지 않는다。' },
    ],
    specialQuiz: {
      type: 'fill',
      title: '-을/ㄹ 텐데，더러/보고',
...
<div style="display:flex;flex-direction:column;gap:10px;margin:12px 0">
  ...
  // ── 第10课：-잖아요，-거든요 ────────────────────────────────────
  {
    ...
    mistakes: [
      { wrong: '처음 만난 사람에게：그 노래 알잖아요', correct: '그 노래 아세요？', note: '-잖아요 는 청자가 이미 알고 있는 정보에만 쓴다。처음 만난 사람에게는 어색하다。모르는 정보라면 의문문을 쓰는 것이 자연스럽다。' },
      { wrong: '왜 늦었어요？— 바빴잖아요', correct: '바빴거든요', note: '청자가 모르는 이유를 설명할 때는 -거든요 를 쓴다。-잖아요 는 청자도 알고 있는 사실을 환기할 때 쓴다。' },
      { wrong: '피곤하거든요잖아요', correct: '피곤하거든요 또는 피곤하잖아요', note: '-거든요 와 -잖아요 는 동시에 쓸 수 없다。두 어미는 서로 다른 정보 공유 상황에서 쓰인다。' },
      { wrong: '먹었잖아요', correct: '먹었거든요', note: '상대방이 모르는 정보를 전달할 때는 -거든요 를 쓴다。-잖아요 는 함께 경험하거나 상대가 이미 알고 있을 때만 쓴다。' },
    ],
    specialQuiz: {
      type: 'fill',
      title: '-잖아요，-거든요',
