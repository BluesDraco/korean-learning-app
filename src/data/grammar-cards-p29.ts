...
export const grammarCardsP29: GrammarCard[] = [
  // ── 第1课：-(으)ㄴ/는 것으로 알려지다/전해지다 ──────────────────────────────────────
  {
    ...
    connectionRules: [
      ...
      { type: 'note', text: '不指明信息源时更客观；指明用 "관계자에 따르면 / 소식통에 따르면"', examples: '관계자에 따르면, 두 회사는 협상 중인 것으로 전해졌다.（据相关人士称，两家公司正在协商。）' },
      { type: 'note', text: '알려지다/전해지다 本身已是被动（"被知晓/被传告"），主语是被报道的那件事或那个人本身，不是记者；所以不再改回主动的 알리다，也不额外加 -되다。', examples: '두 회사는 협력하고 있는 것으로 알려졌다.（主语"两家公司"是被报道的对象，句子已表被动）' },
      { type: 'note', text: '助词是 것"으로"（表判定/认定的对象），不是 것"을"。这里的 (으)로 相当于"被认定为…"，中文母语者容易套成宾语 것을，错。', examples: '(○) 발생한 것으로 알려졌다 / (✗) 발생한 것을 알려졌다' },
    ],
    cardExamples: [
      {
        wordBlocks: [
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 2,
          explanation: '"目前正在否认"，进行体 → 부인하고 있는 것으로。原形 부인하다 不能直接接 것으로，须先变冠形词形。',
        },
        {
...
<div class="ov-section">
  ...
  // ── 第2课：-(으)ㄴ/는 것으로 나타나다/드러나다 ──────────────────────────────────────
  {
    ...
    connectionRules: [
      ...
      { type: 'rule', text: '名词 -인 것으로', examples: '주요 원인인 것으로 드러났다（查明是主要原因。）' },
      { type: 'usage', text: '나타나다：客观数据/调查显示结果', examples: '설문조사 결과 …로 나타났다（问卷调查结果显示为……）' },
      { type: 'usage', text: '드러나다：原本隐藏/未知的事实被查出、被揭露', examples: '조사 결과 부정행위가 있었던 것으로 드러났다（调查结果查明存在舞弊行为。）' },
      ...
      { type: 'note', text: '中文"显示"是及物的（数据显示X），但这里的 나타나다 是自动词（不带宾语）：被显示的内容当主语用 이/가 + 것으로，绝不加 를。带宾语的"表现/显示"是另一个他动词 나타내다，别混。', examples: '(○) 응답자의 70%가 반대하는 것으로 나타났다 / (✗) 조사가 반대를 나타났다' },
      { type: 'note', text: '나타나다 本义是"出现/显现"（사람이 나타났다=有人出现了）。它作"（调查）显示"讲只在 조사/통계/결과 这类数据语境里成立，脱离这个语境会被理解成"出现"。', examples: '설문 조사 결과 …한 것으로 나타났다（在数据语境里=显示）' },
    ],
    cardExamples: [
      {
        wordBlocks: [
...
<div class="ov-section">
  ...
  // ── 第3课：-(으)ㄹ 전망이다 / -(으)ㄹ 것으로 보이다 ──────────────────────────────────────
  {
    ...
    connectionRules: [
      ...
      { type: 'note', text: '전망이다 是"名词 전망(展望) + 이다"结构（不是动词）。所以按 이다 变化：现在 전망이다、敬语 전망입니다，绝不能写成 전망한다/전망하다。中文把"预计"当动词，这里却是"是…的展望"。', examples: '(○) 늘어날 전망이다 / (✗) 늘어날 전망한다' },
      { type: 'note', text: '보이다·예상되다 是自动词/被动，主语是"被预测的那件事"本身，句子已表客观预测；不要换成主动的 보다/예상하다（那会变成"某人看/某人预料"，失去新闻的客观口吻）。', examples: '(○) 기온이 떨어질 것으로 예상된다 / (✗) 기온이 떨어질 것으로 예상한다' },
    ],
    cardExamples: [
      {
        wordBlocks: [
...
<div class="ov-section">
  ...
  // ── 第4课：-기에 앞서 / -에 앞서 ──────────────────────────────────────
  {
    ...
    connectionRules: [
      ...
      { type: 'usage', text: '语体：书面/正式；多用于致辞、报告、公文', examples: '시작하기에 앞서 감사의 말씀을 드립니다.（在开始之前，先向各位致谢。）' },
      { type: 'usage', text: '常配主语"먼저 / 우선 / 우선적으로"强调"先做"', examples: '결정에 앞서 우선 정보를 수집해야 한다.（在做决定之前，首先要收集信息。）' },
      ...
      { type: 'note', text: '读新闻时还会单独看到 앞서 当副词用，意思是"此前/早前"（不带 -기에/-에），后面接已发生的事；常见 "이에 앞서"＝在此之前。别把它当成本课的"在…之前"连接词。', examples: '앞서 정부는 대책을 발표했다.（此前，政府发布了对策。）/ 이에 앞서 실무 협의가 있었다.（在此之前进行了工作磋商。）' },
      { type: 'compare', text: '-에 앞서 vs -을/를 앞두고 → 前者"在做A之前(先做B)"，后者"某大事在即/临近"。中文都译"…之前"，但 앞두고 强调"面临、即将到来"。', examples: '회의에 앞서 자료를 배포했다（开会前先发资料）/ 선거를 앞두고 긴장이 높아지고 있다（临近选举，气氛紧张）' },
    ],
    cardExamples: [
      {
        wordBlocks: [
...
<div class="ov-section">
  ...
  // ── 第5课：-기(를) 요구하다 / 촉구하다 / 당부하다 ──────────────────────────────────────
  {
    ...
    connectionRules: [
      ...
      { type: 'usage', text: '요구하다 → 语气最强，含强烈诉求', examples: '시민들은 사과를 요구했다.（市民们要求道歉。）' },
      { type: 'usage', text: '촉구하다 → 敦促、催促（正式媒体常用）', examples: '야당은 사퇴를 촉구했다.（在野党敦促辞职。）' },
      { type: 'usage', text: '당부하다 → 郑重叮嘱、呼吁（上级/长辈/官方对民众）', examples: '대통령이 방역 협조를 당부했다.（总统呼吁配合防疫。）' },
      { type: 'compare', text: '要求 vs 呼吁 → 요구强，촉구敦促，당부柔和劝导', examples: '요구하다 > 촉구하다 > 당부하다（语气强度：要求 > 敦促 > 恳请，依次减弱）' },
      { type: 'note', text: '也可用名词化短语：재검토를 요구하다 / 사퇴를 촉구하다', examples: '要求/敦促的对象是"某行为"，用 명사 -를 或 -기(를)' },
      { type: 'note', text: '"对象方"（政府/国民）用 -에/-에게，只有"被要求的内容"才用 -를：中文"要求政府"会把政府误当宾语', examples: '정부에 재검토를 요구하다（○）/ 국민에게 협조를 당부하다（○）' },
    ],
    cardExamples: [
      {
        wordBlocks: [
...
<div class="ov-section">
  ...
  // ── 第6课：-는 데 그치다 / -에 그치다 ──────────────────────────────────────
  {
    ...
    connectionRules: [
      ...
      { type: 'compare', text: '这里的 데 是"依存名词"（空格分写），别和连接词尾 -는데（连写）混：하는 데 그치다 ≠ 하는데', examples: '논의하는 데 그쳤다（停留在讨论这件事上，데 分写）/ 논의하는데 시간이 걸렸다（讨论…时花了时间，-는데 连写）' },
...
<div class="ov-section">
  ...
  // ── 第7课：-자 (书面语一……就……) ──────────────────────────────────────
  {
    ...
    connectionRules: [
      ...
      { type: 'compare', text: '同形不同物：句中连接词尾 -자（一…就…）≠ 句尾반말 청유형 -자（…吧），别看到 -자 就当"一…就…"', examples: '(连接) 막이 오르자 박수를 쳤다 / (청유) 우리 이제 시작하자!（咱们现在开始吧！）' },
      { type: 'note', text: '不能与命令 -(으)세요 / 请求 -아/어 주세요 / 劝诱 -(으)ㅂ시다 搭配', examples: '误：집에 오자 밥 먹읍시다.（意义混乱）' },
      { type: 'note', text: '句尾多用过去 -았/었다，客观陈述已发生事件', examples: '뉴스가 발표되자 시장이 반응했다.（新闻一发布，市场就作出了反应。）' },
    ],
    cardExamples: [
      {
        wordBlocks: [
    ...
    mistakes: [
      ...
      { wrong: '뉴스가 발표됐자 시장이 반응했다', correct: '뉴스가 발표되자 시장이 반응했다', note: '-자 直接接词干，前面不能加过去 -았/었-；中文"发布了就…"的"了"别硬译进来' },
    ],
    quickTable: {
      title: '-자 vs -자마자',
      headers: ['形式', '语体', '备注'],
...
<div class="ov-section">
  ...
  // ── 第8课：이래(로) / -(으)ㄴ 이래 ──────────────────────────────────────
  {
    ...
    connectionRules: [
      ...
      { type: 'usage', text: '含"从起点持续至今"的时间跨度', examples: '2000년 이래 처음 있는 일이다.（这是2000年以来头一回。）' },
      { type: 'compare', text: '이래(로) vs -(으)ㄴ 후로 → 前者书面/正式，后者中性', examples: '(书面) 창사 이래 / (日常) 회사 세운 후로' },
      { type: 'note', text: '通常与"가장 / 처음 / 계속 / 매일"等副词呼应', examples: '창사 이래 가장 큰 성장을 이뤘다.（取得了公司成立以来最大的增长。）' },
      { type: 'note', text: '-로 可省，"이래" 单用也可', examples: '창사 이래 = 창사 이래로' },
      { type: 'compare', text: '同译"自从来韩"：-(으)ㄴ 지 配 되다/지나다 说"过了多久"；이래 引出"这段期间一直/最…"，别混', examples: '한국에 온 지 3년이 됐다.（来韩3年了·算时长）/ 한국에 온 이래 매일 공부했다.（来韩以来天天学·说期间）' },
      { type: 'note', text: '이래 前多接"有分量的起点"（创立/来韩/观测/建国），接琐碎日常动作会不自然', examples: '창사 이래 / 건국 이래（○）；아침 먹은 이래（△，日常小事不搭）' },
    ],
    cardExamples: [
      {
        wordBlocks: [
