...
export const articles: Article[] = [
  ...
  // ── 2. 我的家人 (Beginner) ──
  {
    ...
    sentences: [
      ...
      { ko: '어머니는 요리를 정말 잘하세요. 특히 김치찌개를 제일 맛있게 만드세요.', zh: '妈妈做饭特别好吃。尤其泡菜汤做得最美味。', pronunciation: 'eo-meo-ni-neun yo-ri-reul jeong-mal jal-ha-se-yo. teu-ki gim-chi-jji-gae-reul je-il ma-sit-ge man-deu-se-yo', vocab: [{ word: '특히', meaning: '尤其' }, { word: '김치찌개', meaning: '泡菜汤' }, { word: '맛있다', meaning: '好吃' }], grammar: '~게: 副词化词尾，形容词+게→"…地"' },
