...
`,
...

  {
    ...
    connectionRules: [
      ...
      { type: 'rule', text: '名词+이다：-(이)냐고 하다（有收音：이냐고，无收音：냐고）', examples: '학생이냐고 / 의사냐고' },
      { type: 'rule', text: '过去时：-았/었냐고 하다', examples: '갔냐고 / 먹었냐고 / 좋았냐고' },
      { type: 'usage', text: '-는지/-은지/-인지 与 알다/모르다 搭配时是委婉的间接疑问', examples: '어디 사는지 알아요? / 바쁜지 몰라요' },
    ...
    scenarios: [
      ...
      { icon: '🏫', context: '间接疑问', ko: '그 사람이 어디 사는지 혹시 알아요?', zh: '你知道那个人住哪里吗？' },
    ],
    mistakes: [
...
`,
    quickTable: {
      ...
      rows: [
        [{ ko: '동사', zh: '动词' }, { ko: '-느냐고/-냐고', zh: '' }, { ko: '가냐고 물었어요', zh: '' }, { ko: '问去不去', zh: '' }],
        [{ ko: '형용사', zh: '形容词' }, { ko: '-(으)냐고', zh: '' }, { ko: '바쁘냐고 물었어요', zh: '' }, { ko: '问忙不忙', zh: '' }],
        [{ ko: '명사+이다', zh: '名词谓词' }, { ko: '-(이)냐고', zh: '' }, { ko: '학생이냐고 물었어요', zh: '' }, { ko: '问是不是学生', zh: '' }],
        [{ ko: '과거시제', zh: '过去时' }, { ko: '-았/었냐고', zh: '' }, { ko: '먹었냐고 물었어요', zh: '' }, { ko: '问吃了没', zh: '' }],
      ],
    },
    specialQuiz: {
      type: 'fill',
...

  {
    ...
    connectionRules: [
      { type: 'rule', text: '命令句：动词 词干 + -(으)라고 하다（有收音+으라고，无收音+라고）', examples: '먹다→먹으라고 / 가다→가라고 / 앉다→앉으라고 / 만들다→만들라고' },
      { type: 'rule', text: '命令句否定：动词 词干 + -지 말라고 하다', examples: '가지 말라고 했어요（叫不要去）/ 먹지 말라고 했어요（叫不要吃）' },
      { type: 'rule', text: '共动句：动词 词干 + -자고 하다（形式固定，不区分收音）', examples: '가다→가자고 / 먹다→먹자고 / 공부하다→공부하자고' },
...
`,
...

  {
    ...
    connectionRules: [
      ...
      { type: 'rule', text: '-아/어/여 보니까：动词 + 아/어/여 보니까（"尝试后发现"）', examples: '먹어 보니까 / 해 보니까 / 가 보니까 / 살아 보니까' },
...
`,
    quickTable: {
      ...
      rows: [
        ...
        [{ ko: 'ㅂ 불규칙', zh: 'ㅂ不规则' }, { ko: '-우니까', zh: '' }, { ko: '춥다→추우니까', zh: '' }, { ko: '因为冷', zh: '' }],
      ],
    },
    specialQuiz: {
      type: 'fill',
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 2 as 0|1|2|3,
          explanation: '-(으)니까 后句可接命令/共动句，-아/어서 不可以',
        },
        {
...

  {
    ...
    connectionRules: [
      { type: 'rule', text: '名词 + (으)로 유명하다：有收音+으로，无收音/ㄹ+로', examples: '음식으로 유명해요 / 경치로 유명해요 / K-pop으로 유명해요' },
      { type: 'rule', text: '动词 词干 + -기로 유명하다：以做某事著名', examples: '노래를 잘 하기로 유명해요 / 오래 걷기로 유명해요' },
      { type: 'rule', text: '名词 + 이/가 되다：有收音+이 되다，无收音+가 되다', examples: '의사가 됐어요 / 선생님이 됐어요 / 친구가 됐어요' },
...
`,
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 2 as 0|1|2|3,
          explanation: '됐어요 = 되+었어요 的缩略形，됬어요/됬었어요 都是错误拼写',
        },
      ],
    },
...

  {
    ...
    connectionRules: [
      ...
      { type: 'rule', text: '-는 게 좋겠다：动词 词干 + -는 게 좋겠어요（委婉建议）', examples: '쉬는 게 좋겠어요 / 먹는 게 좋겠어요 / 말하는 게 좋겠어요' },
      { type: 'usage', text: '-을/ㄹ 만하다 可与 -아/어 보다 结合：-아/어 볼 만하다', examples: '먹어 볼 만해요（值得尝尝）/ 가 볼 만한 곳이에요（值得去的地方）' },
      { type: 'usage', text: '-을/ㄹ 만하다 可作冠词形修饰名词：-을/ㄹ 만한 + 名词', examples: '볼 만한 영화（值得看的电影）/ 갈 만한 카페（值得去的咖啡厅）' },
...
<div class="reminder-box">看视角：<b>评价事物</b>用 <b>-을 만하다</b>（电影值得看 / 地方值得去）；<b>劝告对方</b>用 <b>-는 게 좋겠다</b>（你该去医院 / 你早点睡）。</div>`,
...

  {
    ...
    rulesNote: '아니면 用于句子之间，(이)나 接名词，-거나 接用言（动词/形容词）。\n(이)나 除了"或者"外还有"大约/至少"的意思：시간이 한 시간이나 걸려요（要花整整一小时）。',
    structures: [
      {
        ko: '커피 아니면 차를 마실게요',
        zh: '我喝咖啡或者茶。',
    ...
    connectionRules: [
      ...
      { type: 'rule', text: '(이)나：名词 + 이나（有收音）/ 나（无收音），"……或者……"', examples: '사과나 바나나 / 책이나 잡지 / 커피나 주스' },
      { type: 'rule', text: '-거나：动词/形容词 词干 + -거나，连接两个同等选项', examples: '먹거나 마시거나 / 크거나 작거나 / 가거나 안 가거나' },
    ...
    scenarios: [
      ...
      { icon: '💬', context: '强调用法 이나', ko: '그 가방이 얼마나 비싼지, 100만 원이나 해요!', zh: '那个包多贵啊，要100万韩元！' },
    ...
    mistakes: [
      ...
      { wrong: '먹거나이나 마셔요（-거나 + 이나 혼용）', correct: '먹거나 마셔요', note: '-거나 和 (이)나 功能相同，只需用一个。动词后接 -거나，名词后接 (이)나。' },
      { wrong: '커피 아니면이나 차（아니면 + 이나 混用）', correct: '커피 아니면 차 或 커피나 차', note: '아니면 和 (이)나 作用相同，只用其中一个即可。' },
      { wrong: '한 시간나 기다렸어요（无收音名词用 이나）', correct: '한 시간이나 기다렸어요', note: '시간 有收音（간）→ 시간이나（强调用法）。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 3 as 0|1|2|3,
          explanation: '이나 的强调用法：한 시간이나 기다렸어요（等了整整一小时）',
        },
      ],
    },
...
`,
    quickTable: {
      ...
      rows: [
        [{ ko: '아 계열', zh: 'ㅏ/ㅗ结尾' }, { ko: '-아 보이다', zh: '' }, { ko: '작아 보여요', zh: '' }, { ko: '看起来小', zh: '' }],
        [{ ko: '어 계열', zh: '其他' }, { ko: '-어 보이다', zh: '' }, { ko: '힘들어 보여요', zh: '' }, { ko: '看起来辛苦', zh: '' }],
        [{ ko: '하다 계열', zh: '' }, { ko: '-해 보이다', zh: '' }, { ko: '행복해 보여요', zh: '' }, { ko: '看起来幸福', zh: '' }],
        [{ ko: 'ㅂ 불규칙', zh: 'ㅂ不规则' }, { ko: '우+어=워 보이다', zh: '' }, { ko: '어려워 보여요', zh: '' }, { ko: '看起来难', zh: '' }],
      ],
    },
    specialQuiz: {
      type: 'fill',
      ...
      questions: [
        {
          ...
          options: ['아', '어', '나', '해'],
          answer: 0 as 0|1|2|3,
          explanation: '좋다 末元音 ㅗ（阳性元音）→ 좋아 보여요（아 系列）',
        },
        {
          prompt: '外面好像在下雨。→ 밖에 비가 오___ 봐요',
          options: ['은가', '는가', '아', '나'],
          answer: 3 as 0|1|2|3,
          explanation: '动词 오다 → 오나 봐요',
        },
        {
          prompt: '好像很忙。→ 바쁜___ 봐요',
          options: ['어', '가', '나', '아'],
          answer: 1 as 0|1|2|3,
          explanation: '形容词 바쁘다 → 바쁜가 봐요（-(으)ㄴ가 보다）',
        },
        {
          prompt: '-아/어/여 보이다 主要与哪类词结合？',
          options: ['名词', '动词', '形容词', '副词'],
          answer: 2 as 0|1|2|3,
          explanation: '-아/어 보이다 主要与形容词结合，表达视觉印象',
        },
      ],
    },
    linkedGrammarIds: [],
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['해', '어', '아', '나'],
          answer: 0 as 0|1|2|3,
          explanation: '행복하다 → 행복해 보여요（하다 类→해）',
        },
        {
          prompt: '因为很晚了，快点走吧。→ 많이 늦었___ 빨리 가요',
          options: ['아서', '어서', '으면', '으니까'],
          answer: 3 as 0|1|2|3,
          explanation: '늦다（有收音）→ 늦었으니까（后接命令/建议可以）',
        },
        {
          prompt: '外面好像在下雨。→ 밖에 비가 오___ 봐요',
          options: ['아', '나', '는다', '는가'],
