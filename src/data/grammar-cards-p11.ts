...
export const grammarCardsP11: GrammarCard[] = [
  {
    ...
    mistakes: [
      { wrong: '친구가 바쁘는다고 했어요', correct: '친구가 바쁘다고 했어요', note: '形容词用 -다고，不加 -는다고。只有动词才区分是否有收音。' },
      { wrong: '그 사람이 의사이라고 했어요', correct: '그 사람이 의사라고 했어요', note: '名词无收音时用 -라고，有收音才用 -이라고。의사 无收音 → 의사라고.' },
      { wrong: '어제 먹었는다고 했어요', correct: '어제 먹었다고 했어요', note: '过去时 -았/었- 后统一用 -다고，不分动词形容词。' },
      { wrong: '오늘 가는다고 해요', correct: '오늘 간다고 해요', note: '가다 는 无收音词干 → -ㄴ다고：가다→간다고。-는다고 只用于有收音词干（먹다→먹는다고）。' },
    ],
      ...
      questions: [
        {
          ...
          options: ['피곤하다고 했어요', '피곤는다고 했어요', '피곤이라고 했어요', '피곤한다고 했어요'],
          answer: 0 as 0|1|2|3,
          explanation: '형용사 → -다고 하다',
        },
        {
          prompt: '他说是医生。→ 의사___ 했어요',
          options: ['라고', '이라고', '는다고', '다고'],
          answer: 0 as 0|1|2|3,
...

  {
    ...
    mistakes: [
      { wrong: '친구가 바쁘는냐고 물었어요', correct: '친구가 바쁘냐고 물었어요', note: '형용사는 -(으)냐고，不加 -는。바쁘다 → 바쁘냐고。' },
      { wrong: '의사이냐고 물었어요', correct: '의사냐고 물었어요', note: '무받침 명사 + 냐고，유받침 명사 + 이냐고。의사 무받침 → 의사냐고。' },
      { wrong: '어디 가느냐고 알아요?', correct: '어디 가는지 알아요?', note: '与 알다/모르다 搭配用 -는지，不用 -냐고。' },
      { wrong: '먹었는냐고 물었어요', correct: '먹었냐고 물었어요', note: '过去时 -았/었- 后直接加 -냐고，不加 -는。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
...

  {
    ...
    mistakes: [
      { wrong: '선생님이 앉으자고 했어요', correct: '선생님이 앉으라고 했어요', note: '-자고 是共动句（一起做），-(으)라고 才是命令句（叫别人做）。' },
      { wrong: '친구가 가자라고 했어요', correct: '친구가 가자고 했어요', note: '共动句引语固定用 -자고，不存在 -자라고 形式。' },
      { wrong: '가지 않으라고 했어요', correct: '가지 말라고 했어요', note: '命令句否定固定用 -지 말라고，不用 -지 않으라고。' },
      { wrong: '먹으라고 하라고 했어요', correct: '먹으라고 했어요', note: '引语动词 하다 只用一次，不重复。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
...

  {
    ...
    mistakes: [
      { wrong: '피곤해서 쉬세요', correct: '피곤하니까 쉬세요', note: '-아/어서 후절에 명령/청유 불가。命令句前必须用 -(으)니까。' },
      { wrong: '먹어보니까', correct: '먹어 보니까', note: '-아/어/여 보니까 中 보다 是补助动词，与前面的 아/어 分开写。' },
      { wrong: '가니까서 늦었어요', correct: '가니까 늦었어요 或 가서 늦었어요', note: '-니까 和 -아/어서 只能用一个，不能叠加。' },
      { wrong: '춥으니까', correct: '추우니까', note: '춥다는 ㅂ 불규칙：词干末 ㅂ + 으니까 → ㅂ→우 변환 → 추우니까。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
...

  {
    ...
    mistakes: [
      { wrong: '서울은 K-pop이로 유명해요', correct: '서울은 K-pop으로 유명해요', note: 'K-pop 以 p 收音结尾 → K-pop으로（有收音+으로）。' },
      { wrong: '의사이가 됐어요', correct: '의사가 됐어요', note: '의사 无收音 → 의사가 되다，不加 이。이/가 只能选一个。' },
      { wrong: '그 사람은 노래로 유명해요', correct: '그 사람은 노래를 잘 하기로 유명해요', note: '用动词表达"以做某事著名"时用 -기로 유명하다，用名词时用 (으)로 유명하다。' },
      { wrong: '됬어요', correct: '됐어요', note: '되다 过去时：됐어요（되+었→됐），不是 됬어요。这是常见拼写错误。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
...

  {
    ...
    mistakes: [
      { wrong: '이 영화는 보는 만해요', correct: '이 영화는 볼 만해요', note: '-을/ㄹ 만하다 前必须用冠词形 -을/ㄹ，不用 -는。' },
      { wrong: '쉬겠는 게 좋겠어요', correct: '쉬는 게 좋겠어요', note: '-는 게 좋겠다 中겠 在좋겠다 안에，动词部分用 -는，不겠 추가 금지。' },
      { wrong: '먹어 만해요', correct: '먹어 볼 만해요', note: '与 보다 结合时形式是 -아/어 볼 만하다，보다 不能省略。' },
      { wrong: '갈 만해서 가세요', correct: '갈 만하면 가세요 或 가 볼 만하니까 가세요', note: '-을/ㄹ 만하다 本身是形容词，其后不直接接命令，需加条件或因果连接。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
  ...
  <div class="cmp-block" style="border-left:4px solid #aee3d8">
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        {
          prompt: '"值得去一次的地方"韩语是？',
          options: ['한 번 가 볼 만한 곳', '한 번 가는 만한 곳', '한 번 갈 만하는 곳', '한 번 가기 만한 곳'],
          answer: 0 as 0|1|2|3,
...

  {
    ...
    mistakes: [
      { wrong: '사과이나 바나나', correct: '사과나 바나나', note: '사과 无收音 → 사과나。이나 用于有收音名词：책이나。' },
      { wrong: '먹거나이나 마셔요', correct: '먹거나 마셔요', note: '-거나 와 (이)나 는 같은 기능이므로 하나만 쓴다。동사에는 -거나，명사에는 (이)나。' },
      { wrong: '커피 아니면이나 차', correct: '커피 아니면 차 或 커피나 차', note: '아니면 和 (이)나 작용이 같으니 하나만 쓸 것。' },
      { wrong: '한 시간나 기다렸어요', correct: '한 시간이나 기다렸어요', note: '시간 有收音（간）→ 시간이나（강조 용법）。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['强调数量多或时间长', '表示命令', '表示让步', '表示原因'],
          answer: 0 as 0|1|2|3,
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['형용사（形容词）', '동사（动词）', '명사（名词）', '부사（副词）'],
          answer: 0 as 0|1|2|3,
