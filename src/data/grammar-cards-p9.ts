...
export const grammarCardsP9: GrammarCard[] = [
  {
    ...
    mistakes: [
      ...
      { wrong: '내일 갈 것 같습니다', correct: '내일 가겠습니다', note: '正式场合表意向用 -겠습니다，-것 같다 是推测，不适合用于正式承诺。' },
    ],
...
<div class="reminder-box">저는 피곤하겠어요 ✗ — -겠- 第一人称推测自己的感受很奇怪，说自己的状态直接用 피곤해요。</div>`,
    ...
    specialQuiz: {
      ...
      questions: [
        { pre: '제가 먼저', post: '。（我先去确认——意向）', prompt: '我先去确认（表意向）→ 제가 먼저 ___。', options: ['확인할 것 같아요', '확인하겠습니다', '확인하는 것 같아요', '확인했겠어요'], answer: 1, explanation: '正式场合表意向用 -겠습니다，不用 -것 같다' },
        { pre: '오늘 날씨가', post: '。（感觉天气好像很冷——柔和推测）', prompt: '感觉天气好像很冷（柔和推测）→ 오늘 날씨가 ___。', options: ['춥겠어요', '추운 것 같아요', '춥는 것 같아요', '추울겠어요'], answer: 1, explanation: '柔和推测用 -것 같다，形容词接 -은/ㄴ 것 같다 → 추운 것 같아요' },
        { pre: '', post: '（我明白了——日常表达）', prompt: '我明白了（日常表达）→ ___', options: ['아는 것 같아요', '알겠어요', '알 것 같아요', '아는 것 같겠어요'], answer: 1, explanation: '알겠어요 是固定表达"我明白了"，用 -겠-' },
        { pre: '그 영화가', post: '。（那部电影好像很有意思——推测）', prompt: '那部电影好像很有意思（推测）→ 그 영화가 ___。', options: ['재미있겠어요', '재미있을 것 같아요', '재미있는 것 같겠어요', '재미있었겠어요'], answer: 1, explanation: '对将来事物的柔和推测用 -을 것 같다 → 재미있을 것 같아요' },
      ],
    },
  ...
  },
  {
    ...
    mistakes: [
      { wrong: '맛있는구나', correct: '맛있구나', note: '形容词 + -구나 直接接词干，不需要加 -는。只有动词才用 -는구나。' },
...
<div class="reminder-box">形容词 + -네요/-군요/-구나 直接接词干，不加 -는。只有动词才用 -는네요/-는군요/-는구나。</div>`,
    ...
    specialQuiz: {
      ...
      questions: [
        { pre: '对上司说：서울이 정말 크', post: '（首尔真大啊）', prompt: '对上司说"首尔真大啊" → 서울이 정말 크___', options: ['구나', '는구나', '군요', '네요'], answer: 3, explanation: '对上司用礼貌语尾 -네요 或 -군요，-구나 对长辈失礼' },
        { pre: '自言自语：아, 이게 정답이', post: '（哦，原来这是答案）', prompt: '自言自语"哦，原来这是答案" → 아, 이게 정답이___', options: ['네요', '군요', '구나', '는구나'], answer: 2, explanation: '形容词/이다 + -구나，自言自语用非正式 -구나' },
        { pre: '形容词 맛있다 + -군요 →', post: '', prompt: '形容词 맛있다 接 -군요，正确形式是？', options: ['맛있는군요', '맛있군요', '맛있겠군요', '맛있었는군요'], answer: 1, explanation: '形容词直接接 -군요，不加 -는' },
        { pre: '动词 먹다 + -는구나 →', post: '', prompt: '动词 먹다 接 -는구나，正确形式是？', options: ['먹구나', '먹는구나', '먹는는구나', '먹었는구나'], answer: 1, explanation: '动词현재 + -는구나 → 먹는구나' },
      ],
    },
  ...
  },
  {
    ...
    mistakes: [
      { wrong: '날씨가 춥는 것 같아요', correct: '날씨가 추운 것 같아요', note: '形容词用 -은/ㄴ 것 같다，不加 -는。只有动词现在时才用 -는 것 같다。' },
      { wrong: '학생것 같다', correct: '학생인 것 같다', note: '名词后必须加 -인 것 같다，不能省略 -인。' },
      { wrong: '내일 비가 오는 것 같아요', correct: '내일 비가 올 것 같아요', note: '将来推测用 -을/ㄹ 것 같다，-는 것 같다 表示现在正在发生。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
...
<div class="reminder-box">형용사 + -는 것 같다 ✗ → 형용사는 -은/ㄴ 것 같다 ✓（추운 것 같아요，not 춥는 것 같아요）</div>`,
    ...
    specialQuiz: {
      ...
      questions: [
        { pre: '形容词 춥다 →', post: '（好像很冷）', prompt: '形容词 춥다 接 -것 같다（好像很冷）→ ___', options: ['춥는 것 같아요', '추운 것 같아요', '출 것 같아요', '춥은 것 같아요'], answer: 1, explanation: '形容词无收音+ㄴ 것 같다，춥다 ㅂ불규칙 → 추운 것 같아요' },
        { pre: '동사 가다 현재 →', post: '（好像在去）', prompt: '动词 가다 현재接 -것 같다（好像在去）→ ___', options: ['간 것 같아요', '갈 것 같아요', '가는 것 같아요', '가은 것 같아요'], answer: 2, explanation: '동사 현재 + 는 것 같다 → 가는 것 같아요' },
        { pre: '동사 먹다 미래 →', post: '（好像要吃）', prompt: '动词 먹다 未来接 -것 같다（好像要吃）→ ___', options: ['먹는 것 같아요', '먹은 것 같아요', '먹을 것 같아요', '먹인 것 같아요'], answer: 2, explanation: '미래는 有收음+을 것 같다 → 먹을 것 같아요' },
        { pre: '명사 학생이다 →', post: '（好像是学生）', prompt: '名词 학생이다 接 -것 같다（好像是学生）→ ___', options: ['학생는 것 같아요', '학생인 것 같아요', '학생은 것 같아요', '학생이는 것 같아요'], answer: 1, explanation: '명사+이다 → 명사+인 것 같다 → 학생인 것 같아요' },
      ],
    },
...
<div class="reminder-box">마다 + 동사词干 ✗（먹마다 ✗）— 마다 只接名词。动词用 -을 때마다。</div>`,
    ...
    specialQuiz: {
      ...
      questions: [
        { pre: '매일（每天）→ 날', post: '운동해요', prompt: '每天运动 → 날 ___ 운동해요', options: ['동안', '마다', '때마다', '는 동안'], answer: 1, explanation: '명사 + 마다 = 每个……，날마다 = 每天' },
        { pre: '한국에 있', post: '한국어를 배웠어요（在韩国期间学了韩语）', prompt: '在韩国期间学了韩语 → 한국에 있___ 한국어를 배웠어요', options: ['는 동안', '을 때마다', '마다', '동안'], answer: 0, explanation: '-는 동안 = 在……的期间（동사接续）' },
        { pre: '이 노래를 듣', post: '기억나요（每次听这首歌都会想起）', prompt: '每次听这首歌都会想起 → 이 노래를 듣___ 기억나요', options: ['는 동안', '마다', '을 때마다', '는 마다'], answer: 2, explanation: '듣다 有收음ㄷ → 들을 때마다（ㄷ불규칙）' },
        { pre: '주말', post: '쉬어요（每个周末休息）', prompt: '每个周末休息 → 주말 ___ 쉬어요', options: ['동안', '마다', '때마다', '는 동안'], answer: 1, explanation: '명사 + 마다 = 每个……，주말마다 = 每个周末' },
      ],
    },
  ...
  },
  {
    ...
    mistakes: [
      { wrong: '잘 하기는요', correct: '잘하기는요', note: '잘하다 是一个词，不要拆开写。' },
      { wrong: '잘하기는요, 그런데 사실 잘해요', correct: '잘하기는요', note: '-기는요 是谦虚否认，后面如果强行加解释说"其实我很好"就破坏了谦虚语气，直接 잘하기는요 单独说即可。' },
...
<div class="reminder-box">-기는요 单独用作回应，-기는 하다 后面要跟 -는데/-지만 才完整，不能单独结束句子。</div>`,
    ...
    specialQuiz: {
      ...
      body: '根据语境选择正确的表达。',
      questions: [
        { pre: 'A: 노래를 정말 잘하세요! B:', post: '（哪里哪里，还不行）', prompt: 'A说"你歌唱得真好"，B谦虚回应 → A: 노래를 정말 잘하세요! B: ___', options: ['잘하기는요', '잘하기는 해요', '잘하기는 하는데요', '잘하는데요'], answer: 0, explanation: '谦虚否定夸奖用 -기는요' },
        { pre: '영화를 보기는 ', post: '재미없었어요（倒是看了，但没意思）', prompt: '倒是看了电影，但没意思 → 영화를 보기는 ___ 재미없었어요', options: ['봤는데', '했는데', '하는데', '기는요'], answer: 1, explanation: '-기는 했는데 = 倒是（过去）+转折，보기는 했는데' },
        { pre: '운동을 하기는 ', post: '자주는 못 해요（倒是做运动，但不常做）', prompt: '倒是做运动，但不常做 → 운동을 하기는 ___ 자주는 못 해요', options: ['했는데', '해요', '하는데', '했어요'], answer: 2, explanation: '-기는 하는데 = 倒是（现在习惯）+转折' },
        { pre: 'A: 요리 잘하시죠? B:', post: '（哪里，我不太会做）', prompt: 'A说"你厨艺很好吧"，B谦虚回应 → A: 요리 잘하시죠? B: ___', options: ['잘하기는요', '잘하기는 해요', '못하기는요', '잘하는데요'], answer: 0, explanation: '-기는요 谦虚回应，否定对方的夸奖' },
      ],
    },
  ...
  },
  {
    ...
    mistakes: [
      ...
      { wrong: '날씨가 좋아하게 됐어요', correct: '좋아지다', note: '-게 되다 用于동사（如 좋아하다），形容词 좋다 变化要用 좋아지다，不是 좋아하게 되다。' },
      { wrong: '한국어가 어려워지게 됐어요', correct: '한국어가 어려워졌어요 / 한국어가 어렵게 됐어요', note: '-아/어/여지다 和 -게 되다 功能重叠，不叠用，选一个即可。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
...
<div class="reminder-box">好记法：-아/어지다 = 状态"变了"（형용사首选）/ -게 되다 = 事情"发展成"（动사首选，说缘由和过程）</div>`,
    ...
    specialQuiz: {
      ...
      body: '根据语境选择正确的变化表达。',
      questions: [
        { pre: '날씨가 많이 따뜻', post: '（天气变暖了）', prompt: '天气变暖了 → 날씨가 많이 따뜻___', options: ['해졌어요', '하게 됐어요', '해지게 됐어요', '하게 되었어요'], answer: 0, explanation: '따뜻하다 → 따뜻해지다，形容词状态变化用 -아/어지다' },
        { pre: '한국어를 공부하', post: '（就开始学韩语了——顺其自然）', prompt: '就开始学韩语了（顺其自然）→ 한국어를 공부하___', options: ['아졌어요', '어졌어요', '게 됐어요', '게 되어졌어요'], answer: 2, explanation: '동사 + -게 되다，表示顺势发展的结果' },
        { pre: '그 사람을 좋아하', post: '（慢慢喜欢上那个人了）', prompt: '慢慢喜欢上那个人了 → 그 사람을 좋아하___', options: ['아졌어요', '게 됐어요', '어졌어요', '게 되어졌어요'], answer: 1, explanation: '좋아하다 是动词，顺势发展用 -게 되다' },
        { pre: '요즘 건강이 많이 좋', post: '（最近身体好多了）', prompt: '最近身体好多了 → 요즘 건강이 많이 좋___', options: ['게 됐어요', '아졌어요', '아지게 됐어요', '아하게 됐어요'], answer: 1, explanation: '좋다 ㅗ结尾形容词 → 좋아지다，状态变化用 -아지다' },
      ],
    },
  ...
  },
  {
    ...
    mistakes: [
      { wrong: '저는 키가 크는 편이에요', correct: '저는 키가 큰 편이에요', note: '形容词用 -은/ㄴ 편이다，不加 -는。크다 → 큰 편이다。' },
  ...
  },
  {
    ...
    mistakes: [
      ...
      { wrong: '울자마자 웃었어요', correct: '울다가 웃었어요', note: '-자마자 강调立刻转变，哭了就笑更自然用 -다가 表示中途转换。' },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
      ...
      questions: [
        {
          ...
          options: ['자마자', '기 전에', '기 시작하면', '은 후에'],
          answer: 0 as 0|1|2|3,
          explanation: "-자마자 接动词词干基本形",
        },
        {
          prompt: '开始学韩语了。→ 한국어를 배우___',
          options: ['기 시작했어요', '자마자요', '기 때문이에요', '기 위해요'],
          answer: 0 as 0|1|2|3,
          explanation: "动词 + 기 시작하다 = 开始……",
        },
        {
          prompt: '-자마자 前半句用什么时态？',
          options: ['基本形（不变时态）', '过去时', '现在时', '将来时'],
          answer: 0 as 0|1|2|3,
          explanation: "-자마자 前半句用基本形，后半句决定时态",
        },
        {
          prompt: '雨开始下了。→ 비가 오___',
          options: ['기 시작했어요', '자마자요', '기로 했어요', '기 싫어요'],
          answer: 0 as 0|1|2|3,
      ...
      questions: [
        {
          ...
          options: ['도와준 덕분에', '도와주기 때문에', '도와주자마자', '도와주는 데다가'],
          answer: 0 as 0|1|2|3,
          explanation: "동사관형형 + 덕분에 = 多亏……",
        },
        {
          prompt: '你知道他住哪里吗？→ 그 사람이 어디 사는 ___',
          options: ['지 알아요?', '지도 알아요?', '것 알아요?', '데 알아요?'],
          answer: 0 as 0|1|2|3,
          explanation: "-는/은/ㄴ 지 알다 = 间接疑问，知道……",
        },
        {
          prompt: '덕분에 表达的是什么语气？',
          options: ['感谢、正面结果', '批评、负面原因', '让步、即使', '顺序、然后'],
          answer: 0 as 0|1|2|3,
          explanation: "덕분에 = 感谢正面结果",
        },
        {
          prompt: '不知道要去哪里。→ 어디에 가야 하는 ___',
          options: ['지 몰라요', '지도 몰라요', '것 몰라요', '데 몰라요'],
          answer: 0 as 0|1|2|3,
...

  {
    ...
    mistakes: [
      ...
      },
      {
        wrong: '가을 수 없어요',
        correct: '갈 수 없어요',
        note: '가다 词干无收音，后接 -ㄹ 수 없다，不是 -을 수 없다。',
      },
      {
