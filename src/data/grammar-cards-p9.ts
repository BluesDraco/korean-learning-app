...
<div class="reminder-box">저는 피곤하겠어요 ✗ — -겠- 第一人称推测自己的感受很奇怪，说自己的状态直接用 피곤해요。</div>`,
    ...
    specialQuiz: {
      ...
      questions: [
        { pre: '제가 먼저', post: '。（我先去确认——意向）', options: ['확인할 것 같아요', '확인하겠습니다', '확인하는 것 같아요', '확인했겠어요'], answer: 1, explanation: '正式场合表意向用 -겠습니다，不用 -것 같다' },
        { pre: '오늘 날씨가', post: '。（感觉天气好像很冷——柔和推测）', options: ['춥겠어요', '추운 것 같아요', '춥는 것 같아요', '추울겠어요'], answer: 1, explanation: '柔和推测用 -것 같다，形容词接 -은/ㄴ 것 같다 → 추운 것 같아요' },
        { pre: '', post: '（我明白了——日常表达）', options: ['아는 것 같아요', '알겠어요', '알 것 같아요', '아는 것 같겠어요'], answer: 1, explanation: '알겠어요 是固定表达"我明白了"，用 -겠-' },
...
<div class="reminder-box">形容词 + -네요/-군요/-구나 直接接词干，不加 -는。只有动词才用 -는네요/-는군요/-는구나。</div>`,
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        { pre: '自言自语：아, 이게 정답이', post: '（哦，原来这是答案）', options: ['네요', '군요', '구나', '는구나'], answer: 2, explanation: '形容词/이다 + -구나，自言自语用非正式 -구나' },
        { pre: '形容词 맛있다 + -군요 →', post: '', options: ['맛있는군요', '맛있군요', '맛있겠군요', '맛있었는군요'], answer: 1, explanation: '形容词直接接 -군요，不加 -는' },
...
<div class="reminder-box">형용사 + -는 것 같다 ✗ → 형용사는 -은/ㄴ 것 같다 ✓（추운 것 같아요，not 춥는 것 같아요）</div>`,
    ...
    specialQuiz: {
      ...
      questions: [
        { pre: '形容词 춥다 →', post: '（好像很冷）', options: ['춥는 것 같아요', '추운 것 같아요', '출 것 같아요', '춥은 것 같아요'], answer: 1, explanation: '形容词无收音+ㄴ 것 같다，춥다 ㅂ불규칙 → 추운 것 같아요' },
        { pre: '동사 가다 현재 →', post: '（好像在去）', options: ['간 것 같아요', '갈 것 같아요', '가는 것 같아요', '가은 것 같아요'], answer: 2, explanation: '동사 현재 + 는 것 같다 → 가는 것 같아요' },
        { pre: '동사 먹다 미래 →', post: '（好像要吃）', options: ['먹는 것 같아요', '먹은 것 같아요', '먹을 것 같아요', '먹인 것 같아요'], answer: 2, explanation: '미래는 有收음+을 것 같다 → 먹을 것 같아요' },
...
<div class="reminder-box">마다 + 동사词干 ✗（먹마다 ✗）— 마다 只接名词。动词用 -을 때마다。</div>`,
    ...
    specialQuiz: {
      ...
      questions: [
        { pre: '매일（每天）→ 날', post: '운동해요', options: ['동안', '마다', '때마다', '는 동안'], answer: 1, explanation: '명사 + 마다 = 每个……，날마다 = 每天' },
        { pre: '한국에 있', post: '한국어를 배웠어요（在韩国期间学了韩语）', options: ['는 동안', '을 때마다', '마다', '동안'], answer: 0, explanation: '-는 동안 = 在……的期间（동사接续）' },
        { pre: '이 노래를 듣', post: '기억나요（每次听这首歌都会想起）', options: ['는 동안', '마다', '을 때마다', '는 마다'], answer: 2, explanation: '듣다 有收음ㄷ → 들을 때마다（ㄷ불규칙）' },
...
<div class="reminder-box">-기는요 单独用作回应，-기는 하다 后面要跟 -는데/-지만 才完整，不能单独结束句子。</div>`,
    ...
    specialQuiz: {
      ...
      body: '根据语境选择正确的表达。',
      questions: [
        { pre: 'A: 노래를 정말 잘하세요! B:', post: '（哪里哪里，还不行）', options: ['잘하기는요', '잘하기는 해요', '잘하기는 하는데요', '잘하는데요'], answer: 0, explanation: '谦虚否定夸奖用 -기는요' },
        { pre: '영화를 보기는 ', post: '재미없었어요（倒是看了，但没意思）', options: ['봤는데', '했는데', '하는데', '기는요'], answer: 1, explanation: '-기는 했는데 = 倒是（过去）+转折，보기는 했는데' },
        { pre: '운동을 하기는 ', post: '자주는 못 해요（倒是做运动，但不常做）', options: ['했는데', '해요', '하는데', '했어요'], answer: 2, explanation: '-기는 하는데 = 倒是（现在习惯）+转折' },
...
<div class="reminder-box">好记法：-아/어지다 = 状态"变了"（형용사首选）/ -게 되다 = 事情"发展成"（动사首选，说缘由和过程）</div>`,
    ...
    specialQuiz: {
      ...
      body: '根据语境选择正确的变化表达。',
      questions: [
        { pre: '날씨가 많이 따뜻', post: '（天气变暖了）', options: ['해졌어요', '하게 됐어요', '해지게 됐어요', '하게 되었어요'], answer: 0, explanation: '따뜻하다 → 따뜻해지다，形容词状态变化用 -아/어지다' },
        { pre: '한국어를 공부하', post: '（就开始学韩语了——顺其自然）', options: ['아졌어요', '어졌어요', '게 됐어요', '게 되어졌어요'], answer: 2, explanation: '동사 + -게 되다，表示顺势发展的结果' },
        { pre: '그 사람을 좋아하', post: '（慢慢喜欢上那个人了）', options: ['아졌어요', '게 됐어요', '어졌어요', '게 되어졌어요'], answer: 1, explanation: '좋아하다 是动词，顺势发展用 -게 되다' },
