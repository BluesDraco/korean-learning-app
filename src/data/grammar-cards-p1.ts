...
<div class="reminder-box">-고 연결 时不触发不规则变化：듣다 → 듣고 있어요（✓），不变形。-고 있다 只接动作动词，形容词不能用（예쁘고 있어요 ✗）。</div>`,
  ...
  },
  {
    ...
    title: '综合练习①',
    whatItDoes: '第一章综合练习',
    whatItDoesBody: '完成这份练习，检验前 10 课是否掌握。\n10 题，5 阶段循序渐进：识别 2 → 变形 3 → 选择 2 → 改错 2 → 应用 1。',
    isPractice: true,
    specialQuiz: {
      type: 'morph',
      title: '第一章综合练习',
      body: '10 题 · 从识别到应用，检验语序 · 助词 · 时态 · 礼貌体',
      questions: [
        // ═══ 识别阶段 (2 题) — 认出正确的写法 ═══════════════════════════════
        {
          prompt: '【识别 1/10】下面哪句是"我是学生"的正确写法？',
          options: [
            '학생 저는 이에요',
            '저는 학생이에요',
            '저는 이에요 학생',
          ...
          answer: 1,
          explanation: '韩语语序：主语 → 谓语。"저는（我-话题）+ 학생이에요（是学生）"。名词述语用 "이에요/예요"。',
        },
        {
          prompt: '【识别 2/10】下面哪句是"我吃饭"的正确写法？',
          options: [
            '저는 먹어요 밥을',
            '밥을 저는 먹어요',
            '저는 밥을 먹어요',
          ...
          answer: 2,
          explanation: '韩语语序：主 → 宾 → 谓。谓语（动词）永远在句末。宾语加 을/를，밥（有 받침）→ 을。',
        },

        // ═══ 变形阶段 (3 题) — 掌握变形规则 ═══════════════════════════════
        {
          prompt: '【变形 3/10】"학생"（有 받침）作话题时，正确的助词是？',
          options: ['은', '는', '이', '가'],
          answer: 0,
          explanation: '话题用 은/는。학생 末字"생"有 받침（ㅇ）→ 은。有 받침 → 은/을/이；无 받침 → 는/를/가。',
        },
        {
          prompt: '【变形 4/10】动词 "먹다" 变过去时"吃了"，正确形式是？',
          options: ['먹어요', '먹었어요', '먹을 거예요', '먹고 있어요'],
          answer: 1,
          explanation: '过去时 -았/었어요。먹（末元音 ㅓ，阴性）→ 먹었어요。现在 먹어요 / 将来 먹을 거예요 / 进行 먹고 있어요。',
        },
        {
          prompt: '【变形 5/10】动词 "가다" 变将来时"要去"，正确形式是？',
          options: ['가요', '갔어요', '갈 거예요', '가고 있어요'],
          answer: 2,
          explanation: '将来时 -을/ㄹ 거예요。가（无 받침）→ 갈 거예요。语义：明天/以后打算去。',
        },

        // ═══ 选择阶段 (2 题) — 填空/选合适的助词 ═══════════════════════════════
        {
          prompt: '【选择 6/10】"학교___ 공부해요."（在学校学习）空里填？',
          options: ['에', '에서', '은', '를'],
          answer: 1,
          explanation: '动作发生场所用 에서。공부하다 是"学习"这个动作，"在学校"发生 → 학교에서。에 只用于方向/存在（가다/있다）。',
        },
        {
          prompt: '【选择 7/10】"저는 카페___ 가요."（我去咖啡店）空里填？',
          options: ['에', '에서', '을', '이'],
          answer: 0,
          explanation: '方向"去某地"用 에（不用 에서）。가다/오다 表移动 → 목적지（目的地）用 에。',
        },

        // ═══ 改错阶段 (2 题) — 从错句找正确改法 ═══════════════════════════════
        {
          prompt: '【改错 8/10】"집에서 있어요."（我在家）这句哪里错？选正确写法：',
          options: [
            '집에 있어요.',
            '집을 있어요.',
            '집에서 있어요.',
          ...
          answer: 0,
          explanation: '있다（在/有）表存在，前面用 에，不用 에서。에서 只用于"发生动作"的场所。同类：있다/없다/살다 前用 에。',
        },
        {
          prompt: '【改错 9/10】"내일 공부했어요."（明天学习了）这句时态矛盾，改成？',
          options: [
            '내일 공부해요.',
            '내일 공부할 거예요.',
            '어제 공부할 거예요.',
          ...
          answer: 1,
          explanation: '내일（明天）是未来时间词，谓语必须用将来时 -을/ㄹ 거예요 → 공부할 거예요。"내일 + 过去时"是矛盾病句。',
        },

        // ═══ 应用阶段 (1 题) — 完整场景整句选择 ═══════════════════════════════
        {
          prompt: '【应用 10/10】你在电话里说"我现在在咖啡厅喝咖啡"，最合适的表达是？',
          options: [
            '저는 지금 카페에 커피가 마셔요.',
            '지금 카페에서 커피를 마시고 있어요.',
            '지금 카페에 커피를 마셨어요.',
          ...
          answer: 1,
          explanation: '지금（现在）+ 进行时 -고 있어요；카페에서（动作场所用 에서）；커피를（宾语）；마시고 있어요（现在正在喝）。综合语序 · 助词 · 时态三个考点。',
        },
      ],
    },
