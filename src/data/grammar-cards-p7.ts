...
<div class="reminder-box">같이 还有"一起"的意思（같이 가요 = 一起去），不要和比较用法混淆。看后面是动词还是名词来判断：같이 걸어요（一起走）vs 모델같이 걸어요（像模特一样走）。</div>`,    specialQuiz: {
  ...
  <div class="ov-section">
    ...
    connectionRules: [
      ...
      { type: 'note', text: '中文一个"一样"其实藏了两层意思，韩语分得很清：表"相似/像……一样"用 처럼/같이；表"相同/同一个"用 같은。别把"想法一样、喜好一样"这种"相同"误说成 처럼。', examples: '相似→친구처럼 놀아요（像朋友一样玩）/ 相同→같은 생각이에요（想法相同）' },
      { type: 'note', text: '같은 是形容词 같다 的定语形，只能放名词前。想把"一样/相同"放到句尾当谓语，要用 N와/과 같다（后面章节详学）。', examples: '가격이 같아요（价格一样）/ 우리는 생각이 같아요（我们想法一样）' },
    ],
    cardExamples: [
...
<div class="reminder-box">됐어요 前加 이（1년이 됐어요），만이에요 前不加 이（3년 만이에요）——两者结构不同，不能混用。</div>`,    specialQuiz: {
  ...
  <div class="ov-section">
    ...
    connectionRules: [
      ...
      { type: 'compare', text: '만에 vs 후에：中文"……之后"很多人默认套 후에，但两者不一样。후에＝单纯的"之后/多久以后"（中性）；만에＝"时隔……才/又"，强调隔了这么久终于又发生。', examples: '3일 후에 다시 올게요（三天后再来）/ 3일 만에 다시 왔어요（隔了三天才又来）' },
      { type: 'note', text: '这里的 지 是依存名词，要和前面动词分开写（배운 지，中间有空格）。别和以后会学到的连接词尾 -는지（"是否"）搞混，那个是连写的。', examples: '배운 지（学了多久，分写）≠ 배우는지（是否学，连写）' },
      { type: 'note', text: '前面接的是过去时定语形（배운 지，不是 배우는 지）：因为算的是"从动作发生那一刻起"过了多久，即使现在还在做也照样用过去形。', examples: '한국에 산 지 3년（在韩国住了三年，现在还住着，仍用 산 지）' },
    ],
    cardExamples: [
...
<div class="reminder-box">좋는데 ✗ → 좋은데 ✓（形容词用은데）；갔은데 ✗ → 갔는데 ✓（过去时用는데）——这两个是最常犯的错误。</div>`,    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ["는데", "고", "으니까"],
          answer: 0,
          explanation: '-는데 铺垫对比："作业做完了，但考试复习没做。"고 只是平列（少了对比感），으니까 表原因（"因为做完作业"与后句逻辑不符）。',
        },
      ],
    },
  ...
  <div class="ov-section">
    ...
    connectionRules: [
      ...
      { type: 'note', text: '있다/없다 虽然中文像形容词（"有的/没有的"），在韩语里按动词接续：一律用 -는데（있는데/없는데），不是 -은데。', examples: '시간이 있는데 같이 갈래요? / 돈이 없는데 어떡하죠?' },
      { type: 'compare', text: '-는데 vs -지만：中文都译"但是"，但语感不同。지만＝纯转折（前后明确对立）；는데＝铺垫背景、语气更软，尤其请求/提议/发问前几乎都用 는데，换成 지만 会显得生硬。', examples: '커피가 없는데 물 드릴까요?（没咖啡，给您水好吗）自然 / 커피가 없지만 물 드릴까요? 生硬' },
...
<div class="reminder-box">아무 + 名词 + 도 → 아무 말도 안 했어요（什么话都没说）。这个扩展格式能覆盖更多场景。</div>`,    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 2,
          explanation: '하나도 + 否定 = "一点都……"：一分钱都没有，强调程度为零。아무도（谁都）指人、아무데도（哪里都）指地点，都不能修饰"钱"。',
        },
        {
          pre: '그 사건에 대해서는',
          post: '몰라요.',
          ...
          answer: 0,
          explanation: '"关于那件事"什么都不知道→事物用 아무것도。아무도（谁都）指人，与"关于那件事"不搭；하나도 后多接 없다/못 하다 表程度，此处 아무것도 最贴。',
        },
        {
          pre: '그 이야기는',
          post: '못 들었어요.',
  ...
  <div class="ov-section">
    ...
    connectionRules: [
      ...
      { type: 'compare', text: '아무-도 vs 아무-나：中文"谁都/什么都"两种意思共用一套词，韩语靠 도/나 分开。아무+도＝配否定，"谁都不/什么都没"；아무+나＝配肯定，"随便谁/随便哪个都行"。选错助词意思会整个反过来。', examples: '아무도 안 와요（没人来）↔ 아무나 와도 돼요（谁来都行）/ 아무것도 없어요（什么都没有）↔ 아무거나 주세요（随便给点什么）' },
    ...
    mistakes: [
      ...
      { wrong: '아무것도를 안 먹었어요', correct: '아무것도 안 먹었어요', note: '这里的 도 已经替代了宾格助词，后面不能再加 을/를；同理 아무도 也不再加 이/가。' },
    ],
    linkedGrammarIds: [],
  },
  {
...
<div class="reminder-box">있다/없다（存在动词）用 에，不用 에다가：가방에다가 있어요 ✗ → 가방에 있어요 ✓。</div>`,    specialQuiz: {
      ...
      questions: [
        {
          ...
          options: ['에다', '에서', '를'],
          answer: 0,
          explanation: '放置的目标位置用 에다(가)（也可用 에）："把书放在桌上。"에서 表动作发生地/来源，를 是宾格，都不能标放置目标。',
        },
        {
          pre: '이 종이',
          post: '이름을 써 주세요.',
          options: ['에', '에서', '로'],
          answer: 0,
          explanation: '写字的目标位置用 에（也可用 에다）："请在这张纸上写名字。"에서 表动作发生地，로 表方向/工具，都不合。',
        },
        {
          pre: '냉장고',
          post: '넣어 두었어요.',
          options: ["를", "에서", "에다"],
          answer: 2,
          explanation: '放进冰箱的目标位置用 에다(가)（也可用 에）："放进了冰箱里。"에서 表动作发生地，를 是宾格，都不能标放入目标。',
        },
        {
          pre: '여기',
          post: '전화번호를 적어 주세요.',
          options: ['에', '에서', '를'],
          answer: 0,
          explanation: '写电话号码的目标位置用 에（也可用 에다）：여기에 적어 주세요（请在这里写电话号码）。에서 表动作发生地，를 是宾格，都不合。',
        },
      ],
    },
  ...
  <div class="ov-section">
    ...
    connectionRules: [
      ...
      { type: 'note', text: '初学阶段用 에 永远不会错：에다가 只是口语里加强"往这个地方"的语感，可以省略。纠结"到底该不该用 에다가"时，直接用 에 最稳。' },
      { type: 'compare', text: '中文一个"在"，韩语要分两组：往某处"放/写/贴"用 에다가·에（目标）；在某场所"做某动作"用 에서（场所）。别拿"在"硬套。', examples: '책상에다가 놓다（放到桌上·目标）✓ / 카페에서 공부하다（在咖啡厅学习·动作场所）✓' },
    ...
    mistakes: [
      ...
      { wrong: '카페에다가 공부해요', correct: '카페에서 공부해요', note: '中文都说"在咖啡厅"，但"在某场所做动作"必须用 에서；에다가 只用于往某处放/写/贴东西。这是"在"负迁移最常栽的地方。' },
    ],
    linkedGrammarIds: ['g4'],
  },
  {
...
<div class="reminder-box">两个分句主语可以不同：저는 좋지만 친구는 싫어해요（我喜欢但朋友不喜欢）。-지만 不限制主语是否相同。</div>`,    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['서', '니까', '지만'],
          answer: 2,
          explanation: '-지만 表转折："价格虽然贵，但质量好。"서/니까 都表原因（"因为贵所以质量好"逻辑不通）。',
        },
        {
          pre: '생각해 봤',
          post: '좋은 생각인 것 같아요.',
  ...
  <div class="ov-section">
    ...
    connectionRules: [
      ...
      { type: 'note', text: '-는데 很多时候根本不是"但是"，而是先给个背景再提问/请求，中文没有对应词，往往整句不译出来。这种句子换成 -지만 会很别扭。', examples: '지금 시간 있는데 커피 한잔 할래요?（现在有空，要不要喝杯咖啡？）/ 여기 처음 왔는데 뭐가 맛있어요?（第一次来这儿，什么好吃？）' },
      { type: 'compare', text: '想不出"但是"该用哪个时：真·对比矛盾（贵却想买）→ 지만；只是铺个背景/引出下文 → 는데。', examples: '비싸지만 샀어요（矛盾对比）/ 백화점에 갔는데 문을 닫았어요（先说去了，再说结果·铺背景）' },
    ...
    mistakes: [
      ...
      { wrong: '여기 처음 왔지만 뭐가 맛있어요?', correct: '여기 처음 왔는데 뭐가 맛있어요?', note: '这里不是转折，是"先铺背景再提问"，必须用 -는데。凡是后半句要提问或请求的铺垫句，几乎都用 -는데 而不是 -지만。' },
    ],
...
<div class="reminder-box">피곤하느라고 ✗（피곤하다 是形容词）→ 피곤하니까 ✓。먹으느라고 ✗ → 먹느라고 ✓（느라고 直接加词干，不加 으）。</div>`,    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ["려고", "느라고", "거나"],
          answer: 1,
          explanation: '-느라고 表示"忙于做某事（睡懒觉）导致负面结果（迟到）"。려고（为了）表目的、거나（或者）表选择，都不合此处的因果。',
        },
      ],
    },
  ...
  <div class="ov-section">
    ...
    connectionRules: [
      ...
      { type: 'compare', text: '-(으)니까 vs -아/어서（都译"因为"，中文分不出）：想让对方去做某事（命令/建议/请求）时只能用 -(으)니까，-아/어서 后句只能是陈述，不能接命令。', examples: '비가 오니까 우산을 챙기세요 ✓（劝对方带伞）/ 비가 와서 우산을 챙기세요 ✗（아/어서 不能接命令）' },
    ...
    mistakes: [
      ...
      { wrong: '늦어서 빨리 오세요', correct: '늦으니까 빨리 오세요', note: '后句是命令/请求（빨리 오세요）时，"因为"只能用 -(으)니까，不能用 -아/어서。这是中文"因为"最容易带偏的地方。' },
    ],
...
<div class="reminder-box">때문에 需要前有名词或 -기：때문에 가요 ✗ → 그것 때문에 가요 ✓。-거든요 不能后接命令句，需换成 -(으)니까。</div>`,    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 0,
          explanation: '-거든요 句末说明原因："因为我喜欢K-pop啊。"때문이에요 前面要名词（动词干 좋아하 不能直接接），려고요 表打算（答非所问）。',
        },
        {
          pre: '감기',
          post: '학교에 못 갔어요.',
        ...
        },
        {
          ...
          answer: 0,
          explanation: '-거든요 直接接词干说明原因：시험이 있거든요（因为明天有考试啊）。있을거든요 混入将来时、있다거든요 叠加了间接引用，都不对。',
        },
      ],
    },
  ...
  <div class="ov-section">
    ...
    connectionRules: [
      ...
      { type: 'note', text: '때문에 常带负面/怪罪语气（"都怪……"）。中文"多亏你、托您的福"这种正面原因不能用 때문에，要用 덕분에（后面章节详学）。', examples: '너 때문에 늦었어（都怪你迟到了·责怪）/ 선생님 덕분에 합격했어요（多亏老师才考上·感谢）' },
      { type: 'note', text: '-거든요 语气随意，对长辈或正式场合慎用；语调不当时会带"我早说过了/我就这样啊"的顶嘴感，只对平辈或熟人用最稳。' },
    ...
    mistakes: [
      ...
      { wrong: '비가 때문에 못 갔어요', correct: '비 때문에 못 갔어요', note: '때문에 直接接名词，前面的名词不加主格助词 이/가：비가 때문에 ✗ → 비 때문에 ✓。' },
      { wrong: '너무 바빴거든요 못 갔어요', correct: '너무 바빠서 못 갔어요', note: '-거든요 不能用作分句连接两件事，要表示因果关系应该用 -아/어서。' },
      { wrong: '선생님 때문에 합격했어요', correct: '선생님 덕분에 합격했어요', note: '感谢、正面原因（"多亏……"）要用 덕분에；때문에 带责怪语气，说成 "선생님 때문에" 像在怪老师。' },
    ],
  ...
  },
  {
    ...
    connectionRules: [
      { type: 'rule', text: '처럼/같이 修饰动词（副词用法），같은 修饰名词（定语用法）', examples: '모델처럼 걸어요 / 같은 학교예요' },
    ...
    specialQuiz: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ['하나도', '아무도', '아무거나'],
          answer: 1,
          explanation: '"教室里一个人都没有"，指人用 아무도。하나도 多修饰程度而非直接指人，아무거나（随便哪个）不接否定，都不合。',
        },
        {
          pre: '비가 오',
          post: '우산을 가져가세요.',
