...
export const grammarCardsP10: GrammarCard[] = [
...

  {
    ...
    mistakes: [
      ...
      },
      {
        wrong: '합격하기를 바랐어요',
        correct: '합격하기를 바라요',
        note: '-기를 바라다 不接过去时态；祝愿他人考试通过用现在时 합격하기를 바라요（✓），不用 바랐어요。',
      },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
...

  {
    ...
    mistakes: [
      ...
      {
        wrong: '가고 싶은 곳에는 경복궁이에요',
        correct: '가고 싶은 곳은 경복궁이에요',
        note: '곳은/데는 后直接接이에요，不加에：가고 싶은 곳은 경복궁이에요（✓）。가고 싶은 곳에는 경복궁이에요는 장소格조사와 주题助词가 충돌하여 부자연스럽다。',
      },
    ],
    overviewHtml: `<div class="overview">
  <div class="ov-hero">
...

  {
    ...
    mistakes: [
      ...
      {
        wrong: '저 사람이 어제 얘기한 그분이에요',
        correct: '그 사람이 어제 얘기한 그분이에요',
        note: '대화 중 이미 언급된 사람은 그（共知指示）로 가리킨다。저는 지금 눈에 보이는 멀리 있는 사람에게 쓰고，대화 맥락의 인물에는 그를 써야 한다。',
      },
      {
        wrong: '그것을 어디 있어요?',
