...
export const grammarCardsP3: GrammarCard[] = [
  {
    ...
    connectionRules: [
      ...
      { type: 'rule', text: '动词词干 + -고 있었어요 — 过去某时正在做', examples: '어제 드라마를 보고 있었어요, 친구를 기다리고 있었어요（昨天在看电视剧、在等朋友。）' },
      ...
      { type: 'compare', text: '-고 있다（动作正在进行）vs -아/어 있다（结果状态·……着）', examples: '앉고 있어요（想说"坐着"是错的）→ 앉아 있어요（坐着·状态）/ 서 있어요（站着）/ 문이 열려 있어요（门开着）。凳子上"坐着"、门"开着"这类是动作结束后的持续状态，用 -아/어 있다；-고 있다 是动作本身还在进行。' },
      { type: 'note', text: '中文"在"的负迁移：表方位的"在"用 있다，不是 -고 있다', examples: '在家 → 집에 있어요（✓）/ 집에 있고 있어요（✗）; 在学习 → 공부하고 있어요（✓）。中文"在"既表方位又表进行，韩语要分开：方位用 있다，动作进行才用 -고 있다。' },
      { type: 'note', text: '敬语连带：尊敬对象"正在做"用 -고 계시다（敬语在P15详解）', examples: '할머니께서 신문을 읽고 계세요（奶奶在看报纸）/ 선생님이 전화하고 계세요（老师在打电话）。主语是长辈或尊敬对象时 있다 换成 계시다。' },
    ...
    mistakes: [
      ...
      { wrong: '의자에 앉고 있어요（想说"坐着"）', correct: '의자에 앉아 있어요', note: '앉다/서다/눕다 这类动词，"坐着/站着/躺着"是动作结束后的结果状态，要用 -아/어 있다；-고 있어요 会变成"正在往下坐"的进行动作。这是中文母语者最常混的一对。' },
    ],
...
<div class="reminder-box">-고 接续时不触发不规则变化：듣다 → 듣고 있어요（✓），不变形。-고 있다 只接动作动词，形容词不能用。</div>`,
      ...
      type: 'judge',
      title: '判断对错：-고 있다 的用法',
      body: '选出使用 -고 있다 正确的句子。',
      questions: [
        { options: ["노래를 듣고 있어요","노래를 들고 있어요"], answer: 0, explanation: '听歌用 듣다，接 -고 时 ㄷ 不规则不发生 → 듣고 있어요。들고 있어요 是"拿着"。' },
        { options: ["모자를 쓰고 있어요","모자를 써고 있어요"], answer: 0, explanation: '쓰다 + -고 있어요 = 쓰고 있어요（戴着帽子），词干 쓰 直接加 고。' },
        { options: ["지금 예쁘고 있어요","지금 예뻐요"], answer: 1, explanation: '-고 있다 只接动作动词，形容词 예쁘다 不能用 -고 있다，直接用 예뻐요。' },
        { options: ["친구가 가방을 들고 있어요","친구가 가방을 듣고 있어요"], answer: 0, explanation: '들다+고 있어요 = 들고 있어요（拿着包），而 듣고 있어요 是"正在听"。' },
      ],
    },
  ...
  },
  {
    ...
    connectionRules: [
      ...
      { type: 'note', text: '-았었어요 强制暗示"现在已相反/中断"，现在还成立就不能用', examples: '现在还住首尔 → 서울에 살아요（✓）不能说 살았었어요; 현재도 좋아하면 → 좋아해요（✓）。中文"曾经/以前"是中性的，韩语 -았었 却把"现在已经不是这样了"锁进词尾里。' },
      { type: 'compare', text: '中文"过"的两种含义要拆开：经历"过" vs 中断"曾经……过"', examples: '"你去过韩国吗？"（问经历，人现在回来了）韩语更常用 가 봤어요; 而 갔었어요 侧重"当时去了那段时间、现已结束"。别把所有中文"过"都套成 -았었어요。' },
    ],
    cardExamples: [
      {
        wordBlocks: [
    ...
    mistakes: [
      ...
      { wrong: '지금도 서울에 살았었어요（现在还住首尔）', correct: '지금도 서울에 살아요', note: '想说"现在也还住"时不能用 -았었어요，它必然暗示"现在已经不住了"。现在仍成立的事直接用现在时。' },
    ],
...
<div class="reminder-box">昨天的普通事件用 -었어요 就够了，-았었어요 用于有时间距离的回忆或强调"现在已不同"。</div>`,
  ...
  },
  {
    ...
    connectionRules: [
      ...
      { type: 'rule', text: '그러면 — 放句首连接条件与结果', examples: '시간이 있어요? 그러면 같이 가요.（有时间吗？那就一起去吧。）' },
      { type: 'compare', text: '그러면 ≠ 그렇지만', examples: '그러면（那么，条件顺接）/ 그렇지만（但是，明确转折）' },
      { type: 'usage', text: '口语中 그러면 常缩短为 그럼', examples: '그럼 같이 가요. / 그럼 내일 봐요.' },
      { type: 'note', text: '보고 싶다 有两个意思：想看 / 想念（想见）', examples: '이 영화를 보고 싶어요（想看这部电影，宾语是事物）/ 엄마가 보고 싶어요（想妈妈·想念，对象是人）。看到"人 + 보고 싶어요"通常是"想念"，不是"想看那个人"。' },
      { type: 'compare', text: '그러면（那么·条件）vs 그래서（所以·因果）', examples: '시간이 있어요? 그러면 같이 가요（有时间吗？那就一起去·假设条件）/ 시간이 없었어요. 그래서 못 갔어요（没时间，所以没去成·陈述因果）。中文都可说"那……"，但 그래서 讲已发生的因果，그러면 讲假设推进。' },
    ...
    mistakes: [
      ...
      { wrong: '그러면（想表达"但是"）', correct: '그렇지만 / 하지만（但是）', note: '그러면＝那么/那样的话（顺接条件），转折要用 그렇지만/하지만，意思完全不同。' },
      ...
      { wrong: '너를 보고 싶어요（想说"想见你"却怕被理解成"想看你"）', correct: '너를 보고 싶어요 就是"想你/想见你"', note: '对象是人时 보고 싶다 表示"想念、想见"，正是想要的意思，不用回避。想表达"想看某物"时宾语换成事物即可（영화를 보고 싶어요）。' },
    ],
...
<div class="reminder-box">-고 싶어요 只接动词词干，不直接接名词。说第三人称愿望换成 -고 싶어하다：친구는 가고 싶어해요。</div>`,
      ...
      questions: [
        {
          ...
          options: ["배우", "공부", "배우고"],
          answer: 2,
          explanation: '-고 싶어요 接动词词干，배우다→배우고 싶어요（想学）。',
        },
        {
          pre: '시간이 있어요.',
          post: ' 같이 가요.',
          ...
          answer: 0,
          explanation: '그러면 表示"那/那么"，连接条件与结果。그렇지만 是转折。',
        },
        {
          pre: '친구는 드라마를',
          post: '싶어해요.',
          options: ["보고", "봐", "보"],
          answer: 0,
          explanation: '第三人称愿望用 -고 싶어하다：친구는 보고 싶어해요。',
        },
        {
          pre: '뭐',
          post: '싶어요?',
          options: ["먹어", "먹고", "먹"],
          answer: 1,
          explanation: '먹다 + -고 싶어요 = 먹고 싶어요（想吃）。',
        },
      ],
    },
  ...
  },
  {
    ...
    connectionRules: [
      ...
      { type: 'rule', text: 'ㄹ + -고 → ㄹ 保留', examples: '살고 있어요, 알고 있어요, 만들고 싶어요（正住着、知道、想做）' },
      ...
      { type: 'note', text: 'ㄹ 词干后面从不加 -으-（以后学 -(으)면 等语尾时用得到）', examples: '살다→살면（✓）不是 살으면（✗）, 알다→알면, 만들다→만들면, 놀다→놀면。别的收音词接 -(으)면 要加 으（먹으면），但 ㄹ 词干直接省掉 으。' },
      { type: 'note', text: 'ㄹ 不规则是"全员规则"，不用一个个背', examples: '所有以 ㄹ 收音结尾的词干都这样脱落（살다/알다/만들다/놀다/팔다/멀다……），不像 ㅂ/ㄷ 不规则那样要记哪些词是不规则。只要末尾是 ㄹ，遇 ㄴ/ㅂ/ㅅ 就脱落。' },
    ...
    mistakes: [
      ...
      { wrong: '서울에 살으면（想说"如果住首尔"）', correct: '서울에 살면', note: 'ㄹ 词干接 -(으)면 时不加 으，直接 살면。这是 ㄹ 词干和普通收音词（먹으면）最容易混的一点。' },
    ],
...
<div class="reminder-box">口诀：遇 ㄴ/ㅂ/ㅅ 开头语尾就脱落，遇元音开头语尾就保留。살다 → 살아요（保）/ 사세요（落）。</div>`,
      ...
      body: '选出变形正确的句子。',
      questions: [
        { options: ["어디에 살아요?","어디에 사라요?"], answer: 0, explanation: '살다 → 词干 살，接 아요 时 ㄹ 保留 → 살+아요 = 살아요（✓）。사라요 是错误写法。' },
        { options: ["이 단어를 알아요","이 단어를 알어요"], answer: 0, explanation: '알다 → 词干 알，接 아요 时 ㄹ 保留 → 알+아요 = 알아요。词干末元音是 ㅏ，接 아요 不接 어요，所以不是 알어요。' },
  ...
  },
  {
    ...
    connectionRules: [
      ...
      { type: 'rule', text: '动词词干 + -겠어요', examples: '가겠어요, 먹겠어요, 알겠어요, 하겠어요（我要去、我要吃、我明白了、我来做）' },
      ...
      { type: 'note', text: '人称限制：-을/ㄹ래요 只能说"我"的意愿（陈述句）或问"你"的意愿（疑问句），不能替第三人转述意愿', examples: '(나) 저는 갈래요 ✓ / (너) 갈래요? ✓ / (他) 그 사람은 갈래요 ✗ → 그 사람은 갈 거예요' },
      { type: 'note', text: '对长辈/上级别用 -을래요? 征询，显得随意；礼貌邀约改用 -으시겠어요?', examples: '(朋友) 뭐 먹을래요? / (长辈) 뭐 드시겠어요?（您要吃点什么？）' },
    ...
    mistakes: [
      ...
      { wrong: '동생은 집에 갈래요.', correct: '동생은 집에 갈 거예요.', note: '中文"弟弟要回家"可直接说，但 -을/ㄹ래요 只表达"我"的意愿或问"你"，转述第三人意愿要用 -을 거예요。' },
    ],
...
<div class="reminder-box">-겠- 不只表示将来，初学阶段先把 알겠어요（明白了）作为固定表达记住，会话立刻更自然。</div>`,
      ...
      questions: [
        {
          ...
          answer: 0,
          explanation: '-을래요 表达说话人当下的意愿："我要喝咖啡"。마셨어요 是过去式。',
        },
        {
          pre: '알',
          post: '. 다시 해 볼게요.',
          options: ["았어요", "을래요", "겠어요"],
          answer: 2,
          explanation: '알겠어요（明白了）是固定搭配，用 -겠- 表示认知确认。',
        },
        {
          pre: '뭐',
          post: '?',
          ...
          answer: 1,
          explanation: '问对方意愿用 -을래요：뭐 먹을래요?（你要吃什么？）',
        },
        {
          pre: '내일',
          post: '.',
          ...
          answer: 2,
          explanation: '만날래요 表达意愿："明天见吧/明天要约吗"。',
        },
      ],
    },
  ...
  },
  {
    ...
    connectionRules: [
      ...
      { type: 'note', text: '三个都是冠词形，后面必须跟名词，不能单独成句；单独问"什么/哪个"要用代词 뭐·무엇·어느 것', examples: '무슨 노래예요? ✓（무슨+名词）/ 单独问"什么？"是 뭐예요? ✗무슨?　选哪个是 어느 거예요?' },
      { type: 'note', text: '어떤 在陈述句里还能表"某个"（不定用法），不只是疑问', examples: '어떤 사람이 왔어요.（有个人来了）/ 어떤 음식을 좋아해요?（喜欢什么样的食物？疑问）' },
    ...
    scenarios: [
      ...
      { icon: '🎨', context: '问颜色（名称）', ko: '이거 무슨 색이에요? 오늘 무슨 일이 있어요?', zh: '这是什么颜色？今天有什么事？' },
    ...
    mistakes: [
      ...
      { wrong: '"什么颜色" 到底用哪个？', correct: '무슨 색이에요?（问名字）/ 어떤 색을 좋아해요?（问偏好、色调）/ 어느 색?（当面有几种可选时）', note: '同一个"什么颜色"随语境切换。问"是啥颜色"用 무슨；问"喜欢什么风格的色"用 어떤；面前有几块可挑时用 어느。' },
      { wrong: '무슨?（想单独问"什么？"）', correct: '뭐예요?', note: '무슨 是冠词形必须带名词，不能单独问；单独问"什么？"用代词 뭐/무엇，别把中文能独立成句的"什么"直接套过来。' },
    ],
...
<div class="reminder-box">어느 只用于疑问句；肯定句里说喜欢哪首歌，直接用"이 노래가 좋아요"，不用 어느。</div>`,
      ...
      questions: [
        {
          ...
          options: ["어느", "무슨", "어떤"],
          answer: 1,
          explanation: '무슨 뜻이에요? 询问"什么意思"，무슨 问事物属性/类别。',
        },
        {
          pre: '두 개 중에',
          post: '노래를 더 좋아해요?',
          options: ["어느", "무슨", "어떤"],
          answer: 0,
          explanation: '어느 在有限选项中做选择："两个中更喜欢哪个？"',
        },
        {
          pre: '너는',
          post: '음식을 좋아해?',
          options: ["무슨", "어느", "어떤"],
          answer: 2,
          explanation: '어떤 问"什么样的"，询问特征/类型，不是有限选项。',
        },
        {
          pre: '',
          post: '나라에 가고 싶어요?',
          options: ["어느", "무슨", "어떤"],
          answer: 0,
          explanation: '어느 나라（哪个国家），在有限选项中选择。',
        },
      ],
    },
  ...
  },
  {
    ...
    connectionRules: [
      { type: 'compare', text: '그렇지만 — 明确转折，前后信息形成对比', examples: '한국어는 재미있어요. 그렇지만 어려워요.（韩语很有意思，但是难。）' },
      { type: 'compare', text: '그런데 — 轻转折/话题推进，口语高频', examples: '이 노래는 좋아요. 그런데 발음이 빨라요.（这首歌很好，不过发音很快。）' },
      ...
      { type: 'compare', text: '句首连词 그렇지만 vs 词尾 -지만：中文"但是"能在一句中间连接，韩语一句里连接要用词尾 -지만，그렇지만 必须另起一句（前句收尾）', examples: '한국어는 재미있지만 어려워요.（一句内，用 -지만）/ 한국어는 재미있어요. 그렇지만 어려워요.（两句，前句用句号收尾）' },
      { type: 'note', text: '口语里 그런데 常缩读成 근데，听力里高频出现，意思一样', examples: '그런데 이거 알아요? = 근데 이거 알아요?（话说，你知道这个吗？）' },
    ...
    mistakes: [
      { wrong: '공부해요. 그렇지만 드라마도 봐요.', correct: '공부해요. 그리고 드라마도 봐요.', note: '补充信息用 그리고，前后有对比才用 그렇지만/그런데。' },
      ...
      { wrong: '한국어는 재미있어요 그렇지만 어려워요.', correct: '한국어는 재미있어요. 그렇지만 어려워요.（或一句内：재미있지만 어려워요.）', note: '中文"但是"能在一句中间连接，但 그렇지만 是句首连词，前面必须先用句号收尾；想一句内连接要改用词尾 -지만。' },
    ],
...
<div class="reminder-box">그런데 比 그렇지만 用途更广——轻转折、话题推进都能用，口语里出现频率远高于 그렇지만。</div>`,
      ...
      questions: [
        {
          ...
          answer: 0,
          explanation: '前后有转折（辣→但好吃），用 그렇지만 表示对比转折。',
        },
        {
          pre: '어제 드라마를 봤어요.',
          post: '거기 나온 노래가 뭐예요?',
          ...
          answer: 1,
          explanation: '转换话题/顺便提起："昨天看剧了。对了里面那首歌是什么？"用 그런데。',
        },
        {
          pre: '날씨가 추웠어요.',
          post: '눈이 왔어요.',
  ...
  },
  {
    ...
    connectionRules: [
      { type: 'rule', text: '그래서 — 原因 + 그래서 + 自然结果', examples: '비가 와요. 그래서 집에 있어요.（下雨了，所以待在家。）' },
      { type: 'rule', text: '그러니까 — 原因 + 그러니까 + 结果/建议（带提醒语气）', examples: '지금 길이 막힙니다. 그러니까 빨리 가세요.（现在堵车，所以请快点走。）' },
      ...
      { type: 'note', text: '硬规则：想让对方"去做某事"（命令句/劝诱句"…하세요/…합시다"）只能用 그러니까，그래서 后面不能接命令或劝诱', examples: '비가 와요. 그러니까 우산을 가져가세요. ✓ / 비가 와요. 그래서 우산을 가져가세요. ✗（그래서 后不接命令）' },
    ...
    mistakes: [
      ...
      { wrong: '피곤해요. 그래서 좀 쉬세요.', correct: '피곤해요. 그러니까 좀 쉬세요.', note: '让对方去做（命令句/劝诱句）只能用 그러니까，그래서 后面不能接命令或劝诱。' },
    ],
...
<div class="reminder-box">原因一定在前，그래서/그러니까 + 结果在后，顺序不能反。转折用 그런데，不要混用。</div>`,
      ...
      questions: [
        {
          ...
          answer: 0,
          explanation: '让对方"带伞"是命令句（가져가세요），그래서 后面不能接命令或劝诱，只能用 그러니까："下雨了，所以请带伞。"',
        },
        {
          pre: '이 문법은 중요해요.',
          post: '꼭 복습하세요.',
          ...
          answer: 0,
          explanation: '그러니까 带有主观说服力："这语法很重要，所以一定要复习。"',
        },
        {
          pre: '어제 많이 걸었어요.',
          post: '다리가 아파요.',
          ...
          answer: 0,
          explanation: '客观因果关系：走了很多路→所以腿疼。用 그래서。',
        },
        {
          pre: '내일 시험이에요.',
          post: '오늘 일찍 자요.',
          ...
          answer: 2,
          explanation: '带有推理/劝告："明天考试，所以今天早睡。"그러니까 语气更强。',
        },
      ],
    },
  ...
  },
  {
    ...
    connectionRules: [
      ...
      { type: 'note', text: '-(으)ㄹ까요? 有两种意思，靠主语区分：主语是"我们/我"时表提议(要不要…?)；主语是第三人称或不受自己控制的事时表推测(会…吗/…呢?)。别一律理解成"要不要"', examples: '같이 갈까요?（我们要一起去吗？提议）/ 비가 올까요?（会下雨吗？推测）' },
    ],
    cardExamples: [
      {
        wordBlocks: [
    ...
    mistakes: [
      ...
      { wrong: '카페에 가요 공부하러（照搬中文"去咖啡店学习"的语序）', correct: '카페에 공부하러 가요', note: '中文"去+做某事"把"去"放前面，韩语相反：목적动词 -(으)러 放前、가요/와요 落在句末。' },
    ],
...
<div class="reminder-box">먹으러 가요（去吃）≠ 먹고 가요（吃了再走）。-(으)러 是目的，-고 是先后顺序，两者不能混用。</div>`,
        specialQuiz: {
      type: 'judge',
      title: '判断对错：-(으)러 和 -을까요 的用法',
      body: '选出使用正确的句子。',
      questions: [
        { options: ["카페에 공부하러 가요","카페에 공부해러 가요"], answer: 0, explanation: '공부하다→공부하러 가요，-(으)러 接词干。공부해러 不存在。' },
        { options: ["같이 밥을 먹을까요?","같이 밥을 먹러 갈까요?"], answer: 0, explanation: '먹다 有收音 ㄱ，接 -(으)러 时必须加 으 → 먹으러。选项 2 的 먹러 少了 으，是错误的变形。' },
        { options: ["영화를 보러 갈까요?","영화를 볼까러 가요?"], answer: 0, explanation: '-을까요 是提议："要不要去看电影？"。不能和 -러 叠用。' },
        { options: ["친구를 만나러 왔어요","친구를 만날까 왔어요"], answer: 0, explanation: '-(으)러 오다 表示"来做某事"：만나러 왔어요（来见朋友）。만날까 왔어요 不存在。' },
      ],
    },
  ...
  },
  {
    ...
    connectionRules: [
      ...
      { type: 'note', text: '-은/ㄴ 후에 的 -은/ㄴ 表"做完/完成"，不是过去时。哪怕整句在说习惯或将来，动词也用 -은/ㄴ，不要因为"事还没发生"就改成现在形 -는', examples: '내일 밥을 먹은 후에 갈 거예요（明天吃完饭后去，说的是将来，仍用 먹은）' },
      { type: 'note', text: '名词直接 + 전에/후에，不用变形，和动词形式对称', examples: '수업 전에 / 식사 전에 / 방학 후에' },
    ],
    cardExamples: [
      {
        wordBlocks: [
    ...
    mistakes: [
      ...
      { wrong: '먹는 후에（用现在形 -는）', correct: '먹은 후에', note: '후에 前要用表完成的 -은/ㄴ，不是现在形 -는。哪怕说的是将来或习惯，也用 먹은 후에。' },
    ],
...
<div class="reminder-box">-기 전에 不管有没有收音，都直接接词干+기，比 -은/ㄴ 후에 简单得多，不会出错。</div>`,
      ...
      questions: [
        {
          ...
          answer: 1,
          explanation: '먹은 후에 = 吃完饭后刷牙。-은 후에 表示"在……之后"。',
        },
        {
          pre: '',
          post: '손을 씻어요.',
          ...
          answer: 0,
          explanation: '먹기 전에 = 饭前洗手。-기 전에 表示"在……之前"。',
        },
        {
          pre: '숙제를',
          post: 'TV를 봐요.',
          ...
          answer: 0,
          explanation: '한 후에 = 做完作业后看电视。하다→한 후에（ㄴ 후에 接词干）。',
        },
        {
          pre: '자기',
          post: '한국어를 복습해요.',
          options: ["후에", "때", "전에"],
          answer: 2,
          explanation: '자기 전에 = 睡前复习韩语。-기 전에 前加动词词干。',
        },
      ],
    },
  ...
  // ── 第三章 第11课：综合练习③ ─────────────────────────────
  {
    ...
    connectionRules: [
      { type: 'usage', text: '-고 있어요: 正在进行; 穿戴动词 + -고 있어요: 持续状态', examples: '공부하고 있어요 / 안경을 쓰고 있어요（戴着）' },
      ...
      { type: 'usage', text: '그래서（所以，자연결과）/ 그러니까（所以，제안 어감）', examples: '비가 와요. 그래서 집에 있어요.（下雨了，所以待在家。）' },
