      ...
      questions: [
        {
          ...
          answer: 0,
          explanation: '그래서 表示客观因果："下雨了，所以要带伞。"',
        },
        {
          pre: '이 문법은 중요해요.',
          post: '꼭 복습하세요.',
...
<div class="reminder-box">-기 전에 不管有没有收音，都直接接词干+기，比 -은/ㄴ 후에 简单得多，不会出错。</div>`,
      ...
      questions: [
        ...
        },
        {
          pre: '숙제를',
          post: 'TV를 봐요.',
          options: ["한 후에","하기 전에","하는 중에"],
          answer: 0,
          explanation: '한 후에 = 做完作业后看电视。하다→한 후에（ㄴ后에 接词干）。',
        },
        {
          pre: '자기',
          post: '한국어를 복습해요.',
